...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    public V put(K k, V v) {
        K k2 = k;
        V v2 = v;
        V putImpl$default = Core.putImpl$default((Core) core$volatile$FU.get(this), k2, v2, (HashedWeakRef) null, 4, (Object) null);
        if (putImpl$default == ConcurrentWeakMapKt.REHASH) {
            putImpl$default = putSynchronized(k2, v2);
        }
    ...
    public V remove(Object obj) {
        ...
        Object obj2 = obj;
        V putImpl$default = Core.putImpl$default((Core) core$volatile$FU.get(this), obj2, (Object) null, (HashedWeakRef) null, 4, (Object) null);
        if (putImpl$default == ConcurrentWeakMapKt.REHASH) {
            putImpl$default = putSynchronized(obj2, (Object) null);
        }
        if (putImpl$default != null) {
            _size$volatile$FU.decrementAndGet(this);
        }
    ...
    private final synchronized V putSynchronized(K k, V v) {
        ...
        try {
            ...
            while (true) {
                K k2 = k;
                V v2 = v;
                putImpl$default = Core.putImpl$default(core, k2, v2, (HashedWeakRef) null, 4, (Object) null);
                if (putImpl$default == ConcurrentWeakMapKt.REHASH) {
                    core = core.rehash();
