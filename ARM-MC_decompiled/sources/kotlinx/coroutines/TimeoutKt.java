...
public final class TimeoutKt {
    ...
    public static final <T> Object m2027withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m2025toDelayMillisLRDsOJo(j), function2, continuation);
    }

    /* JADX WARNING: Removed duplicated region for block: B:16:0x003f  */
    /* JADX WARNING: Removed duplicated region for block: B:31:0x007b A[RETURN] */
    ...
    public static final <T> java.lang.Object withTimeoutOrNull(long r7, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super T> r10) {
        ...
        L_0x0049:
            ...
            r10.<init>()
            r0.L$0 = r9     // Catch:{ TimeoutCancellationException -> 0x0073 }
            r0.L$1 = r10     // Catch:{ TimeoutCancellationException -> 0x0073 }
            r0.J$0 = r7     // Catch:{ TimeoutCancellationException -> 0x0073 }
            r0.label = r4     // Catch:{ TimeoutCancellationException -> 0x0073 }
            r2 = r0
            kotlin.coroutines.Continuation r2 = (kotlin.coroutines.Continuation) r2     // Catch:{ TimeoutCancellationException -> 0x0073 }
            kotlinx.coroutines.TimeoutCoroutine r4 = new kotlinx.coroutines.TimeoutCoroutine     // Catch:{ TimeoutCancellationException -> 0x0073 }
            r4.<init>(r7, r2)     // Catch:{ TimeoutCancellationException -> 0x0073 }
            r10.element = r4     // Catch:{ TimeoutCancellationException -> 0x0073 }
            java.lang.Object r7 = setupTimeout(r4, r9)     // Catch:{ TimeoutCancellationException -> 0x0073 }
            java.lang.Object r8 = kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch:{ TimeoutCancellationException -> 0x0073 }
            if (r7 != r8) goto L_0x006f
            kotlin.coroutines.Continuation r0 = (kotlin.coroutines.Continuation) r0     // Catch:{ TimeoutCancellationException -> 0x0073 }
            kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineSuspended(r0)     // Catch:{ TimeoutCancellationException -> 0x0073 }
        L_0x006f:
    ...
    public static final <T> Object m2028withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m2025toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final kotlinx.coroutines.TimeoutCancellationException TimeoutCancellationException(long r2, kotlinx.coroutines.Delay r4, kotlinx.coroutines.Job r5) {
        ...
        L_0x0008:
            ...
            java.lang.String r4 = r4.m2026timeoutMessageLRDsOJo(r0)
