...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x0092, code lost:
        if (((kotlinx.coroutines.flow.SubscribedFlowCollector) r9).onSubscription(r0) == r1) goto L_0x00d4;
     */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Removed duplicated region for block: B:25:0x0076  */
    /* JADX WARNING: Removed duplicated region for block: B:36:0x00ae A[Catch:{ all -> 0x00d5 }] */
    /* JADX WARNING: Removed duplicated region for block: B:39:0x00bf A[Catch:{ all -> 0x00d5 }] */
    ...
    public boolean tryEmit(T t) {
        ...
        for (Continuation<Unit> continuation : continuationArr) {
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m516constructorimpl(Unit.INSTANCE));
            }
        }
        return z;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x006e, code lost:
        ...
        r3.resumeWith(kotlin.Result.m516constructorimpl(kotlin.Unit.INSTANCE));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0084, code lost:
        if (r11 != kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()) goto L_0x0089;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x008d, code lost:
        if (r11 != kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()) goto L_0x0090;
     */
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.lang.Object emitSuspend(T r11, kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        /*
            r10 = this;
            ...
            monitor-enter(r10)
            boolean r4 = r10.tryEmitLocked(r11)     // Catch:{ all -> 0x0095 }
            if (r4 == 0) goto L_0x0032
            r11 = r1
            kotlin.coroutines.Continuation r11 = (kotlin.coroutines.Continuation) r11     // Catch:{ all -> 0x002e }
            kotlin.Result$Companion r2 = kotlin.Result.Companion     // Catch:{ all -> 0x002e }
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x002e }
            java.lang.Object r2 = kotlin.Result.m516constructorimpl(r2)     // Catch:{ all -> 0x002e }
            r11.resumeWith(r2)     // Catch:{ all -> 0x002e }
            kotlin.coroutines.Continuation[] r11 = r10.findSlotsToResumeLocked(r3)     // Catch:{ all -> 0x002e }
            r2 = 0
            r5 = r10
            goto L_0x005e
        L_0x002e:
            ...
            goto L_0x0098
        L_0x0032:
            kotlinx.coroutines.flow.SharedFlowImpl$Emitter r4 = new kotlinx.coroutines.flow.SharedFlowImpl$Emitter     // Catch:{ all -> 0x0095 }
            long r5 = r10.getHead()     // Catch:{ all -> 0x0095 }
            int r7 = r10.getTotalSize()     // Catch:{ all -> 0x0095 }
            long r7 = (long) r7     // Catch:{ all -> 0x0095 }
            long r6 = r5 + r7
            r9 = r1
            kotlin.coroutines.Continuation r9 = (kotlin.coroutines.Continuation) r9     // Catch:{ all -> 0x0095 }
            r5 = r10
            r8 = r11
            r4.<init>(r5, r6, r8, r9)     // Catch:{ all -> 0x0093 }
            r10.enqueueLocked(r4)     // Catch:{ all -> 0x0093 }
            int r11 = r10.queueSize     // Catch:{ all -> 0x0093 }
            int r11 = r11 + r2
            r10.queueSize = r11     // Catch:{ all -> 0x0093 }
            int r11 = r10.bufferCapacity     // Catch:{ all -> 0x0093 }
            if (r11 != 0) goto L_0x005c
            kotlin.coroutines.Continuation[] r3 = r10.findSlotsToResumeLocked(r3)     // Catch:{ all -> 0x0093 }
        L_0x005c:
            r11 = r3
            r2 = r4
        L_0x005e:
        ...
        L_0x0068:
            ...
            java.lang.Object r4 = kotlin.Result.m516constructorimpl(r4)
            r3.resumeWith(r4)
        L_0x0079:
            int r2 = r2 + 1
            goto L_0x0068
    ...
    public final Object awaitValue(SharedFlowSlot sharedFlowSlot, Continuation<? super Unit> continuation) {
        ...
        synchronized (this) {
            if (tryPeekLocked(sharedFlowSlot) < 0) {
                ...
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m516constructorimpl(Unit.INSTANCE));
            }
            Unit unit = Unit.INSTANCE;
        }
