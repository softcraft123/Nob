...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> debounce(Flow<? extends T> flow, long j) {
        int i = (j > 0 ? 1 : (j == 0 ? 0 : -1));
        if (i >= 0) {
            return i == 0 ? flow : debounceInternal$FlowKt__DelayKt(flow, new FlowKt__DelayKt$$ExternalSyntheticLambda1(j));
        }
    ...
    public static final <T> Flow<T> m2082debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m2025toDelayMillisLRDsOJo(j));
    }

    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new FlowKt__DelayKt$$ExternalSyntheticLambda0(function1));
    }

    /* access modifiers changed from: private */
    public static final long debounce$lambda$2$FlowKt__DelayKt(Function1 function1, Object obj) {
        return DelayKt.m2025toDelayMillisLRDsOJo(((Duration) function1.invoke(obj)).m1903unboximpl());
    }
    ...
    public static final <T> Flow<T> m2083sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m2025toDelayMillisLRDsOJo(j));
    }

    /* renamed from: timeout-HG0u8IE  reason: not valid java name */
    public static final <T> Flow<T> m2084timeoutHG0u8IE(Flow<? extends T> flow, long j) {
        return m2085timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt  reason: not valid java name */
    private static final <T> Flow<T> m2085timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j) {
