...
public final class ChannelResult<T> {
    ...
    public static final /* synthetic */ ChannelResult m2050boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Object m2051constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2052equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).m2062unboximpl());
    }
    ...
    public static int m2057hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public int hashCode() {
        return m2057hashCodeimpl(this.holder);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Object m2062unboximpl() {
        return this.holder;
    }
    ...
    public static final boolean m2060isSuccessimpl(Object obj) {
        return !(obj instanceof Failed);
    }

    /* renamed from: isFailure-impl  reason: not valid java name */
    public static final boolean m2059isFailureimpl(Object obj) {
        return obj instanceof Failed;
    }

    /* renamed from: isClosed-impl  reason: not valid java name */
    public static final boolean m2058isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* renamed from: getOrNull-impl  reason: not valid java name */
    public static final T m2055getOrNullimpl(Object obj) {
    ...
    public static final T m2056getOrThrowimpl(Object obj) {
        if (!(obj instanceof Failed)) {
            return obj;
        }
    ...
    public static final Throwable m2054exceptionOrNullimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        public final <E> Object m2065successJP2dKIU(E e) {
            return ChannelResult.m2051constructorimpl(e);
        }

        /* renamed from: failure-PtdJZtk  reason: not valid java name */
        public final <E> Object m2064failurePtdJZtk() {
            return ChannelResult.m2051constructorimpl(ChannelResult.failed);
        }

        /* renamed from: closed-JP2dKIU  reason: not valid java name */
        public final <E> Object m2063closedJP2dKIU(Throwable th) {
            return ChannelResult.m2051constructorimpl(new Closed(th));
        }
    }

    public String toString() {
        return m2061toStringimpl(this.holder);
    }
