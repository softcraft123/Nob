    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m516constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m516constructorimpl(Unit.INSTANCE);
        if (Result.m523isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m2065successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m2063closedJP2dKIU(Result.m519exceptionOrNullimpl(obj2));
        }
