            ...
            if (obj2 instanceof NotCompleted) {
                ...
                if (obj2 instanceof CompletedContinuation) {
                    ...
                    if (!completedContinuation.getCancelled()) {
                        Throwable th3 = th;
                        th2 = th3;
                        if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj2, CompletedContinuation.copy$default(completedContinuation, (Object) null, (CancelHandler) null, (Function3) null, (Object) null, th3, 15, (Object) null))) {
                    ...
                    th2 = th;
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj2, new CompletedContinuation(obj2, (CancelHandler) null, (Function3) null, (Object) null, th2, 14, (DefaultConstructorMarker) null))) {
                        return;
                    }
                }
                th = th2;
                ...
                if (obj2 instanceof Active) {
                    ...
                    if (z) {
                        ...
                        if (!(obj instanceof Segment)) {
                            ...
                            if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj2, CompletedContinuation.copy$default(completedContinuation, (Object) null, cancelHandler, (Function3) null, (Object) null, (Throwable) null, 29, (Object) null))) {
                                return;
                            }
                        } else {
                            return;
                        ...
                        Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type kotlinx.coroutines.CancelHandler");
                        if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj2, new CompletedContinuation(obj2, (CancelHandler) obj, (Function3) null, (Object) null, (Throwable) null, 28, (DefaultConstructorMarker) null))) {
                            return;
                        }
                    } else {
                        return;
    ...
    private final <R> Object resumedState(NotCompleted notCompleted, R r, int i, Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> function3, Object obj) {
        if (r instanceof CompletedExceptionally) {
            if (DebugKt.getASSERTIONS_ENABLED() && obj != null) {
                throw new AssertionError();
            } else if (!DebugKt.getASSERTIONS_ENABLED() || function3 == null) {
                return r;
            } else {
                throw new AssertionError();
            }
    ...
    public final <R> void resumeImpl$kotlinx_coroutines_core(R r, int i, Function3<? super Throwable, ? super R, ? super CoroutineContext, Unit> function3) {
        ...
        while (true) {
            ...
            if (obj instanceof NotCompleted) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$volatile$FU, this, obj, resumedState((NotCompleted) obj, r2, i2, function32, (Object) null))) {
                    detachChildIfNonResuable();
                    dispatchResume(i2);
                    return;
                }
            ...
            if (obj2 instanceof NotCompleted) {
                ...
                if ((obj2 instanceof CompletedContinuation) && obj4 != null) {
                    ...
                    if (completedContinuation.idempotentResume == obj4) {
                        if (!DebugKt.getASSERTIONS_ENABLED() || Intrinsics.areEqual((Object) completedContinuation.result, (Object) r3)) {
                            return CancellableContinuationImplKt.RESUME_TOKEN;
                        }
                        throw new AssertionError();
                    }
