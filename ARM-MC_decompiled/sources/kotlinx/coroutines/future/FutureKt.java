...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> asCompletableFuture(Deferred<? extends T> deferred) {
        ...
        deferred.invokeOnCompletion(new FutureKt$$ExternalSyntheticLambda0(completableFuture, deferred));
        return completableFuture;
    }
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        ...
        job.invokeOnCompletion(new FutureKt$$ExternalSyntheticLambda3(completableFuture));
        return completableFuture;
    }
