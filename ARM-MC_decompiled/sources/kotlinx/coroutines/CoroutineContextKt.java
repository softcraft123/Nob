...
public final class CoroutineContextKt {
    ...
    private static final boolean hasCopyableElements(CoroutineContext coroutineContext) {
        return ((Boolean) coroutineContext.fold(false, new CoroutineContextKt$$ExternalSyntheticLambda0())).booleanValue();
    }
    ...
    private static final CoroutineContext foldCopies(CoroutineContext coroutineContext, CoroutineContext coroutineContext2, boolean z) {
        ...
        CoroutineContext coroutineContext3 = (CoroutineContext) coroutineContext.fold(EmptyCoroutineContext.INSTANCE, new CoroutineContextKt$$ExternalSyntheticLambda1(objectRef, z));
        if (hasCopyableElements2) {
            objectRef.element = ((CoroutineContext) objectRef.element).fold(EmptyCoroutineContext.INSTANCE, new CoroutineContextKt$$ExternalSyntheticLambda2());
        }
