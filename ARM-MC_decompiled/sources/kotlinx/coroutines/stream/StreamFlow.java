...
final class StreamFlow<T> implements Flow<T> {
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L_0x0041:
            ...
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r7 = consumed$volatile$FU
            r2 = 0
            boolean r7 = r7.compareAndSet(r5, r2, r3)
            if (r7 == 0) goto L_0x0082
            java.util.stream.Stream<T> r7 = r5.stream     // Catch:{ all -> 0x007a }
            java.util.Iterator r7 = r7.iterator()     // Catch:{ all -> 0x007a }
            r4 = r7
            r7 = r6
            r6 = r4
            r4 = r5
        L_0x0059:
            boolean r2 = r6.hasNext()     // Catch:{ all -> 0x0037 }
            if (r2 == 0) goto L_0x0072
            java.lang.Object r2 = r6.next()     // Catch:{ all -> 0x0037 }
            r0.L$0 = r4     // Catch:{ all -> 0x0037 }
            r0.L$1 = r7     // Catch:{ all -> 0x0037 }
            r0.L$2 = r6     // Catch:{ all -> 0x0037 }
            r0.label = r3     // Catch:{ all -> 0x0037 }
            java.lang.Object r2 = r7.emit(r2, r0)     // Catch:{ all -> 0x0037 }
