...
public final class DelayKt {
    ...
    public static final Object m2024delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2025toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2025toDelayMillisLRDsOJo(long j) {
        boolean r0 = Duration.m1882isPositiveimpl(j);
        if (r0) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m1866getInWholeMillisecondsimpl(Duration.m1884plusLRDsOJo(j, DurationKt.toDuration(999999, DurationUnit.NANOSECONDS)));
        } else if (!r0) {
            return 0;
        } else {
