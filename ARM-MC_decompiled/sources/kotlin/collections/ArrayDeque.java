...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public <T> T[] toArray(T[] tArr) {
        ...
        int i = this.head;
        if (i < positiveMod) {
            ArraysKt.copyInto$default(this.elementData, (Object[]) tArr2, 0, i, positiveMod, 2, (Object) null);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
            ArraysKt.copyInto((T[]) objArr, tArr2, 0, this.head, objArr.length);
            Object[] objArr2 = this.elementData;
            ArraysKt.copyInto((T[]) objArr2, tArr2, objArr2.length - this.head, 0, positiveMod);
        }
        return CollectionsKt.terminateCollectionToArray(size(), tArr2);
    }
    ...
    private final void removeRangeShiftPreceding(int i, int i2) {
        ...
        while (i > 0) {
            ...
            ArraysKt.copyInto((T[]) objArr, (T[]) objArr, i4 + 1, i5 + 1, i3);
    ...
    private final void removeRangeShiftSucceeding(int i, int i2) {
        ...
        while (true) {
            ...
            if (size2 > 0) {
                ...
                ArraysKt.copyInto((T[]) objArr2, (T[]) objArr2, positiveMod2, positiveMod, i3);
    ...
    private final void nullifyNonEmpty(int i, int i2) {
        if (i < i2) {
            ArraysKt.fill((T[]) this.elementData, null, i, i2);
            return;
        }
        Object[] objArr = this.elementData;
        ArraysKt.fill((T[]) objArr, null, i, objArr.length);
        ArraysKt.fill((T[]) this.elementData, null, 0, i2);
    }
