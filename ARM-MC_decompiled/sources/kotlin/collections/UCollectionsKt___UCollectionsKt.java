...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m586constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m597setVurrAj0(r0, i, r2.m584unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m665constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m676setVXSXFK8(r0, i, r2.m663unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m744constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m755setk8EXiF4(r0, i, r2.m742unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m849constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m860set01HTLdE(r0, i, r2.m847unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m611constructorimpl(i + r1.m663unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m690constructorimpl(j + r2.m742unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m611constructorimpl(i + UInt.m611constructorimpl(r1.m584unboximpl() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m611constructorimpl(i + UInt.m611constructorimpl(r1.m847unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
