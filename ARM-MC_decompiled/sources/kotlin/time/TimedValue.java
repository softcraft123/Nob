...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m2015copyRFiDyg4$default(TimedValue timedValue, T t, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m2017copyRFiDyg4(t, j);
    }
    ...
    public final long m2016component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m2017copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.value, (Object) timedValue.value) && Duration.m1853equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1876hashCodeimpl(this.duration);
    }
    ...
    public final long m2018getDurationUwyO8pc() {
        return this.duration;
    }
