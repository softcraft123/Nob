...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1837getAdjustmentUwyO8pc() {
    ...
    public TimeMark m1838minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1988minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m1836elapsedNowUwyO8pc() {
        return Duration.m1883minusLRDsOJo(this.mark.m1985elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1839plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1884plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
