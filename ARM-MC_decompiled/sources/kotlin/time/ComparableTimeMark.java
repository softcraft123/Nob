...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark m1840minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc  reason: not valid java name */
    long m1841minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    ComparableTimeMark m1842plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static ComparableTimeMark m1843minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.m1842plusLRDsOJo(Duration.m1901unaryMinusUwyO8pc(j));
        }
        ...
        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark comparableTimeMark2) {
            ...
            return Duration.m1847compareToLRDsOJo(comparableTimeMark.m1841minusUwyO8pc(comparableTimeMark2), Duration.Companion.m1951getZEROUwyO8pc());
        }
    }
}
