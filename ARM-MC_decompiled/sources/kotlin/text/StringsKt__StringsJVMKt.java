...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replaceFirst(String str, char c, char c2, boolean z) {
        ...
        return StringsKt.replaceRange(charSequence, indexOf$default, indexOf$default + 1, (CharSequence) String.valueOf(c2)).toString();
    }
    ...
    public static final String replaceFirst(String str, String str2, String str3, boolean z) {
        ...
        CharSequence charSequence = str;
        String str4 = str2;
        int indexOf$default = StringsKt.indexOf$default(charSequence, str4, 0, z, 2, (Object) null);
        if (indexOf$default < 0) {
            return str;
        }
        return StringsKt.replaceRange(charSequence, indexOf$default, str4.length() + indexOf$default, (CharSequence) str3).toString();
    }
