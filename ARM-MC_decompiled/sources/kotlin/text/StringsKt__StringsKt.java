...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final String substringAfter(String str, String str2, String str3) {
        ...
        String substring = str.substring(indexOf$default + str4.length(), str.length());
        Intrinsics.checkNotNullExpressionValue(substring, "substring(...)");
        return substring;
    }
    ...
    public static final String substringAfterLast(String str, String str2, String str3) {
        ...
        Intrinsics.checkNotNullParameter(str3, "missingDelimiterValue");
        String str4 = str2;
        int lastIndexOf$default = StringsKt.lastIndexOf$default((CharSequence) str, str4, 0, false, 6, (Object) null);
        if (lastIndexOf$default == -1) {
            return str3;
        }
        String substring = str.substring(lastIndexOf$default + str4.length(), str.length());
        Intrinsics.checkNotNullExpressionValue(substring, "substring(...)");
        return substring;
    }
    ...
    public static final String replaceAfter(String str, String str2, String str3, String str4) {
        ...
        return StringsKt.replaceRange(charSequence, indexOf$default + str5.length(), str.length(), (CharSequence) str3).toString();
    }
    ...
    public static final String replaceAfterLast(String str, String str2, String str3, String str4) {
        ...
        return StringsKt.replaceRange(charSequence, lastIndexOf$default + str5.length(), str.length(), (CharSequence) str3).toString();
    }
    ...
    private static final int indexOf$StringsKt__StringsKt(CharSequence charSequence, CharSequence charSequence2, int i, int i2, boolean z, boolean z2) {
        ...
        if (!(charSequence instanceof String) || !(charSequence2 instanceof String)) {
            ...
            while (true) {
                ...
                z3 = z4;
                if (StringsKt.regionMatchesImpl(charSequence4, 0, charSequence3, i3, charSequence2.length(), z4)) {
                    return i3;
                }
                if (i3 == last) {
                    return -1;
            ...
            while (true) {
                boolean z5 = z;
                if (StringsKt.regionMatches((String) charSequence2, 0, (String) charSequence, i4, charSequence2.length(), z5)) {
                    return i4;
                }
                if (i4 == last2) {
                    return -1;
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i, boolean z, boolean z2) {
        ...
        if (z || collection.size() != 1) {
            CharSequence charSequence3 = charSequence;
            int i2 = i;
            IntProgression intRange = !z2 ? new IntRange(RangesKt.coerceAtLeast(i2, 0), charSequence3.length()) : RangesKt.downTo(RangesKt.coerceAtMost(i2, StringsKt.getLastIndex(charSequence3)), 0);
                ...
                if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                    ...
                    while (true) {
                        ...
                        while (true) {
                            ...
                            z3 = z;
                            if (StringsKt.regionMatches(str, 0, (String) charSequence3, i3, str.length(), z3)) {
                                break;
                            }
                            z = z3;
                        }
                ...
                if ((step2 > 0 && first2 <= last2) || (step2 < 0 && last2 <= first2)) {
                    ...
                    while (true) {
                        ...
                        while (true) {
                            ...
                            boolean z5 = z4;
                            z4 = z5;
                            if (StringsKt.regionMatchesImpl(str3, 0, charSequence2, i4, str3.length(), z5)) {
                                break;
                            }
    ...
    public static final boolean contains(CharSequence charSequence, CharSequence charSequence2, boolean z) {
        ...
        CharSequence charSequence3 = charSequence;
        return indexOf$StringsKt__StringsKt$default(charSequence3, charSequence2, 0, charSequence3.length(), z, false, 16, (Object) null) >= 0;
    }
    ...
    public static final Sequence<String> splitToSequence(CharSequence charSequence, String[] strArr, boolean z, int i) {
        ...
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence2, strArr, 0, z, i, 2, (Object) null), new StringsKt__StringsKt$splitToSequence$1(charSequence2));
    }
    ...
    public static final List<String> split(CharSequence charSequence, String[] strArr, boolean z, int i) {
        ...
        CharSequence charSequence2 = charSequence;
        Iterable<IntRange> asIterable = SequencesKt.asIterable(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence2, strArr, 0, z, i, 2, (Object) null));
        Collection arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(asIterable, 10));
        for (IntRange substring : asIterable) {
            arrayList.add(StringsKt.substring(charSequence2, substring));
        }
    ...
    public static final Sequence<String> splitToSequence(CharSequence charSequence, char[] cArr, boolean z, int i) {
        ...
        CharSequence charSequence2 = charSequence;
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence2, cArr, 0, z, i, 2, (Object) null), new StringsKt__StringsKt$splitToSequence$2(charSequence2));
    }
    ...
    public static final List<String> split(CharSequence charSequence, char[] cArr, boolean z, int i) {
        ...
        CharSequence charSequence2 = charSequence;
        Iterable<IntRange> asIterable = SequencesKt.asIterable(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence2, cArr, 0, z, i, 2, (Object) null));
        Collection arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(asIterable, 10));
        for (IntRange substring : asIterable) {
            arrayList.add(StringsKt.substring(charSequence2, substring));
        }
