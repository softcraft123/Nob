...
public final class HexFormat {
    ...
    public static final class BytesHexFormat {
        ...
        public BytesHexFormat(int i, int i2, String str, String str2, String str3, String str4) {
            ...
            this.ignoreCase = (HexFormatKt.access$isCaseSensitive(str) || HexFormatKt.access$isCaseSensitive(str2) || HexFormatKt.access$isCaseSensitive(str3) || HexFormatKt.access$isCaseSensitive(str4)) ? true : z;
        }
    ...
    public static final class NumberHexFormat {
        ...
        public NumberHexFormat(String str, String str2, boolean z, int i) {
            ...
            this.ignoreCase = (HexFormatKt.access$isCaseSensitive(str) || HexFormatKt.access$isCaseSensitive(str2)) ? true : z2;
        }
        ...
        public final StringBuilder appendOptionsTo$kotlin_stdlib(StringBuilder sb, String str) {
            ...
            Intrinsics.checkNotNullExpressionValue(append4, "append(...)");
            Intrinsics.checkNotNullExpressionValue(append4.append(10), "append(...)");
            StringBuilder append5 = sb.append(str).append("removeLeadingZeros = ").append(this.removeLeadingZeros);
            Intrinsics.checkNotNullExpressionValue(append5, "append(...)");
            StringBuilder append6 = append5.append(',');
            Intrinsics.checkNotNullExpressionValue(append6, "append(...)");
            Intrinsics.checkNotNullExpressionValue(append6.append(10), "append(...)");
