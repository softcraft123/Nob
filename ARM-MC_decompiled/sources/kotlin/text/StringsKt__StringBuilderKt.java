...
class StringsKt__StringBuilderKt extends StringsKt__StringBuilderJVMKt {
    ...
    public static final StringBuilder append(StringBuilder sb, String... strArr) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(strArr, Values.VECTOR_MAP_VECTORS_KEY);
    ...
    public static final StringBuilder append(StringBuilder sb, Object... objArr) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(objArr, Values.VECTOR_MAP_VECTORS_KEY);
    ...
    private static final StringBuilder appendLine(StringBuilder sb, char[] cArr) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(cArr, Values.VECTOR_MAP_VECTORS_KEY);
