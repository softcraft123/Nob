...
public final class UStringsKt {
    ...
    public static final String m1821toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1823toStringolVBNx4(short s, int i) {
    ...
    public static final String m1822toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(((long) i) & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40  reason: not valid java name */
    public static final String m1820toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m584unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m847unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m663unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m742unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m663unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m611constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m528boximpl(UByte.m534constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m663unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m611constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m791boximpl(UShort.m797constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m611constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m611constructorimpl(i3 * r3);
            int r7 = UInt.m611constructorimpl(UInt.m611constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m690constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m690constructorimpl(j * r5);
            long r13 = ULong.m690constructorimpl(ULong.m690constructorimpl(((long) UInt.m611constructorimpl(digitOf)) & 4294967295L) + r9);
