...
class PathsKt__PathReadWriteKt {
    ...
    public static final void writeText(java.nio.file.Path r4, java.lang.CharSequence r5, java.nio.charset.Charset r6, java.nio.file.OpenOption... r7) throws java.io.IOException {
        /*
            ...
            r7 = r4
            java.io.OutputStream r7 = (java.io.OutputStream) r7     // Catch:{ all -> 0x008a }
            boolean r0 = r5 instanceof java.lang.String     // Catch:{ all -> 0x008a }
            if (r0 == 0) goto L_0x0031
            kotlin.jvm.internal.Intrinsics.checkNotNull(r7)     // Catch:{ all -> 0x008a }
            java.lang.String r5 = (java.lang.String) r5     // Catch:{ all -> 0x008a }
            kotlin.io.FilesKt.writeTextImpl(r7, r5, r6)     // Catch:{ all -> 0x008a }
            goto L_0x0083
        L_0x0031:
            java.nio.charset.CharsetEncoder r6 = kotlin.io.FilesKt.newReplaceEncoder(r6)     // Catch:{ all -> 0x008a }
            boolean r0 = r5 instanceof java.nio.CharBuffer     // Catch:{ all -> 0x008a }
            if (r0 == 0) goto L_0x0041
            r0 = r5
            java.nio.CharBuffer r0 = (java.nio.CharBuffer) r0     // Catch:{ all -> 0x008a }
            java.nio.CharBuffer r0 = r0.asReadOnlyBuffer()     // Catch:{ all -> 0x008a }
            goto L_0x0045
        L_0x0041:
            java.nio.CharBuffer r0 = java.nio.CharBuffer.wrap(r5)     // Catch:{ all -> 0x008a }
        L_0x0045:
            int r5 = r5.length()     // Catch:{ all -> 0x008a }
            r1 = 8192(0x2000, float:1.14794E-41)
            int r5 = java.lang.Math.min(r5, r1)     // Catch:{ all -> 0x008a }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r6)     // Catch:{ all -> 0x008a }
            java.nio.ByteBuffer r5 = kotlin.io.FilesKt.byteBufferForEncoding(r5, r6)     // Catch:{ all -> 0x008a }
        L_0x0056:
            boolean r1 = r0.hasRemaining()     // Catch:{ all -> 0x008a }
            if (r1 == 0) goto L_0x0083
            r1 = 1
            java.nio.charset.CoderResult r1 = r6.encode(r0, r5, r1)     // Catch:{ all -> 0x008a }
            boolean r1 = r1.isError()     // Catch:{ all -> 0x008a }
            if (r1 != 0) goto L_0x0077
            byte[] r1 = r5.array()     // Catch:{ all -> 0x008a }
            int r2 = r5.position()     // Catch:{ all -> 0x008a }
            r3 = 0
            r7.write(r1, r3, r2)     // Catch:{ all -> 0x008a }
            r5.clear()     // Catch:{ all -> 0x008a }
            goto L_0x0056
        L_0x0077:
            java.lang.String r5 = "Check failed."
            java.lang.IllegalStateException r6 = new java.lang.IllegalStateException     // Catch:{ all -> 0x008a }
            java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x008a }
            r6.<init>(r5)     // Catch:{ all -> 0x008a }
            throw r6     // Catch:{ all -> 0x008a }
        L_0x0083:
            kotlin.Unit r5 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x008a }
            r5 = 0
            kotlin.io.CloseableKt.closeFinally(r4, r5)
            return
        L_0x008a:
    ...
    static /* synthetic */ void forEachLine$default(java.nio.file.Path r1, java.nio.charset.Charset r2, kotlin.jvm.functions.Function1 r3, int r4, java.lang.Object r5) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            kotlin.sequences.Sequence r4 = kotlin.io.TextStreamsKt.lineSequence(r4)     // Catch:{ all -> 0x004f }
    ...
    static /* synthetic */ java.lang.Object useLines$default(java.nio.file.Path r0, java.nio.charset.Charset r1, kotlin.jvm.functions.Function1 r2, int r3, java.lang.Object r4) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r3)     // Catch:{ all -> 0x003b }
            kotlin.sequences.Sequence r3 = kotlin.io.TextStreamsKt.lineSequence(r3)     // Catch:{ all -> 0x003b }
            java.lang.Object r2 = r2.invoke(r3)     // Catch:{ all -> 0x003b }
    ...
    private static final <T> T useLines(java.nio.file.Path r2, java.nio.charset.Charset r3, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<java.lang.String>, ? extends T> r4) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x0036 }
            kotlin.sequences.Sequence r1 = kotlin.io.TextStreamsKt.lineSequence(r1)     // Catch:{ all -> 0x0036 }
            java.lang.Object r4 = r4.invoke(r1)     // Catch:{ all -> 0x0036 }
