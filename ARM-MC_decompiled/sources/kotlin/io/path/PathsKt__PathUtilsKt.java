...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final String getInvariantSeparatorsPathString(Path path) {
        ...
        if (Intrinsics.areEqual((Object) separator, (Object) DomExceptionUtils.SEPARATOR)) {
            return path.toString();
        }
    ...
    static /* synthetic */ java.lang.Object useDirectoryEntries$default(java.nio.file.Path r0, java.lang.String r1, kotlin.jvm.functions.Function1 r2, int r3, java.lang.Object r4) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            r1 = 0
            r3 = r0
            java.nio.file.DirectoryStream r3 = (java.nio.file.DirectoryStream) r3     // Catch:{ all -> 0x003d }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r3)     // Catch:{ all -> 0x003d }
            java.lang.Iterable r3 = (java.lang.Iterable) r3     // Catch:{ all -> 0x003d }
            kotlin.sequences.Sequence r3 = kotlin.collections.CollectionsKt.asSequence(r3)     // Catch:{ all -> 0x003d }
            java.lang.Object r2 = r2.invoke(r3)     // Catch:{ all -> 0x003d }
    ...
    private static final <T> T useDirectoryEntries(java.nio.file.Path r2, java.lang.String r3, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<? extends java.nio.file.Path>, ? extends T> r4) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x0038 }
            ...
            java.lang.Object r4 = r4.invoke(r1)     // Catch:{ all -> 0x0038 }
    ...
    static /* synthetic */ void forEachDirectoryEntry$default(java.nio.file.Path r1, java.lang.String r2, kotlin.jvm.functions.Function1 r3, int r4, java.lang.Object r5) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            r2 = 0
            r4 = r1
            java.nio.file.DirectoryStream r4 = (java.nio.file.DirectoryStream) r4     // Catch:{ all -> 0x0049 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r4)     // Catch:{ all -> 0x0049 }
            java.lang.Iterable r4 = (java.lang.Iterable) r4     // Catch:{ all -> 0x0049 }
            java.util.Iterator r4 = r4.iterator()     // Catch:{ all -> 0x0049 }
        L_0x0028:
            boolean r0 = r4.hasNext()     // Catch:{ all -> 0x0049 }
            if (r0 == 0) goto L_0x0036
            java.lang.Object r0 = r4.next()     // Catch:{ all -> 0x0049 }
            r3.invoke(r0)     // Catch:{ all -> 0x0049 }
            goto L_0x0028
        L_0x0036:
    ...
    private static final void forEachDirectoryEntry(java.nio.file.Path r3, java.lang.String r4, kotlin.jvm.functions.Function1<? super java.nio.file.Path, kotlin.Unit> r5) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x0044 }
            java.lang.Iterable r1 = (java.lang.Iterable) r1     // Catch:{ all -> 0x0044 }
            java.util.Iterator r1 = r1.iterator()     // Catch:{ all -> 0x0044 }
        L_0x0023:
            boolean r2 = r1.hasNext()     // Catch:{ all -> 0x0044 }
            if (r2 == 0) goto L_0x0031
            java.lang.Object r2 = r1.next()     // Catch:{ all -> 0x0044 }
            r5.invoke(r2)     // Catch:{ all -> 0x0044 }
            goto L_0x0023
        L_0x0031:
    ...
    private static final Path setLastModifiedTime(Path path, FileTime fileTime) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(fileTime, Values.VECTOR_MAP_VECTORS_KEY);
    ...
    private static final Path setOwner(Path path, UserPrincipal userPrincipal) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(userPrincipal, Values.VECTOR_MAP_VECTORS_KEY);
    ...
    private static final Path setPosixFilePermissions(Path path, Set<? extends PosixFilePermission> set) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(set, Values.VECTOR_MAP_VECTORS_KEY);
