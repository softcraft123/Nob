...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m1720getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public final long m1744getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1745getLastsVKNKU() {
        return this.last;
    }
    ...
    public boolean isEmpty() {
        ...
        long j = this.first;
        long j2 = this.last;
        return i > 0 ? Long.compareUnsigned(j, j2) > 0 : Long.compareUnsigned(j, j2) < 0;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m690constructorimpl(j ^ ULong.m690constructorimpl(j >>> 32))) * 31) + ((int) ULong.m690constructorimpl(j2 ^ ULong.m690constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append(ULong.m736toStringimpl(this.first)).append("..").append(ULong.m736toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append(ULong.m736toStringimpl(this.first)).append(" downTo ").append(ULong.m736toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1746fromClosedRange7ftBX0g(long j, long j2, long j3) {
