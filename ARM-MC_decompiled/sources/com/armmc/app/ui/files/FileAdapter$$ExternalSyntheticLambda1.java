...
public final /* synthetic */ class FileAdapter$$ExternalSyntheticLambda1 implements View.OnClickListener {
    ...
    public /* synthetic */ FileAdapter$$ExternalSyntheticLambda1(FileAdapter fileAdapter, FileItem fileItem) {
        this.f$0 = fileAdapter;
        this.f$1 = fileItem;
    }

    public final void onClick(View view) {
        FileAdapter.onBindViewHolder$lambda$0(this.f$0, this.f$1, view);
    }
}
