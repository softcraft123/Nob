...
public final /* synthetic */ class MainActivity$$ExternalSyntheticLambda5 implements View.OnClickListener {
    ...
    public /* synthetic */ MainActivity$$ExternalSyntheticLambda5(MainActivity mainActivity, BottomSheetDialog bottomSheetDialog, MaterialCardView materialCardView, MaterialCardView materialCardView2, ImageView imageView, ImageView imageView2) {
    ...
    public final void onClick(View view) {
        MainActivity.showTunnelRegionDialog$lambda$10(this.f$0, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, view);
    }
}
