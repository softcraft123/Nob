...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:44:0x00c7 */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:38:0x0074 A[Catch:{ all -> 0x00c8 }] */
    ...
    public boolean encode(com.bumptech.glide.load.engine.Resource<android.graphics.Bitmap> r9, java.io.File r10, com.bumptech.glide.load.Options r11) {
        /*
            ...
            long r3 = com.bumptech.glide.util.LogTime.getLogTime()     // Catch:{ all -> 0x00c8 }
            com.bumptech.glide.load.Option<java.lang.Integer> r5 = COMPRESSION_QUALITY     // Catch:{ all -> 0x00c8 }
            java.lang.Object r5 = r11.get(r5)     // Catch:{ all -> 0x00c8 }
            java.lang.Integer r5 = (java.lang.Integer) r5     // Catch:{ all -> 0x00c8 }
            int r5 = r5.intValue()     // Catch:{ all -> 0x00c8 }
            r6 = 0
        ...
        L_0x006d:
            r5 = 2
            boolean r5 = android.util.Log.isLoggable(r0, r5)     // Catch:{ all -> 0x00c8 }
            if (r5 == 0) goto L_0x00be
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x00c8 }
            r5.<init>(r1)     // Catch:{ all -> 0x00c8 }
            java.lang.StringBuilder r1 = r5.append(r2)     // Catch:{ all -> 0x00c8 }
            java.lang.String r2 = " of size "
            java.lang.StringBuilder r1 = r1.append(r2)     // Catch:{ all -> 0x00c8 }
            int r2 = com.bumptech.glide.util.Util.getBitmapByteSize(r9)     // Catch:{ all -> 0x00c8 }
            java.lang.StringBuilder r1 = r1.append(r2)     // Catch:{ all -> 0x00c8 }
            java.lang.String r2 = " in "
            java.lang.StringBuilder r1 = r1.append(r2)     // Catch:{ all -> 0x00c8 }
            double r2 = com.bumptech.glide.util.LogTime.getElapsedMillis(r3)     // Catch:{ all -> 0x00c8 }
            java.lang.StringBuilder r1 = r1.append(r2)     // Catch:{ all -> 0x00c8 }
            java.lang.String r2 = ", options format: "
            java.lang.StringBuilder r1 = r1.append(r2)     // Catch:{ all -> 0x00c8 }
            com.bumptech.glide.load.Option<android.graphics.Bitmap$CompressFormat> r2 = COMPRESSION_FORMAT     // Catch:{ all -> 0x00c8 }
            java.lang.Object r11 = r11.get(r2)     // Catch:{ all -> 0x00c8 }
            java.lang.StringBuilder r11 = r1.append(r11)     // Catch:{ all -> 0x00c8 }
            java.lang.String r1 = ", hasAlpha: "
            java.lang.StringBuilder r11 = r11.append(r1)     // Catch:{ all -> 0x00c8 }
            boolean r9 = r9.hasAlpha()     // Catch:{ all -> 0x00c8 }
            java.lang.StringBuilder r9 = r11.append(r9)     // Catch:{ all -> 0x00c8 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x00c8 }
            android.util.Log.v(r0, r9)     // Catch:{ all -> 0x00c8 }
        L_0x00be:
