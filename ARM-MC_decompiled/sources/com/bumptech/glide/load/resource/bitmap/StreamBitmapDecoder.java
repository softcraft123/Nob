...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
    ...
    public Resource<Bitmap> decode(InputStream inputStream, int i, int i2, Options options) throws IOException {
        ...
        try {
            Resource<Bitmap> decode = this.downsampler.decode((InputStream) new MarkEnforcingInputStream(obtain), i, i2, options, (Downsampler.DecodeCallbacks) new UntrustedCallbacks(recyclableBufferedInputStream, obtain));
            obtain.release();
            if (z) {
