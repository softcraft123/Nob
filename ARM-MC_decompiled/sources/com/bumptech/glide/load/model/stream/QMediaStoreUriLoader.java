...
public final class QMediaStoreUriLoader<DataT> implements ModelLoader<Uri, DataT> {
    ...
    private static final class QMediaStoreUriFetcher<DataT> implements DataFetcher<DataT> {
        ...
        private File queryForFilePath(Uri uri2) throws FileNotFoundException {
            ...
            try {
                Uri uri3 = uri2;
                cursor = this.context.getContentResolver().query(uri3, PROJECTION, (String) null, (String[]) null, (String) null);
                if (cursor == null || !cursor.moveToFirst()) {
                    throw new FileNotFoundException("Failed to media store entry for: " + uri3);
                }
                ...
                throw new FileNotFoundException("File path was empty in media store for: " + uri3);
            } catch (Throwable th) {
                Throwable th2 = th;
                if (cursor != null) {
                    cursor.close();
