...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        public ListenableFuture<V> loadAsync(K k, int i, LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> cacheLoader) {
            ...
            loadFuture.addListener(new LocalCache$Segment$$ExternalSyntheticLambda0(this, k, i, loadingValueReference, loadFuture), MoreExecutors.directExecutor());
            return loadFuture;
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$loadAsync$0$com-google-common-cache-LocalCache$Segment  reason: not valid java name */
        public /* synthetic */ void m336lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(Object obj, int i, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
            try {
        ...
        public V getAndRecordStats(K r4, int r5, com.google.common.cache.LocalCache.LoadingValueReference<K, V> r6, com.google.common.util.concurrent.ListenableFuture<V> r7) throws java.util.concurrent.ExecutionException {
            /*
                ...
                java.lang.Object r7 = com.google.common.util.concurrent.Uninterruptibles.getUninterruptibly(r7)     // Catch:{ all -> 0x003e }
                if (r7 == 0) goto L_0x0025
                com.google.common.cache.AbstractCache$StatsCounter r0 = r3.statsCounter     // Catch:{ all -> 0x0023 }
                long r1 = r6.elapsedNanos()     // Catch:{ all -> 0x0023 }
                r0.recordLoadSuccess(r1)     // Catch:{ all -> 0x0023 }
                r3.storeLoadedValue(r4, r5, r6, r7)     // Catch:{ all -> 0x0023 }
            ...
            L_0x0023:
                ...
                goto L_0x0040
            L_0x0025:
                com.google.common.cache.CacheLoader$InvalidCacheLoadException r1 = new com.google.common.cache.CacheLoader$InvalidCacheLoadException     // Catch:{ all -> 0x0023 }
                java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x0023 }
                r2.<init>(r0)     // Catch:{ all -> 0x0023 }
                java.lang.StringBuilder r0 = r2.append(r4)     // Catch:{ all -> 0x0023 }
                java.lang.String r2 = "."
                java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x0023 }
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        public ListenableFuture<V> loadFuture(K k, CacheLoader<? super K, V> cacheLoader) {
            try {
                ...
                return Futures.transform(reload, new LocalCache$LoadingValueReference$$ExternalSyntheticLambda0(this), MoreExecutors.directExecutor());
            } catch (Throwable th) {
        ...
        public /* synthetic */ Object m335lambda$loadFuture$0$comgooglecommoncacheLocalCache$LoadingValueReference(Object obj) {
            set(obj);
            return obj;
        }
    ...
    public com.google.common.collect.ImmutableMap<K, V> getAll(java.lang.Iterable<? extends K> r8) throws java.util.concurrent.ExecutionException {
        ...
        L_0x002d:
            ...
            goto L_0x000e
        L_0x0030:
            boolean r8 = r1.isEmpty()     // Catch:{ all -> 0x009a }
        ...
        L_0x0058:
            ...
            java.lang.StringBuilder r4 = r4.append(r6)     // Catch:{ UnsupportedLoadingOperationException -> 0x0071 }
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ UnsupportedLoadingOperationException -> 0x0071 }
        ...
        L_0x0071:
            java.util.Iterator r8 = r1.iterator()     // Catch:{ all -> 0x009a }
        L_0x0075:
            boolean r1 = r8.hasNext()     // Catch:{ all -> 0x009a }
            if (r1 == 0) goto L_0x008b
            java.lang.Object r1 = r8.next()     // Catch:{ all -> 0x009a }
            int r3 = r3 + -1
            com.google.common.cache.CacheLoader<? super K, V> r4 = r7.defaultLoader     // Catch:{ all -> 0x009a }
            java.lang.Object r4 = r7.get(r1, r4)     // Catch:{ all -> 0x009a }
            r0.put(r1, r4)     // Catch:{ all -> 0x009a }
            goto L_0x0075
        L_0x008b:
            com.google.common.collect.ImmutableMap r8 = com.google.common.collect.ImmutableMap.copyOf(r0)     // Catch:{ all -> 0x009a }
