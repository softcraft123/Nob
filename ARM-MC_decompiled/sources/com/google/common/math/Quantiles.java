...
public final class Quantiles {
    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            if (Quantiles.containsNaN(dArr2)) {
            ...
            Quantiles.selectAllInPlace(iArr5, 0, i3 - 1, dArr2, 0, dArr2.length - 1);
            ...
            while (true) {
                ...
                if (i7 == 0) {
                    ...
                    linkedHashMap2.put(Integer.valueOf(iArr7[i]), Double.valueOf(Quantiles.interpolate(dArr[i6], dArr[i6 + 1], (double) i7, (double) this.scale)));
                }
                i++;
            }
        }
