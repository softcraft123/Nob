    ...
    private static final class PerListenerQueue<L> implements Runnable {
        ...
        public void run() {
            ...
            L_0x0000:
                ...
                boolean r2 = r9.isThreadScheduled     // Catch:{ all -> 0x0050 }
                com.google.common.base.Preconditions.checkState(r2)     // Catch:{ all -> 0x0050 }
                java.util.Queue<com.google.common.util.concurrent.ListenerCallQueue$Event<L>> r2 = r9.waitQueue     // Catch:{ all -> 0x0050 }
                java.lang.Object r2 = r2.poll()     // Catch:{ all -> 0x0050 }
                com.google.common.util.concurrent.ListenerCallQueue$Event r2 = (com.google.common.util.concurrent.ListenerCallQueue.Event) r2     // Catch:{ all -> 0x0050 }
                java.util.Queue<java.lang.Object> r3 = r9.labelQueue     // Catch:{ all -> 0x0050 }
                java.lang.Object r3 = r3.poll()     // Catch:{ all -> 0x0050 }
                if (r2 != 0) goto L_0x001f
                r9.isThreadScheduled = r0     // Catch:{ all -> 0x0050 }
            ...
            L_0x0026:
                r2 = move-exception
                java.util.logging.Logger r4 = com.google.common.util.concurrent.ListenerCallQueue.logger     // Catch:{ all -> 0x005d }
                ...
                L r7 = r9.listener     // Catch:{ all -> 0x005d }
                java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ all -> 0x005d }
                java.lang.String r7 = " "
                java.lang.StringBuilder r6 = r6.append(r7)     // Catch:{ all -> 0x005d }
                java.lang.StringBuilder r3 = r6.append(r3)     // Catch:{ all -> 0x005d }
            ...
            L_0x005e:
                ...
                monitor-enter(r9)
                r9.isThreadScheduled = r0     // Catch:{ all -> 0x0065 }
