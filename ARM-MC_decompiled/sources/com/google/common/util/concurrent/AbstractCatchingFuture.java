...
abstract class AbstractCatchingFuture<V, X extends Throwable, F, T> extends FluentFuture.TrustedFuture<V> implements Runnable {
    ...
    public final void run() {
        ...
        L_0x007d:
            ...
            return
        L_0x0087:
            java.lang.Object r0 = r8.doFallback(r2, r4)     // Catch:{ all -> 0x0093 }
            r8.exceptionType = r3
            r8.fallback = r3
            r8.setResult(r0)
            return
        L_0x0093:
            r0 = move-exception
            com.google.common.util.concurrent.Platform.restoreInterruptIfIsInterruptedException(r0)     // Catch:{ all -> 0x009f }
            r8.setException(r0)     // Catch:{ all -> 0x009f }
            r8.exceptionType = r3
            r8.fallback = r3
            return
        L_0x009f:
