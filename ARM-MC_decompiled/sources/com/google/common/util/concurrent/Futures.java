...
public final class Futures extends GwtFuturesCatchingSpecialization {
    ...
    public static <O> ListenableFuture<O> scheduleAsync(AsyncCallable<O> asyncCallable, long j, TimeUnit timeUnit, ScheduledExecutorService scheduledExecutorService) {
        TrustedListenableFutureTask<O> create = TrustedListenableFutureTask.create(asyncCallable);
        create.addListener(new Futures$$ExternalSyntheticLambda1(scheduledExecutorService.schedule(create, j, timeUnit)), MoreExecutors.directExecutor());
        return create;
    }
    ...
    public static <T> ImmutableList<ListenableFuture<T>> inCompletionOrder(Iterable<? extends ListenableFuture<? extends T>> iterable) {
        ...
        for (int i2 = 0; i2 < gwtCompatibleToArray.length; i2++) {
            gwtCompatibleToArray[i2].addListener(new Futures$$ExternalSyntheticLambda0(inCompletionOrderState, build, i2), MoreExecutors.directExecutor());
        }
        return build;
    }
