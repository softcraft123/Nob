    ...
    public static long copy(ReadableByteChannel readableByteChannel, WritableByteChannel writableByteChannel) throws IOException {
        ...
        if (readableByteChannel instanceof FileChannel) {
            ...
            while (true) {
                ...
                long transferTo = fileChannel.transferTo(j2, 524288, writableByteChannel2);
                j2 += transferTo;
            ...
            WritableByteChannel writableByteChannel3 = writableByteChannel;
            ByteBuffer wrap = ByteBuffer.wrap(createBuffer());
            while (readableByteChannel.read(wrap) != -1) {
                Java8Compatibility.flip(wrap);
                while (wrap.hasRemaining()) {
                    j += (long) writableByteChannel3.write(wrap);
                }
