...
final class TableCollectors {
    static <T, R, C, V> Collector<T, ?, ImmutableTable<R, C, V>> toImmutableTable(Function<? super T, ? extends R> function, Function<? super T, ? extends C> function2, Function<? super T, ? extends V> function3) {
        ...
        return Collector.of(new TableCollectors$$ExternalSyntheticLambda8(), new TableCollectors$$ExternalSyntheticLambda9(function, function2, function3), new TableCollectors$$ExternalSyntheticLambda10(), new TableCollectors$$ExternalSyntheticLambda1(), new Collector.Characteristics[0]);
    }
    ...
    static <T, R, C, V> Collector<T, ?, ImmutableTable<R, C, V>> toImmutableTable(Function<? super T, ? extends R> function, Function<? super T, ? extends C> function2, Function<? super T, ? extends V> function3, BinaryOperator<V> binaryOperator) {
        ...
        return Collector.of(new TableCollectors$$ExternalSyntheticLambda4(), new TableCollectors$$ExternalSyntheticLambda5(function, function2, function3, binaryOperator), new TableCollectors$$ExternalSyntheticLambda6(binaryOperator), new TableCollectors$$ExternalSyntheticLambda7(), new Collector.Characteristics[0]);
    }
    ...
    static <T, R, C, V, I extends Table<R, C, V>> Collector<T, ?, I> toTable(Function<? super T, ? extends R> function, Function<? super T, ? extends C> function2, Function<? super T, ? extends V> function3, Supplier<I> supplier) {
        return toTable(function, function2, function3, new TableCollectors$$ExternalSyntheticLambda0(), supplier);
    }
    ...
    static <T, R, C, V, I extends Table<R, C, V>> Collector<T, ?, I> toTable(Function<? super T, ? extends R> function, Function<? super T, ? extends C> function2, Function<? super T, ? extends V> function3, BinaryOperator<V> binaryOperator, Supplier<I> supplier) {
        ...
        return Collector.of(supplier, new TableCollectors$$ExternalSyntheticLambda2(function, function2, function3, binaryOperator), new TableCollectors$$ExternalSyntheticLambda3(binaryOperator), new Collector.Characteristics[0]);
    }
    ...
    private static final class MutableCell<R, C, V> extends Tables.AbstractCell<R, C, V> {
        ...
        MutableCell(R r, C c, V v) {
            ...
            this.value = Preconditions.checkNotNull(v, Values.VECTOR_MAP_VECTORS_KEY);
        }
