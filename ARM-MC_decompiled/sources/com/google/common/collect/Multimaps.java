...
public final class Multimaps {
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            Map<K, Collection<V>> unmodifiableMap = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new Multimaps$UnmodifiableMultimap$$ExternalSyntheticLambda0()));
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        public Collection<V2> m338lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(@ParametricNullness K k, Collection<V1> collection) {
        ...
        public Collection<V2> get(@ParametricNullness K k) {
            return m338lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(k, this.fromMultimap.get(k));
        }
        ...
        public Collection<V2> removeAll(@CheckForNull Object obj) {
            return m338lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(obj, this.fromMultimap.removeAll(obj));
        }
    ...
    static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends Maps.EntrySet<K, Collection<V>> {
            ...
            public /* synthetic */ Collection m337lambda$iterator$0$comgooglecommoncollectMultimaps$AsMap$EntrySet(Object obj) {
