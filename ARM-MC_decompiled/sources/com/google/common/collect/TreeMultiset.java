...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    public boolean setCount(@ParametricNullness E e, int i, int i2) {
        ...
        if (avlNode != null) {
            int[] iArr = new int[1];
            int i3 = i;
            this.rootReference.checkAndSet(avlNode, avlNode.setCount(comparator(), e, i3, i2, iArr));
            return iArr[0] == i3;
        } else if (i != 0) {
            return false;
        } else {
        ...
        public AvlNode<E> setCount(Comparator<? super E> comparator, @ParametricNullness E e, int i, int i2, int[] iArr) {
            ...
            if (compare < 0) {
                ...
                if (avlNode == null) {
                    ...
                    int i4 = i2;
                    int[] iArr2 = iArr;
                    this.left = avlNode.setCount(comparator, e, i3, i4, iArr2);
                    int i5 = iArr2[0];
                    if (i5 == i3) {
                        if (i4 == 0 && i5 != 0) {
                            this.distinctElements--;
                ...
                if (compare > 0) {
                    ...
                    if (avlNode2 == null) {
                        iArr3[0] = 0;
                        if (i6 == 0 && i7 > 0) {
                            return addRightChild(e2, i7);
                        }
                    } else {
                        this.right = avlNode2.setCount(comparator2, e2, i6, i7, iArr3);
                        int i8 = iArr3[0];
                        if (i8 == i6) {
                            if (i7 == 0 && i8 != 0) {
                                this.distinctElements--;
