...
final class SplitInstallManagerKtxKt$runTask$3$1 extends Lambda implements Function1<Throwable, Unit> {
    final /* synthetic */ Function0<Unit> $onCanceled;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SplitInstallManagerKtxKt$runTask$3$1(Function0<Unit> function0) {
        super(1);
