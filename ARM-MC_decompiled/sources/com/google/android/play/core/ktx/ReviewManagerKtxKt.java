...
public final class ReviewManagerKtxKt {
    ...
    public static final <T> Object runTask(Task<T> task, Function0<Unit> function0, Continuation<? super T> continuation) {
        ...
        if (!task.isComplete()) {
            task.addOnSuccessListener(new ReviewManagerKtxKt$sam$com_google_android_gms_tasks_OnSuccessListener$0(new ReviewManagerKtxKt$runTask$3$2(cancellableContinuation)));
