...
final class bn {
    ...
    bn(Context context, s sVar, at atVar, k kVar) {
        ...
        ae aeVar = new ae(context2, sVar, "ExpressIntegrityService", bo.a, bd.a, (y) null);
        this.a = aeVar;
        aeVar.c().post(new be(this, taskCompletionSource, context2));
    }
    ...
    public final Task c(Activity activity, Bundle bundle) {
        ...
        this.a.t(new bh(this, taskCompletionSource, bundle2, activity, taskCompletionSource, i), taskCompletionSource);
