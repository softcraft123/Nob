...
public final class zzi {
    ...
    public zzi(Context context) {
        ...
        if (zzw.zza(context)) {
            ...
            this.zza = new zzt(context2, zzb, "com.google.android.finsky.inappreviewservice.InAppReviewService", new Intent("com.google.android.finsky.BIND_IN_APP_REVIEW_SERVICE").setPackage("com.android.vending"), new zze(), (zzo) null);
        }
    }
    ...
    public final Task zza() {
        ...
        zzi.zzc("requestInAppReview (%s)", str);
        if (this.zza == null) {
            zzi.zza("Play Store app is either not installed or not the official version", new Object[0]);
