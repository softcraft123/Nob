...
public final class zzbk {
    ...
    public static Object zzc(Class cls) {
        try {
            ...
            throw new zzbl(String.format("Failed to invoke default constructor on class %s", new Object[]{cls.getName()}), e);
        }
    }
    ...
    public static Object zzd(Object obj, String str, Class cls, Class cls2, Object obj2) {
        try {
            ...
            throw new zzbl(String.format("Failed to invoke method %s on an object of type %s", new Object[]{str, obj.getClass()}), e);
        }
    }
    ...
    public static Object zzf(Class cls, String str, Class cls2, Class cls3, Object obj) {
        try {
            ...
            throw new zzbl(String.format("Failed to invoke static method %s on type %s", new Object[]{"isDexOptNeeded", cls}), e);
        }
    }
    ...
    public static Object zzg(Class cls, String str, Class cls2, Class cls3, Object obj, Class cls4, Object obj2) {
        try {
            ...
            throw new zzbl(String.format("Failed to invoke static method %s on type %s", new Object[]{"optimizedPathFor", cls}), e);
        }
    }
    ...
    private static Field zzh(Object obj, String str) {
        ...
        throw new zzbl(String.format("Failed to find a field named %s on an object of instance %s", new Object[]{str, obj.getClass().getName()}));
    }
    ...
    private static Method zzi(Class cls, String str, Class... clsArr) {
        ...
        throw new zzbl(String.format("Could not find a method named %s with parameters %s in type %s", new Object[]{str, Arrays.asList(clsArr), cls}));
    }
}
