...
public final /* synthetic */ class zzg implements zzr {
    ...
    public /* synthetic */ zzg(Integer num, int i, int i2, Long l, Long l2, List list, List list2) {
        this.zza = num;
        this.zzb = i;
        this.zzc = i2;
        this.zzd = l;
    ...
    public final SplitInstallSessionState zza(SplitInstallSessionState splitInstallSessionState) {
        ...
        if (list == null) {
            list = create.moduleNames();
        }
        if (list2 == null) {
            list2 = create.languages();
        }
        return SplitInstallSessionState.create(sessionId, i, i2, bytesDownloaded, j, list, list2);
    }
}
