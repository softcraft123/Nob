...
public final class zzam {
    ...
    public zzam(Context context, zze zze2, zzah zzah) {
        zzal zzal = new zzal(new zza(zze2));
        this.zza = zze2;
        this.zzb = zzah;
        this.zzc = context;
        this.zzd = zzal;
    ...
    public final boolean zzc(java.io.File[] r13) {
        ...
        L_0x0037:
            ...
            r6 = r13[r5]
            java.lang.String r6 = r6.getAbsolutePath()     // Catch:{ Exception -> 0x00b5 }
            java.security.cert.X509Certificate[][] r7 = com.google.android.play.core.splitinstall.internal.zzi.zza(r6)     // Catch:{ Exception -> 0x0099 }
            if (r7 == 0) goto L_0x0083
            int r8 = r7.length     // Catch:{ Exception -> 0x00b5 }
            if (r8 == 0) goto L_0x0083
            r8 = r7[r4]     // Catch:{ Exception -> 0x00b5 }
            int r8 = r8.length     // Catch:{ Exception -> 0x00b5 }
            if (r8 != 0) goto L_0x0050
            goto L_0x0083
        L_0x0050:
            boolean r6 = r3.isEmpty()     // Catch:{ Exception -> 0x00b5 }
            if (r6 == 0) goto L_0x005c
            java.lang.String r13 = "No certificates found for app."
            android.util.Log.e(r2, r13)     // Catch:{ Exception -> 0x00b5 }
            goto L_0x00af
        L_0x005c:
            java.util.Iterator r6 = r3.iterator()     // Catch:{ Exception -> 0x00b5 }
        L_0x0060:
            boolean r8 = r6.hasNext()     // Catch:{ Exception -> 0x00b5 }
            if (r8 == 0) goto L_0x0037
            java.lang.Object r8 = r6.next()     // Catch:{ Exception -> 0x00b5 }
            java.security.cert.X509Certificate r8 = (java.security.cert.X509Certificate) r8     // Catch:{ Exception -> 0x00b5 }
            int r9 = r7.length     // Catch:{ Exception -> 0x00b5 }
            r10 = r4
        L_0x006e:
            if (r10 >= r9) goto L_0x007d
            r11 = r7[r10]     // Catch:{ Exception -> 0x00b5 }
            r11 = r11[r4]     // Catch:{ Exception -> 0x00b5 }
            boolean r11 = r11.equals(r8)     // Catch:{ Exception -> 0x00b5 }
            if (r11 != 0) goto L_0x0060
            int r10 = r10 + 1
            goto L_0x006e
        L_0x007d:
            java.lang.String r13 = "There's an app certificate that doesn't sign the split."
            android.util.Log.i(r2, r13)     // Catch:{ Exception -> 0x00b5 }
            goto L_0x00af
        L_0x0083:
            java.lang.StringBuilder r13 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x00b5 }
            r13.<init>()     // Catch:{ Exception -> 0x00b5 }
            r13.append(r1)     // Catch:{ Exception -> 0x00b5 }
            r13.append(r6)     // Catch:{ Exception -> 0x00b5 }
            r13.append(r0)     // Catch:{ Exception -> 0x00b5 }
            java.lang.String r13 = r13.toString()     // Catch:{ Exception -> 0x00b5 }
            android.util.Log.e(r2, r13)     // Catch:{ Exception -> 0x00b5 }
            goto L_0x00af
        L_0x0099:
            r13 = move-exception
            ...
            r3.append(r1)     // Catch:{ Exception -> 0x00b5 }
            ...
            android.util.Log.e(r2, r0, r13)     // Catch:{ Exception -> 0x00b5 }
        L_0x00af:
