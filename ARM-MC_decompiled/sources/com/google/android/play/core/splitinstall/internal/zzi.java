...
public final class zzi {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= 8) {
                                                    ...
                                                    if (i3 > slice.remaining()) {
                                                        ...
                                                        X509Certificate[][] zzl = zzl(randomAccessFile.getChannel(), new zze(zze(slice, i3 - 4), longValue2, zza, longValue, byteBuffer2, (zzd) null));
    ...
    private static void zzh(Map map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            ...
            long j4 = j;
            zzc zzc = new zzc(fileChannel2, 0, j4);
            zzc zzc2 = new zzc(fileChannel2, j2, j3 - j2);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            zzj.zzd(duplicate, j4);
    ...
    private static byte[][] zzk(int[] iArr, zzb[] zzbArr) throws DigestException {
        ...
        while (true) {
            ...
            j2 += (zzbArr[i4].zza() + 1048575) / 1048576;
            i4++;
        }
        if (j2 < 2097151) {
            ...
            while (i8 < i) {
                ...
                while (zza > 0) {
                    ...
                    try {
                        zzb.zzb(messageDigestArr, j3, min);
                        int i13 = 0;
                        while (i13 < iArr2.length) {
                            ...
                            int digest = messageDigest.digest(bArr5, (i11 * zzb2) + 5, zzb2);
                            if (digest == zzb2) {
                                i13++;
                                c = c2;
                            } else {
