...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public AppBarLayout(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        ...
        L_0x002d:
            ...
            android.content.res.ColorStateList r1 = r7.getBackgroundCSL()
            ...
            r7.initializeLiftOnScrollWithColor(r2)
            goto L_0x0062
        L_0x005f:
            r7.initializeLiftOnScrollWithElevation(r0, r2)
        L_0x0062:
            androidx.core.view.ViewCompat.setBackground(r7, r2)
        L_0x0065:
    ...
    public /* synthetic */ void m253lambda$initializeLiftOnScrollWithColor$0$comgoogleandroidmaterialappbarAppBarLayout(MaterialShapeDrawable materialShapeDrawable, ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m254lambda$initializeLiftOnScrollWithElevation$1$comgoogleandroidmaterialappbarAppBarLayout(MaterialShapeDrawable materialShapeDrawable, ValueAnimator valueAnimator) {
            ...
            if (getTopBottomOffsetForScrollingSibling() != 0) {
                if (view.canScrollVertically(-1)) {
                    ...
                    if (i != 0) {
                        ...
                        ViewCompat.replaceAccessibilityAction(coordinatorLayout2, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_SCROLL_BACKWARD, (CharSequence) null, new AccessibilityViewCommand() {
