...
public final class Cam16 {
    ...
    static Cam16 fromXyzInViewingConditions(double d, double d2, double d3, ViewingConditions viewingConditions) {
        ...
        double flRoot = viewingConditions.getFlRoot() * (4.0d / viewingConditions.getC()) * Math.sqrt(d15) * (viewingConditions.getAw() + 4.0d);
        ...
        double sqrt = pow5 * Math.sqrt(d15);
        ...
        double d16 = (1.7000000000000002d * pow4) / ((0.007d * pow4) + 1.0d);
        double log1p = Math.log1p(0.0228d * flRoot2) * 43.859649122807014d;
        return new Cam16(d14, sqrt, pow4, flRoot, flRoot2, sqrt2, d16, log1p * Math.cos(radians), log1p * Math.sin(radians));
    }
