...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    public AnimatorSet onCreateExpandedStateChangeAnimation(View view, View view2, boolean z, boolean z2) {
        ...
        final boolean z3 = z;
        boolean z4 = z2;
        createElevationAnimation(view3, view4, z3, z4, onCreateMotionSpec, arrayList, arrayList2);
        RectF rectF = this.tmpRectF1;
        createTranslationAnimation(view3, view4, z3, z4, onCreateMotionSpec, arrayList, arrayList2, rectF);
        boolean z5 = z4;
        float width = rectF.width();
        float height = rectF.height();
        FabTransformationSpec fabTransformationSpec = onCreateMotionSpec;
        createDependencyTranslationAnimation(view3, view4, z3, fabTransformationSpec, arrayList);
        FabTransformationSpec fabTransformationSpec2 = fabTransformationSpec;
        boolean z6 = z5;
        createIconFadeAnimation(view3, view4, z3, z6, fabTransformationSpec2, arrayList, arrayList2);
        ArrayList arrayList3 = arrayList;
        ArrayList arrayList4 = arrayList2;
        createExpansionAnimation(view3, view4, z3, z6, fabTransformationSpec2, width, height, arrayList3, arrayList4);
        ArrayList arrayList5 = arrayList3;
        ArrayList arrayList6 = arrayList4;
        createColorAnimation(view3, view4, z3, z6, fabTransformationSpec2, arrayList5, arrayList6);
        createChildrenFadeAnimation(view3, view4, z3, z6, fabTransformationSpec2, arrayList5, arrayList6);
        ...
        for (int i = 0; i < size; i++) {
            animatorSet.addListener((Animator.AnimatorListener) arrayList6.get(i));
        }
        return animatorSet;
    }
    ...
    private void createExpansionAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, float f, float f2, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view4 instanceof CircularRevealWidget) {
            ...
            if (z) {
                ...
                int i = (int) calculateRevealCenterY;
                int i2 = (int) calculateRevealCenterX;
                long delay = timing.getDelay();
                View view5 = view2;
                createPreFillRadialExpansion(view5, delay, i2, i, f3, list);
                ...
                int i4 = i3;
                createPostFillRadialExpansion(view2, delay2, duration, totalDuration, i4, i, width, list);
