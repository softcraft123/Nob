...
class SearchBarAnimationHelper {
    ...
    public void startExpandAnimation(SearchBar searchBar, View view, AppBarLayout appBarLayout, boolean z) {
        ...
        View view2 = view;
        view2.post(new SearchBarAnimationHelper$$ExternalSyntheticLambda3(this, searchBar, view2, appBarLayout, z));
    }
    ...
    public /* synthetic */ void m294lambda$startExpandAnimation$0$comgoogleandroidmaterialsearchSearchBarAnimationHelper(SearchBar searchBar, View view, AppBarLayout appBarLayout, boolean z) {
        AnimatorSet animatorSet = new AnimatorSet();
