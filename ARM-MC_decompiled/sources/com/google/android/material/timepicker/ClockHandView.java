...
class ClockHandView extends View {
    ...
    public /* synthetic */ void m325lambda$setHandRotation$0$comgoogleandroidmaterialtimepickerClockHandView(ValueAnimator valueAnimator) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        boolean handleTouchInput = this.changedDuringTouch | handleTouchInput(x, y, z3, z2, z);
        this.changedDuringTouch = handleTouchInput;
        if (handleTouchInput && z && (onActionUpListener2 = this.onActionUpListener) != null) {
