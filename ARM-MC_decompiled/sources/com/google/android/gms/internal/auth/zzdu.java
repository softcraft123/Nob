...
final class zzdu {
    ...
    static int zzc(zzgi zzgi, byte[] bArr, int i, int i2, int i3, zzdt zzdt) throws IOException {
        ...
        zzgi zzgi2 = zzgi;
        zzdt zzdt2 = zzdt;
        int zzl = zzl(zzd, zzgi2, bArr, i, i2, i3, zzdt2);
        zzgi2.zze(zzd);
        zzdt2.zzc = zzd;
        return zzl;
    }
    ...
    static int zzd(zzgi zzgi, byte[] bArr, int i, int i2, zzdt zzdt) throws IOException {
        ...
        zzgi zzgi2 = zzgi;
        zzdt zzdt2 = zzdt;
        int zzm = zzm(zzd, zzgi2, bArr, i, i2, zzdt2);
        zzgi2.zze(zzd);
        zzdt2.zzc = zzd;
        return zzm;
    }
    ...
    static int zzg(int i, byte[] bArr, int i2, int i3, zzha zzha, zzdt zzdt) throws zzfb {
        if ((i >>> 3) != 0) {
            ...
            if (i4 == 0) {
                zzdt zzdt2 = zzdt;
                int zzk = zzk(bArr, i2, zzdt2);
                zzha.zzh(i, Long.valueOf(zzdt2.zzb));
                return zzk;
            } else if (i4 == 1) {
                ...
                if (i5 < 0) {
                    ...
                    if (i5 == 0) {
                        ...
                        zzha.zzh(i, zzef.zzk(bArr2, zzh, i5));
                    }
                    return zzh + i5;
                } else {
                    throw zzfb.zzf();
                ...
                while (true) {
                    ...
                    i2 = zzg(i7, bArr, zzh2, i3, zzd, zzdt);
                }
                if (i2 > i3 || i7 != i6) {
                    throw zzfb.zzd();
                }
    ...
    static int zzl(Object obj, zzgi zzgi, byte[] bArr, int i, int i2, int i3, zzdt zzdt) throws IOException {
        zzga zzga = (zzga) zzgi;
        Object obj2 = obj;
        int zzb = zzga.zzb(obj2, bArr, i, i2, i3, zzdt);
        zzdt.zzc = obj2;
        return zzb;
    }
