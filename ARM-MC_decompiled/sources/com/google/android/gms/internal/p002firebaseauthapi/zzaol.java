...
interface zzaol {
    ...
    void zza(int i, zzajv zzajv) throws IOException;

    <K, V> void zza(int i, zzamd<K, V> zzamd, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzanb zzanb) throws IOException;
    ...
    @Deprecated
    void zza(int i, List<?> list, zzanb zzanb) throws IOException;
    ...
    void zzb(int i, Object obj, zzanb zzanb) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzanb zzanb) throws IOException;
