...
abstract class zzaff<ResultT, CallbackT> implements zzafq<ResultT> {
    ...
    public final zzaff<ResultT, CallbackT> zza(zzau zzau) {
    ...
    static /* synthetic */ void zza(zzaff zzaff) {
        zzaff.zzb();
        Preconditions.checkState(zzaff.zzu, "no success or failure set on method implementation");
    }

    static /* synthetic */ void zza(zzaff zzaff, Status status) {
        zzau zzau = zzaff.zzf;
        if (zzau != null) {
            zzau.zza(status);
        }
