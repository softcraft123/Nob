...
public final class zzaen {
    ...
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        L_0x00aa:
            ...
            return r0
        L_0x00b6:
            com.google.firebase.auth.zzad r3 = new com.google.firebase.auth.zzad
            java.lang.String r0 = zza((int) r0)
            r3.<init>(r0, r1)
            return r3
        L_0x00c0:
    ...
    public static FirebaseAuthMultiFactorException zza(FirebaseAuth firebaseAuth, zzaas zzaas, FirebaseUser firebaseUser) {
        zzu.zza(firebaseAuth);
        zzu.zza(zzaas);
        Pair pair = zza.get(17078);
        return new FirebaseAuthMultiFactorException((String) pair.first, (String) pair.second, zzal.zza(zzaas, firebaseAuth, firebaseUser));
    }
