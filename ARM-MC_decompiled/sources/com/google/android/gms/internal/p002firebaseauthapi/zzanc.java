...
interface zzanc {
    ...
    <T> void zza(T t, zzanb<T> zzanb, zzaku zzaku) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzanb<T> zzanb, zzaku zzaku) throws IOException;

    <K, V> void zza(Map<K, V> map, zzamd<K, V> zzamd, zzaku zzaku) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t, zzanb<T> zzanb, zzaku zzaku) throws IOException;

    void zzb(List<zzajv> list) throws IOException;

    <T> void zzb(List<T> list, zzanb<T> zzanb, zzaku zzaku) throws IOException;
