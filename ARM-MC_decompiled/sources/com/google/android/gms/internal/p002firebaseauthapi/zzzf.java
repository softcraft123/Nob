...
public final class zzzf {
    ...
    public static ECPrivateKey zza(zzzi zzzi, byte[] bArr) throws GeneralSecurityException {
        return (ECPrivateKey) zzzj.zze.zza("EC").generatePrivate(new ECPrivateKeySpec(zzne.zza(bArr), zza(zzzi)));
    }

    public static ECPublicKey zza(ECParameterSpec eCParameterSpec, zzzh zzzh, byte[] bArr) throws GeneralSecurityException {
        return (ECPublicKey) zzzj.zze.zza("EC").generatePublic(new ECPublicKeySpec(zza(eCParameterSpec.getCurve(), zzzh, bArr), eCParameterSpec));
    }

    public static ECParameterSpec zza(zzzi zzzi) throws NoSuchAlgorithmException {
        int ordinal = zzzi.ordinal();
        if (ordinal == 0) {
            return zznj.zza;
        }
        if (ordinal == 1) {
        ...
        throw new NoSuchAlgorithmException("curve not implemented:" + String.valueOf(zzzi));
    }

    public static ECPoint zza(EllipticCurve ellipticCurve, zzzh zzzh, byte[] bArr) throws GeneralSecurityException {
