...
public final class zznj {
    ...
    private static zzni zza(zzni zzni, zzni zzni2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzni.zza()) {
            return zzni2;
        }
        if (zzni2.zza()) {
        ...
        BigInteger mod = zzni.zzd.multiply(zzni.zzd).mod(bigInteger2);
        BigInteger mod2 = zzni2.zzd.multiply(zzni2.zzd).mod(bigInteger2);
        BigInteger mod3 = zzni.zzb.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzni2.zzb.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zzni.zzc.multiply(zzni2.zzd).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zzni2.zzc.multiply(zzni.zzd).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (!mod3.equals(mod4)) {
            ...
            BigInteger add = zzni.zzd.add(zzni2.zzd);
            ...
            return zza(zzni, bigInteger, bigInteger2);
        }
    }

    private static zzni zza(zzni zzni, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzni.zzc.equals(BigInteger.ZERO)) {
            return zzni.zza;
        }
        BigInteger mod = zzni.zzb.multiply(zzni.zzb).mod(bigInteger2);
        BigInteger mod2 = zzni.zzc.multiply(zzni.zzc).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzni.zzd.multiply(zzni.zzd).mod(bigInteger2);
        BigInteger add = zzni.zzb.add(mod2);
        ...
        BigInteger add3 = zzni.zzc.add(zzni.zzd);
