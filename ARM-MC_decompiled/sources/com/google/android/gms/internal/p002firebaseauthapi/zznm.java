...
public final class zznm {
    ...
    static void zzb(long[] r44, long[] r45, long[] r46) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zznm.zzb(long[], long[], long[]):void");
    }
    ...
    public static byte[] zzc(long[] jArr) {
        ...
        while (true) {
            ...
            while (i4 < 9) {
                ...
                copyOf[i4] = j + ((long) (i6 << i5));
                i4++;
                copyOf[i4] = copyOf[i4] - ((long) i6);
            }
            long j2 = copyOf[9];
            int i7 = -((int) (((j2 >> 31) & j2) >> 25));
            copyOf[9] = j2 + ((long) (i7 << 25));
            copyOf[0] = copyOf[0] - (((long) i7) * 19);
            i3++;
        }
        long j3 = copyOf[0];
        int i8 = -((int) (((j3 >> 31) & j3) >> 26));
        copyOf[0] = j3 + ((long) (i8 << 26));
        copyOf[1] = copyOf[1] - ((long) i8);
        int i9 = 0;
        while (i9 < 2) {
            int i10 = i2;
            while (i10 < 9) {
                long j4 = copyOf[i10];
                int i11 = i10 & 1;
                copyOf[i10] = j4 & ((long) zzc[i11]);
                i10++;
                copyOf[i10] = copyOf[i10] + ((long) ((int) (j4 >> zzd[i11])));
                i2 = i2;
                i9 = i9;
            }
            int i12 = i2;
        ...
        long j6 = copyOf[i13] + (((long) ((int) (j5 >> 25))) * 19);
        copyOf[i13] = j6;
        ...
        copyOf[i13] = copyOf[i13] - ((long) (67108845 & i14));
        long j7 = (long) (33554431 & i14);
        copyOf[1] = copyOf[1] - j7;
        for (i = 2; i < 10; i += 2) {
            copyOf[i] = copyOf[i] - ((long) (67108863 & i14));
            int i21 = i + 1;
