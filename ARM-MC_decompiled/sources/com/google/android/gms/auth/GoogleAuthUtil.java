...
public final class GoogleAuthUtil extends zzl {
    ...
    private static TokenData zzg(Context context, Account account, String str, Bundle bundle, long j) throws IOException, GoogleAuthException {
        ...
        try {
            TokenData zza = zzl.zza(context2, account, str, bundle, 0, (Executor) null);
            ...
            Log.w("GoogleAuthUtil", "Error when getting token", googlePlayServicesAvailabilityException);
            throw new UserRecoverableNotifiedException("User intervention required. Notification has been pushed.", googlePlayServicesAvailabilityException);
        } catch (UserRecoverableAuthException e2) {
            UserRecoverableAuthException userRecoverableAuthException = e2;
            GooglePlayServicesUtil.cancelAvailabilityErrorNotifications(context2);
            Log.w("GoogleAuthUtil", "Error when getting token", userRecoverableAuthException);
            throw new UserRecoverableNotifiedException("User intervention required. Notification has been pushed.", userRecoverableAuthException);
        }
    }
