...
public class DetectedActivity extends AbstractSafeParcelable {
    ...
    public String toString() {
        ...
        int type = getType();
        if (type != 0) {
            str = type != 1 ? type != 2 ? type != 3 ? type != 4 ? type != 5 ? type != 7 ? type != 8 ? type != 16 ? type != 17 ? Integer.toString(type) : "IN_RAIL_VEHICLE" : "IN_ROAD_VEHICLE" : DebugCoroutineInfoImplKt.RUNNING : "WALKING" : "TILTING" : "UNKNOWN" : "STILL" : "ON_FOOT" : "ON_BICYCLE";
        } else {
            str = "IN_VEHICLE";
        }
        int i = this.zzc;
