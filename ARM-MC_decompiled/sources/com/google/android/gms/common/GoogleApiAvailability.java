...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final boolean zag(Activity activity, LifecycleFragment lifecycleFragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog zaa2 = zaa(activity2, i, zag.zad(lifecycleFragment, getErrorResolutionIntent(activity, i, "d"), 2), onCancelListener2, (DialogInterface.OnClickListener) null);
        if (zaa2 == null) {
            return false;
        }
        zad(activity2, zaa2, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener2);
        return true;
    }
    ...
    public boolean showErrorDialogFragment(Activity activity, int i, ActivityResultLauncher<IntentSenderRequest> activityResultLauncher, DialogInterface.OnCancelListener onCancelListener) {
        Activity activity2 = activity;
        DialogInterface.OnCancelListener onCancelListener2 = onCancelListener;
        Dialog zaa2 = zaa(activity2, i, (zag) null, onCancelListener2, new zac(this, activity, i, activityResultLauncher));
        if (zaa2 == null) {
            return false;
        }
        zad(activity2, zaa2, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener2);
