...
final class zaaa implements zaca {
    ...
    private zaaa(Context context, zabe zabe, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map map, Map map2, ClientSettings clientSettings, Api.AbstractClientBuilder abstractClientBuilder, Api.Client client, ArrayList arrayList, ArrayList arrayList2, Map map3, Map map4) {
        ...
        Map map5 = map4;
        this.zad = new zabi(context2, zabe2, lock2, looper2, googleApiAvailabilityLight2, map2, (ClientSettings) null, map5, (Api.AbstractClientBuilder) null, arrayList2, new zax(this, (zaw) null));
        Map map6 = map3;
        this.zae = new zabi(context2, zabe2, lock2, looper2, googleApiAvailabilityLight2, map, clientSettings, map6, abstractClientBuilder, arrayList, new zaz(this, (zay) null));
