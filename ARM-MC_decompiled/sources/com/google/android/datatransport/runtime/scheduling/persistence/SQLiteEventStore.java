...
public class SQLiteEventStore implements EventStore, SynchronizationGuard, ClientHealthMetricsStore {
    ...
    public /* synthetic */ Long m227lambda$persist$1$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(EventInternal eventInternal, TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        byte[] bArr;
        if (isStorageAtLimit()) {
        ...
        for (Map.Entry next : eventInternal.getMetadata().entrySet()) {
            ...
            contentValues3.put(Values.VECTOR_MAP_VECTORS_KEY, (String) next.getValue());
    ...
    public /* synthetic */ Object m229lambda$recordFailure$4$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(String str, String str2, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ Object m228lambda$recordFailure$3$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Cursor cursor) {
    ...
    public /* synthetic */ Boolean m222lambda$hasPendingEventsFor$6$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        Long transportContextId = getTransportContextId(sQLiteDatabase, transportContext);
        if (transportContextId == null) {
            return false;
        }
    ...
    public /* synthetic */ List m223lambda$loadBatch$8$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ Integer m221lambda$cleanUp$12$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(long j, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ Object m220lambda$cleanUp$11$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Cursor cursor) {
        while (cursor.moveToNext()) {
            int i = cursor.getInt(0);
    ...
    public /* synthetic */ Object m226lambda$loadEvents$14$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(List list, TransportContext transportContext, Cursor cursor) {
        while (cursor.moveToNext()) {
            boolean z = false;
    ...
    private Map<Long, Set<Metadata>> loadMetadata(SQLiteDatabase sQLiteDatabase, List<PersistedEvent> list) {
        ...
        sb.append(')');
        tryWithCursor(sQLiteDatabase.query("event_metadata", new String[]{"event_id", "name", Values.VECTOR_MAP_VECTORS_KEY}, sb.toString(), (String[]) null, (String) null, (String) null, (String) null), new SQLiteEventStore$$ExternalSyntheticLambda9(hashMap));
        return hashMap;
    }
    ...
    public /* synthetic */ ClientMetrics m225lambda$loadClientMetrics$20$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(String str, Map map, ClientMetrics.Builder builder, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ ClientMetrics m224lambda$loadClientMetrics$19$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Map map, ClientMetrics.Builder builder, Cursor cursor) {
        while (cursor.moveToNext()) {
    ...
    public /* synthetic */ Object m230lambda$resetClientMetrics$23$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(SQLiteDatabase sQLiteDatabase) {
