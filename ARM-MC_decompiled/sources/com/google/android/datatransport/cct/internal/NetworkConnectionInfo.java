...
public abstract class NetworkConnectionInfo {
    ...
    public enum NetworkType {
        ...
        static {
            ...
            sparseArray.put(1, networkType15);
            sparseArray.put(2, networkType19);
            sparseArray.put(3, networkType);
            sparseArray.put(4, networkType2);
            sparseArray.put(5, networkType3);
            sparseArray.put(6, networkType4);
            sparseArray.put(7, networkType5);
            sparseArray.put(8, networkType6);
            sparseArray.put(9, networkType7);
            sparseArray.put(10, networkType8);
            sparseArray.put(11, networkType9);
            sparseArray.put(12, networkType10);
            sparseArray.put(13, networkType11);
            sparseArray.put(14, networkType12);
            sparseArray.put(15, networkType16);
            sparseArray.put(16, networkType17);
            sparseArray.put(17, networkType18);
            sparseArray.put(-1, networkType13);
        }
    ...
    public enum MobileSubtype {
        ...
        static {
            ...
            valueMap = sparseArray;
            sparseArray.put(0, mobileSubtype13);
            sparseArray.put(1, mobileSubtype14);
            sparseArray.put(2, mobileSubtype20);
            sparseArray.put(3, mobileSubtype);
            sparseArray.put(4, mobileSubtype2);
            sparseArray.put(5, mobileSubtype3);
            sparseArray.put(6, mobileSubtype4);
            sparseArray.put(7, mobileSubtype5);
            sparseArray.put(8, mobileSubtype6);
            sparseArray.put(9, mobileSubtype7);
            sparseArray.put(10, mobileSubtype8);
            sparseArray.put(11, mobileSubtype9);
            sparseArray.put(12, mobileSubtype10);
            sparseArray.put(13, mobileSubtype11);
            sparseArray.put(14, mobileSubtype12);
