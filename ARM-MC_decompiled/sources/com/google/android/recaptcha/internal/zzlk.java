...
final class zzlk extends zzln {
    ...
    public final void zze(int i, zzle zzle) throws IOException {
        zzt((i << 3) | 2);
        zzt(zzle.zzd());
        zzle.zzh(this);
    }
    ...
    public final void zzm(int i, zzoi zzoi, zzow zzow) throws IOException {
        zzt((i << 3) | 2);
        zzt(((zzko) zzoi).zza(zzow));
        zzow.zzj(zzoi, this.zza);
    }

    public final void zzn(int i, zzoi zzoi) throws IOException {
        zzt(11);
        zzs(2, i);
        zzt(26);
        zzt(zzoi.zzo());
    ...
    public final void zzo(int i, zzle zzle) throws IOException {
        zzt(11);
        zzs(2, i);
        zze(3, zzle);
        zzt(12);
    ...
    public final void zzq(String str) throws IOException {
        ...
        try {
            ...
            if (zzA2 == zzA) {
                int i2 = i + zzA2;
                this.zzd = i2;
                int zzb2 = zzpv.zzb(str, this.zzb, i2, this.zzc - i2);
                this.zzd = i;
                zzt((zzb2 - i) - zzA2);
                this.zzd = zzb2;
                return;
        ...
        if (!zzln.zzc || this.zzc - this.zzd < 10) {
            ...
            while (true) {
                ...
                if ((j & -128) == 0) {
                    ...
                    int i4 = this.zzd;
                    this.zzd = i4 + 1;
                    zzps.zzn(bArr3, (long) i4, (byte) i3);
                    return;
                }
                byte[] bArr4 = this.zzb;
                int i5 = this.zzd;
                this.zzd = i5 + 1;
                zzps.zzn(bArr4, (long) i5, (byte) ((i3 | 128) & 255));
                j >>>= 7;
            }
        }
    }
