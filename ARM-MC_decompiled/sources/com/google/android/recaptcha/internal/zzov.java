...
interface zzov {
    ...
    @Deprecated
    void zzC(List list, zzow zzow, zzmo zzmo) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzow zzow, zzmo zzmo) throws IOException;
    ...
    void zzt(Object obj, zzow zzow, zzmo zzmo) throws IOException;

    void zzu(Object obj, zzow zzow, zzmo zzmo) throws IOException;
