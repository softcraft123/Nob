...
final class zzlg extends zzli {
    ...
    /* synthetic */ zzlg(InputStream inputStream, int i, zzlh zzlh) {
        super((zzlh) null);
        byte[] bArr = zznl.zzb;
    ...
    public final zzle zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (zzj2 <= i - i2 && zzj2 > 0) {
            zzle zzk2 = zzle.zzk(this.zzf, i2, zzj2);
            this.zzi += zzj2;
            return zzk2;
        } else if (zzj2 == 0) {
            return zzle.zzb;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i2 = this.zzi;
            if (zzj2 <= i - i2) {
                String str = new String(this.zzf, i2, zzj2, zznl.zza);
                this.zzi += zzj2;
                return str;
            }
        }
