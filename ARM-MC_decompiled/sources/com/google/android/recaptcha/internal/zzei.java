...
public final class zzei extends SQLiteOpenHelper {
    ...
    static {
        zzeg zzeg = new zzeg((DefaultConstructorMarker) null);
        zza = zzeg;
        zzb = zzeg.zzc("18.6.1");
        zzc = zzeg.zzd("18.6.1");
    }
    ...
    public final int zza(List list) {
        ...
        return getWritableDatabase().delete("ce", "id IN ".concat(String.valueOf(CollectionsKt.joinToString$default(list, ", ", "(", ")", 0, (CharSequence) null, zzeh.zza, 24, (Object) null))), (String[]) null);
    }
    ...
    public final java.util.List zzd() {
        ...
        L_0x0018:
            boolean r2 = r1.moveToNext()     // Catch:{ Exception -> 0x004a }
            if (r2 == 0) goto L_0x004e
            java.lang.String r2 = "id"
            int r2 = r1.getColumnIndexOrThrow(r2)     // Catch:{ Exception -> 0x004a }
            int r2 = r1.getInt(r2)     // Catch:{ Exception -> 0x004a }
            java.lang.String r3 = "ss"
            int r3 = r1.getColumnIndexOrThrow(r3)     // Catch:{ Exception -> 0x004a }
            java.lang.String r3 = r1.getString(r3)     // Catch:{ Exception -> 0x004a }
            java.lang.String r4 = "ts"
            int r4 = r1.getColumnIndexOrThrow(r4)     // Catch:{ Exception -> 0x004a }
            long r4 = r1.getLong(r4)     // Catch:{ Exception -> 0x004a }
            com.google.android.recaptcha.internal.zzej r6 = new com.google.android.recaptcha.internal.zzej     // Catch:{ Exception -> 0x004a }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r3)     // Catch:{ Exception -> 0x004a }
            r6.<init>(r3, r4, r2)     // Catch:{ Exception -> 0x004a }
            r0.add(r6)     // Catch:{ Exception -> 0x004a }
            goto L_0x0018
        L_0x0048:
            r0 = move-exception
            goto L_0x0052
        L_0x004a:
            java.util.List r0 = kotlin.collections.CollectionsKt.emptyList()     // Catch:{ all -> 0x0048 }
        L_0x004e:
            r1.close()
            return r0
        L_0x0052:
    ...
    public final boolean zzf(zzej zzej) {
        return zza(CollectionsKt.listOf(zzej)) == 1;
    }
}
