...
public final class zze extends OAuthCredential {
    ...
    public static zze zza(zzajb zzajb) {
        Preconditions.checkNotNull(zzajb, "Must specify a non-null webSignInCredential");
        return new zze((String) null, (String) null, (String) null, zzajb, (String) null, (String) null, (String) null);
    }
    ...
    public static zze zza(String str, String str2, String str3, String str4, String str5) {
        ...
        if (!TextUtils.isEmpty(str2) || !TextUtils.isEmpty(str3)) {
            return new zze(str, str2, str3, (zzajb) null, str4, str5, (String) null);
        }
    ...
    static zze zza(String str, String str2, String str3, String str4) {
        Preconditions.checkNotEmpty(str, "Must specify a non-empty providerId");
        if (!TextUtils.isEmpty(str2) || !TextUtils.isEmpty(str3)) {
            return new zze(str, str2, str3, (zzajb) null, (String) null, (String) null, str4);
        }
        throw new IllegalArgumentException("Must specify an idToken or an accessToken.");
    }

    public static zzajb zza(zze zze2, String str) {
        Preconditions.checkNotNull(zze2);
        zzajb zzajb = zze2.zzd;
        if (zzajb != null) {
            return zzajb;
        }
        return new zzajb(zze2.getIdToken(), zze2.getAccessToken(), zze2.getProvider(), (String) null, zze2.getSecret(), (String) null, str, zze2.zze, zze2.zzg);
    }
    ...
    zze(String str, String str2, String str3, zzajb zzajb, String str4, String str5, String str6) {
