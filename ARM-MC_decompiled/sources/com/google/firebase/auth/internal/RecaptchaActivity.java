...
public class RecaptchaActivity extends FragmentActivity implements zzaes {
    ...
    private final Uri.Builder zza(Uri.Builder builder, Intent intent, String str, String str2) {
        ...
        String str4 = str;
        zzo.zza().zza(getApplicationContext(), str4, uuid, "com.google.firebase.auth.internal.ACTION_SHOW_RECAPTCHA", stringExtra3);
        ...
        if ("android.intent.action.VIEW".equals(getIntent().getAction())) {
            ...
            try {
                ...
                if (!zzagl.zza(instance)) {
                    ...
                    new zzaeq(packageName, lowerCase, intent3, instance, recaptchaActivity).executeOnExecutor(instance2.zze(), new Void[0]);
                } else {
                    recaptchaActivity = this;
                    zza(zza(Uri.parse(zzagl.zza(instance.getOptions().getApiKey())).buildUpon(), getIntent(), packageName, lowerCase).build(), packageName, instance2.zzc());
                }
