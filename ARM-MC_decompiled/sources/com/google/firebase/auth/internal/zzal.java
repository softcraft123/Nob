...
public final class zzal extends MultiFactorResolver {
    ...
    public static zzal zza(zzaas zzaas, FirebaseAuth firebaseAuth, FirebaseUser firebaseUser) {
        List<MultiFactorInfo> zzc2 = zzaas.zzc();
        ...
        List<MultiFactorInfo> zzc3 = zzaas.zzc();
        ...
        return new zzal(arrayList, zzam.zza(zzaas.zzc(), zzaas.zzb()), firebaseAuth.getApp().getName(), zzaas.zza(), (zzaf) firebaseUser, arrayList2);
    }
    ...
    public zzal(List<PhoneMultiFactorInfo> list, zzam zzam, String str, zze zze2, zzaf zzaf, List<TotpMultiFactorInfo> list2) {
