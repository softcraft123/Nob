...
public final class zzbl {
    ...
    private static final zzah<String> zzb = zzah.zza("firebaseAppName", "firebaseUserUid", "operation", "tenantId", "verifyAssertionRequest", "statusCode", "statusMessage", "timestamp");
    ...
    private static void zza(SharedPreferences sharedPreferences) {
        ...
        zzah<String> zzah = zzb;
        zzah zzah2 = zzah;
        int size = zzah.size();
        int i = 0;
        while (i < size) {
            Object obj = zzah.get(i);
            i++;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x008c, code lost:
        if (r4.equals("com.google.firebase.auth.internal.NONGMSCORE_REAUTHENTICATE") == false) goto L_0x006e;
     */
    ...
    public final void zza(com.google.firebase.auth.FirebaseAuth r12) {
        ...
        L_0x002a:
            ...
            java.lang.String r1 = r0.getString(r1, r3)
            android.os.Parcelable$Creator<com.google.android.gms.internal.firebase-auth-api.zzajb> r4 = com.google.android.gms.internal.p002firebaseauthapi.zzajb.CREATOR
            ...
            com.google.android.gms.internal.firebase-auth-api.zzajb r1 = (com.google.android.gms.internal.p002firebaseauthapi.zzajb) r1
        ...
        L_0x0063:
            ...
            r6 = -1
            switch(r5) {
                case -98509410: goto L_0x0086;
                case 175006864: goto L_0x007b;
                case 1450464913: goto L_0x0070;
        ...
        L_0x00e3:
            ...
            goto L_0x0109
        L_0x0105:
            com.google.android.gms.tasks.Task r9 = com.google.android.gms.tasks.Tasks.forResult(r12)
        L_0x0109:
            r11.zze = r9
            zza((android.content.SharedPreferences) r0)
            return
        L_0x010f:
            ...
            r11.zzf = r3
            zza((android.content.SharedPreferences) r0)
            com.google.firebase.FirebaseException r12 = com.google.android.gms.internal.p002firebaseauthapi.zzaen.zza((com.google.android.gms.common.api.Status) r2)
    ...
    public static void zza(Context context, zzajb zzajb, String str, String str2) {
        SharedPreferences.Editor edit = context.getSharedPreferences("com.google.firebase.auth.internal.ProcessDeathHelper", 0).edit();
        edit.putString("verifyAssertionRequest", SafeParcelableSerializer.serializeToString(zzajb));
