...
public final class JavaDataStorage {
    ...
    public JavaDataStorage(Context context2, String str) {
        Intrinsics.checkNotNullParameter(context2, "context");
        Intrinsics.checkNotNullParameter(str, "name");
        this.context = context2;
        this.name = str;
        this.dataStore$delegate = PreferenceDataStoreDelegateKt.preferencesDataStore$default(str, new ReplaceFileCorruptionHandler(new JavaDataStorage$$ExternalSyntheticLambda0(this)), new JavaDataStorage$$ExternalSyntheticLambda1(this), (CoroutineScope) null, 8, (Object) null);
        this.dataStore = getDataStore(context2);
    }
    ...
    private final DataStore<Preferences> getDataStore(Context context2) {
        return (DataStore) this.dataStore$delegate.getValue(context2, $$delegatedProperties[0]);
    }

    /* access modifiers changed from: private */
    public static final List dataStore_delegate$lambda$1(JavaDataStorage javaDataStorage, Context context2) {
        Intrinsics.checkNotNullParameter(context2, "it");
        return CollectionsKt.listOf(SharedPreferencesMigrationKt.SharedPreferencesMigration$default(context2, javaDataStorage.name, (Set) null, 4, (Object) null));
    }
    ...
    public final <T> T getSync(Preferences.Key<T> key, T t) {
        ...
        return BuildersKt__BuildersKt.runBlocking$default((CoroutineContext) null, new JavaDataStorage$getSync$1(this, key, t, (Continuation<? super JavaDataStorage$getSync$1>) null), 1, (Object) null);
    }
    ...
    public final <T> Preferences putSync(Preferences.Key<T> key, T t) {
        Intrinsics.checkNotNullParameter(key, "key");
        return (Preferences) BuildersKt__BuildersKt.runBlocking$default((CoroutineContext) null, new JavaDataStorage$putSync$1(this, key, t, (Continuation<? super JavaDataStorage$putSync$1>) null), 1, (Object) null);
    }
    ...
    public final Preferences editSync(Function1<? super MutablePreferences, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "transform");
        return (Preferences) BuildersKt__BuildersKt.runBlocking$default((CoroutineContext) null, new JavaDataStorage$editSync$1(this, function1, (Continuation<? super JavaDataStorage$editSync$1>) null), 1, (Object) null);
    }
}
