...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor MAP_VALUE_DESC = FieldDescriptor.builder(Values.VECTOR_MAP_VECTORS_KEY).withProperty(AtProtobuf.builder().tag(2).build()).build();
