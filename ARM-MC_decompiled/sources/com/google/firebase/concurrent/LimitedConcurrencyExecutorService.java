...
final class LimitedConcurrencyExecutorService extends LimitedConcurrencyExecutor implements ExecutorService {
    ...
    public <T> Future<T> submit(Runnable runnable, T t) {
        return submit(new LimitedConcurrencyExecutorService$$ExternalSyntheticLambda1(runnable, t));
    }

    public Future<?> submit(Runnable runnable) {
        return submit(new LimitedConcurrencyExecutorService$$ExternalSyntheticLambda0(runnable));
    }
