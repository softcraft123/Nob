...
public class Values {
    ...
    static {
        ...
        MIN_VECTOR_VALUE = (Value) Value.newBuilder().setMapValue(MapValue.newBuilder().putFields(TYPE_KEY, value3).putFields(VECTOR_MAP_VECTORS_KEY, (Value) Value.newBuilder().setArrayValue(ArrayValue.newBuilder()).build())).build();
    }
    ...
    private static int compareTimestamps(Timestamp timestamp, Timestamp timestamp2) {
        ...
        return Integer.compare(timestamp.getNanos(), timestamp2.getNanos());
    }
