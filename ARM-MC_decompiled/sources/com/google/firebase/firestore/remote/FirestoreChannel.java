...
public class FirestoreChannel {
    ...
    public <ReqT, RespT> ClientCall<ReqT, RespT> runBidiStreamingRpc(MethodDescriptor<ReqT, RespT> methodDescriptor, IncomingStreamObserver<RespT> incomingStreamObserver) {
        ...
        createClientCall.addOnCompleteListener(this.asyncQueue.getExecutor(), (OnCompleteListener<ClientCall<ReqT, RespT>>) new FirestoreChannel$$ExternalSyntheticLambda0(this, clientCallArr, incomingStreamObserver));
    ...
    public /* synthetic */ void m480lambda$runBidiStreamingRpc$0$comgooglefirebasefirestoreremoteFirestoreChannel(final ClientCall[] clientCallArr, final IncomingStreamObserver incomingStreamObserver, Task task) {
    ...
    public <ReqT, RespT> void runStreamingResponseRpc(MethodDescriptor<ReqT, RespT> methodDescriptor, ReqT reqt, StreamingListener<RespT> streamingListener) {
        this.callProvider.createClientCall(methodDescriptor).addOnCompleteListener(this.asyncQueue.getExecutor(), new FirestoreChannel$$ExternalSyntheticLambda2(this, streamingListener, reqt));
    }
    ...
    public /* synthetic */ void m482lambda$runStreamingResponseRpc$1$comgooglefirebasefirestoreremoteFirestoreChannel(final StreamingListener streamingListener, Object obj, Task task) {
    ...
    public /* synthetic */ void m481lambda$runRpc$2$comgooglefirebasefirestoreremoteFirestoreChannel(final TaskCompletionSource taskCompletionSource, Object obj, Task task) {
        ClientCall clientCall = (ClientCall) task.getResult();
        clientCall.start(new ClientCall.Listener<RespT>() {
            public void onMessage(RespT respt) {
