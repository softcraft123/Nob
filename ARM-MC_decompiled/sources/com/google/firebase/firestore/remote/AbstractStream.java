...
abstract class AbstractStream<ReqT, RespT, CallbackT extends Stream.StreamCallback> implements Stream<CallbackT> {
    ...
    class StreamObserver implements IncomingStreamObserver<RespT> {
        ...
        public void onHeaders(Metadata metadata) {
            this.dispatcher.run(new AbstractStream$StreamObserver$$ExternalSyntheticLambda1(this, metadata));
        }
        ...
        public /* synthetic */ void m473lambda$onHeaders$0$comgooglefirebasefirestoreremoteAbstractStream$StreamObserver(Metadata metadata) {
        ...
        public void onNext(RespT respt) {
            ...
            this.dispatcher.run(new AbstractStream$StreamObserver$$ExternalSyntheticLambda0(this, i, respt));
        ...
        public /* synthetic */ void m474lambda$onNext$1$comgooglefirebasefirestoreremoteAbstractStream$StreamObserver(int i, Object obj) {
            if (Logger.isDebugEnabled()) {
        ...
        public /* synthetic */ void m475lambda$onOpen$2$comgooglefirebasefirestoreremoteAbstractStream$StreamObserver() {
        ...
        public /* synthetic */ void m472lambda$onClose$3$comgooglefirebasefirestoreremoteAbstractStream$StreamObserver(Status status) {
            if (status.isOk()) {
    ...
    public /* synthetic */ void m470lambda$onOpen$0$comgooglefirebasefirestoreremoteAbstractStream() {
        if (isOpen()) {
    ...
    public /* synthetic */ void m471lambda$performBackoff$1$comgooglefirebasefirestoreremoteAbstractStream() {
