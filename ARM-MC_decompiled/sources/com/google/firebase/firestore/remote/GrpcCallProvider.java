...
public class GrpcCallProvider {
    ...
    public /* synthetic */ Task m483lambda$createClientCall$0$comgooglefirebasefirestoreremoteGrpcCallProvider(MethodDescriptor methodDescriptor, Task task) throws Exception {
    ...
    public void m487lambda$onConnectivityStateChange$2$comgooglefirebasefirestoreremoteGrpcCallProvider(ManagedChannel managedChannel) {
        ...
        if (state == ConnectivityState.CONNECTING) {
            ...
            this.connectivityAttemptTimer = this.asyncQueue.enqueueAfterDelay(AsyncQueue.TimerId.CONNECTIVITY_ATTEMPT_TIMER, 15000, new GrpcCallProvider$$ExternalSyntheticLambda0(this, managedChannel));
        }
        managedChannel.notifyWhenStateChanged(state, new GrpcCallProvider$$ExternalSyntheticLambda1(this, managedChannel));
    }
    ...
    public /* synthetic */ void m486lambda$onConnectivityStateChange$1$comgooglefirebasefirestoreremoteGrpcCallProvider(ManagedChannel managedChannel) {
    ...
    public /* synthetic */ void m488lambda$onConnectivityStateChange$3$comgooglefirebasefirestoreremoteGrpcCallProvider(ManagedChannel managedChannel) {
        this.asyncQueue.enqueueAndForget(new GrpcCallProvider$$ExternalSyntheticLambda2(this, managedChannel));
    }
    ...
    public /* synthetic */ void m489lambda$resetChannel$4$comgooglefirebasefirestoreremoteGrpcCallProvider(ManagedChannel managedChannel) {
        managedChannel.shutdownNow();
        initChannelTask();
    }
    ...
    public /* synthetic */ ManagedChannel m485lambda$initChannelTask$6$comgooglefirebasefirestoreremoteGrpcCallProvider() throws Exception {
        ManagedChannel initChannel = initChannel(this.context, this.databaseInfo);
        this.asyncQueue.enqueueAndForget(new GrpcCallProvider$$ExternalSyntheticLambda6(this, initChannel));
