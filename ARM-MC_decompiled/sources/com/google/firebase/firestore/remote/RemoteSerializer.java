...
public final class RemoteSerializer {
    ...
    public WatchChange decodeWatchChange(ListenResponse listenResponse) {
        ...
        if (i == 1) {
            ...
            return new WatchChange.DocumentChange(Collections.emptyList(), documentRemove.getRemovedTargetIdsList(), decodeKey(documentRemove.getDocument()), (MutableDocument) null);
        } else if (i == 5) {
