...
public class DocumentReference {
    ...
    public Task<Void> set(Object obj, SetOptions setOptions) {
        ...
        return ((Task) this.firestore.callClient(new DocumentReference$$ExternalSyntheticLambda1(Collections.singletonList(parsedSetData.toMutation(this.key, Precondition.NONE))))).continueWith(Executors.DIRECT_EXECUTOR, Util.voidErrorTransformer());
    }
    ...
    private Task<Void> update(UserData.ParsedUpdateData parsedUpdateData) {
        return ((Task) this.firestore.callClient(new DocumentReference$$ExternalSyntheticLambda2(Collections.singletonList(parsedUpdateData.toMutation(this.key, Precondition.exists(true)))))).continueWith(Executors.DIRECT_EXECUTOR, Util.voidErrorTransformer());
    }
    ...
    public /* synthetic */ Task m361lambda$get$3$comgooglefirebasefirestoreDocumentReference(FirestoreClient firestoreClient) {
    ...
    public /* synthetic */ DocumentSnapshot m362lambda$get$4$comgooglefirebasefirestoreDocumentReference(Task task) throws Exception {
    ...
    private Task<DocumentSnapshot> getViaSnapshotListener(Source source) {
        ...
        taskCompletionSource2.setResult(addSnapshotListenerInternal(Executors.DIRECT_EXECUTOR, listenOptions, (Activity) null, new DocumentReference$$ExternalSyntheticLambda7(taskCompletionSource, taskCompletionSource2, source)));
    ...
    private ListenerRegistration addSnapshotListenerInternal(Executor executor, EventManager.ListenOptions listenOptions, Activity activity, EventListener<DocumentSnapshot> eventListener) {
        AsyncEventListener asyncEventListener = new AsyncEventListener(executor, new DocumentReference$$ExternalSyntheticLambda5(this, eventListener));
        return (ListenerRegistration) this.firestore.callClient(new DocumentReference$$ExternalSyntheticLambda6(asQuery(), listenOptions, asyncEventListener, activity));
    }
    ...
    public /* synthetic */ void m360lambda$addSnapshotListenerInternal$6$comgooglefirebasefirestoreDocumentReference(EventListener eventListener, ViewSnapshot viewSnapshot, FirebaseFirestoreException firebaseFirestoreException) {
