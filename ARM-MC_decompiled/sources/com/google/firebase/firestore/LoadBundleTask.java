...
public class LoadBundleTask extends Task<LoadBundleTaskProgress> {
    ...
    public void m369lambda$addOnProgressListener$0$comgooglefirebasefirestoreLoadBundleTask(OnProgressListener<LoadBundleTaskProgress> onProgressListener) {
        synchronized (this.lock) {
    ...
    public void setException(Exception exc) {
        ...
        synchronized (this.lock) {
            try {
                exc2 = exc;
                LoadBundleTaskProgress loadBundleTaskProgress = new LoadBundleTaskProgress(this.snapshot.getDocumentsLoaded(), this.snapshot.getTotalDocuments(), this.snapshot.getBytesLoaded(), this.snapshot.getTotalBytes(), exc2, LoadBundleTaskProgress.TaskState.ERROR);
                this.snapshot = loadBundleTaskProgress;
                for (ManagedListener invokeAsync : this.progressListeners) {
        ...
        this.completionSource.setException(exc2);
    }
    ...
    private static class ManagedListener {
        ...
        public /* synthetic */ void m370lambda$invokeAsync$0$comgooglefirebasefirestoreLoadBundleTask$ManagedListener(LoadBundleTaskProgress loadBundleTaskProgress) {
