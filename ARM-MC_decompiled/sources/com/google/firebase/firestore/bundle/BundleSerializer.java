...
public class BundleSerializer {
    ...
    private BundledQuery decodeBundledQuery(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject3.optBoolean("allDescendants", false)) {
            ...
            decodeName = (ResourcePath) decodeName.append(jSONObject3.getString("collectionId"));
            str = null;
        }
        ...
        return new BundledQuery(new Query(decodeName, str, decodeWhere, decodeOrderBy, (long) decodeLimit, Query.LimitType.LIMIT_TO_FIRST, decodeStartAtBound, decodeEndAtBound).toTarget(), decodeLimitType(jSONObject));
    }
