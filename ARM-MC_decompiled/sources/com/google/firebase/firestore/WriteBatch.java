...
public class WriteBatch {
    ...
    public WriteBatch set(DocumentReference documentReference, Object obj, SetOptions setOptions) {
        ...
        this.mutations.add(parsedSetData.toMutation(documentReference.getKey(), Precondition.NONE));
        return this;
    }
    ...
    public /* synthetic */ Task m376lambda$commit$0$comgooglefirebasefirestoreWriteBatch(FirestoreClient firestoreClient) {
