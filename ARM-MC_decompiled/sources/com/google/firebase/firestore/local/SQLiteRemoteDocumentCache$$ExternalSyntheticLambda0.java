...
public final /* synthetic */ class SQLiteRemoteDocumentCache$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public final void run() {
        this.f$0.m452lambda$processRowInBackground$2$comgooglefirebasefirestorelocalSQLiteRemoteDocumentCache(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7);
    }
}
