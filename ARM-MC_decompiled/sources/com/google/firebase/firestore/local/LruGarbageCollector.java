...
public class LruGarbageCollector {
    ...
    public class GCScheduler implements Scheduler {
        ...
        public /* synthetic */ void m429lambda$scheduleGC$0$comgooglefirebasefirestorelocalLruGarbageCollector$GCScheduler() {
    ...
    public long getNthSequenceNumber(int i) {
        ...
        this.delegate.forEachTarget(new LruGarbageCollector$$ExternalSyntheticLambda0(rollingSequenceNumberBuffer));
        LruDelegate lruDelegate = this.delegate;
        Objects.requireNonNull(rollingSequenceNumberBuffer);
        lruDelegate.forEachOrphanedDocumentSequenceNumber(new LruGarbageCollector$$ExternalSyntheticLambda1(rollingSequenceNumberBuffer));
