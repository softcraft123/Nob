...
final class SQLiteIndexManager implements IndexManager {
    ...
    public /* synthetic */ void m437lambda$start$2$comgooglefirebasefirestorelocalSQLiteIndexManager(Map map, Cursor cursor) {
    ...
    public List<ResourcePath> getCollectionParents(String str) {
        ...
        this.db.query("SELECT parent FROM collection_parents WHERE collection_id = ?").binding(str).forEach(new SQLiteIndexManager$$ExternalSyntheticLambda3(arrayList));
        return arrayList;
    }
    ...
    private void updateEntries(Document document, SortedSet<IndexEntry> sortedSet, SortedSet<IndexEntry> sortedSet2) {
        ...
        Util.diffCollections(sortedSet, sortedSet2, new SQLiteIndexManager$$ExternalSyntheticLambda0(this, document), new SQLiteIndexManager$$ExternalSyntheticLambda1(this, document));
    }
    ...
    public void m438lambda$updateEntries$4$comgooglefirebasefirestorelocalSQLiteIndexManager(Document document, IndexEntry indexEntry) {
    ...
    public void m439lambda$updateEntries$5$comgooglefirebasefirestorelocalSQLiteIndexManager(Document document, IndexEntry indexEntry) {
    ...
    public List<DocumentKey> getDocumentsMatchingTarget(Target target) {
        ...
        while (true) {
            ...
            Object[] generateQueryAndBindings = generateQueryAndBindings(target2, fieldIndex2.getIndexId(), arrayValues, encodeBound(fieldIndex2, target2, lowerBound), lowerBound.isInclusive() ? ">=" : ">", encodeBound(fieldIndex2, target2, bound), bound.isInclusive() ? "<=" : "<", encodeValues(fieldIndex2, target2, notInValues));
        ...
        binding.forEach(new SQLiteIndexManager$$ExternalSyntheticLambda4(arrayList4));
    ...
    private Object[] generateQueryAndBindings(Target target, int i, List<Value> list, Object[] objArr, String str, Object[] objArr2, String str2, Object[] objArr3) {
        ...
        if (objArr3 != null) {
            ...
            repeatSequence.append(Util.repeatSequence("?", objArr3.length, ", "));
        ...
        Object[] fillBounds = fillBounds(i2, i, list3, objArr, objArr4, objArr3);
        ArrayList arrayList = new ArrayList();
