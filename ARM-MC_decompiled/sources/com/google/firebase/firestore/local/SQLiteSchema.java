...
class SQLiteSchema {
    ...
    public /* synthetic */ void m458lambda$createV1MutationQueue$0$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    public /* synthetic */ void m464lambda$removeAcknowledgedMutations$2$comgooglefirebasefirestorelocalSQLiteSchema(Cursor cursor) {
        String string = cursor.getString(0);
        new SQLitePersistence.Query(this.db, "SELECT batch_id FROM mutations WHERE uid = ? AND batch_id <= ?").binding(string, Long.valueOf(cursor.getLong(1))).forEach(new SQLiteSchema$$ExternalSyntheticLambda13(this, string));
    }
    ...
    public /* synthetic */ void m463lambda$removeAcknowledgedMutations$1$comgooglefirebasefirestorelocalSQLiteSchema(String str, Cursor cursor) {
    ...
    public /* synthetic */ void m460lambda$createV1TargetCache$3$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    public /* synthetic */ void m459lambda$createV1RemoteDocumentCache$4$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    public /* synthetic */ void m455lambda$createFieldIndex$5$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    public /* synthetic */ void m462lambda$dropLastLimboFreeSnapshotVersion$6$comgooglefirebasefirestorelocalSQLiteSchema(Cursor cursor) {
    ...
    private void ensureSequenceNumbers() {
        boolean[] zArr;
        Long l = (Long) new SQLitePersistence.Query(this.db, "SELECT highest_listen_sequence_number FROM target_globals LIMIT 1").firstValue(new SQLiteSchema$$ExternalSyntheticLambda6());
        ...
        do {
            ...
            binding.forEach(new SQLiteSchema$$ExternalSyntheticLambda7(zArr, compileStatement, longValue));
        } while (zArr[0]);
    }
    ...
    private void createV8CollectionParentsIndex() {
        ...
        SQLiteSchema$$ExternalSyntheticLambda10 sQLiteSchema$$ExternalSyntheticLambda10 = new SQLiteSchema$$ExternalSyntheticLambda10(new MemoryIndexManager.MemoryCollectionParentIndex(), this.db.compileStatement("INSERT OR REPLACE INTO collection_parents (collection_id, parent) VALUES (?, ?)"));
        new SQLitePersistence.Query(this.db, "SELECT path FROM remote_documents").forEach(new SQLiteSchema$$ExternalSyntheticLambda11(sQLiteSchema$$ExternalSyntheticLambda10));
        new SQLitePersistence.Query(this.db, "SELECT path FROM document_mutations").forEach(new SQLiteSchema$$ExternalSyntheticLambda12(sQLiteSchema$$ExternalSyntheticLambda10));
    }
    ...
    public /* synthetic */ void m461lambda$createV8CollectionParentsIndex$9$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    public /* synthetic */ void m465lambda$rewriteCanonicalIds$13$comgooglefirebasefirestorelocalSQLiteSchema(Cursor cursor) {
        int i = cursor.getInt(0);
        try {
    ...
    private void ensurePathLength() {
        ...
        do {
            zArr = new boolean[]{false};
            binding.forEach(new SQLiteSchema$$ExternalSyntheticLambda1(zArr, compileStatement));
        } while (zArr[0]);
    }
    ...
    public /* synthetic */ void m453lambda$createBundleCache$15$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    public /* synthetic */ void m457lambda$createOverlays$16$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    public /* synthetic */ void m454lambda$createDataMigrationTable$17$comgooglefirebasefirestorelocalSQLiteSchema() {
    ...
    public /* synthetic */ void m456lambda$createGlobalsTable$18$comgooglefirebasefirestorelocalSQLiteSchema() {
