...
public final class LocalStore implements BundleCallback {
    ...
    public /* synthetic */ void m426lambda$startIndexManager$0$comgooglefirebasefirestorelocalLocalStore() {
    ...
    public /* synthetic */ void m427lambda$startMutationQueue$1$comgooglefirebasefirestorelocalLocalStore() {
    ...
    public LocalDocumentsResult writeLocally(List<Mutation> list) {
        ...
        return (LocalDocumentsResult) this.persistence.runTransaction("Locally write mutations", new LocalStore$$ExternalSyntheticLambda12(this, hashSet, list, now));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$writeLocally$2$com-google-firebase-firestore-local-LocalStore  reason: not valid java name */
    public /* synthetic */ LocalDocumentsResult m428lambda$writeLocally$2$comgooglefirebasefirestorelocalLocalStore(Set set, List list, Timestamp timestamp) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> acknowledgeBatch(MutationBatchResult mutationBatchResult) {
        return (ImmutableSortedMap) this.persistence.runTransaction("Acknowledge batch", new LocalStore$$ExternalSyntheticLambda5(this, mutationBatchResult));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$acknowledgeBatch$3$com-google-firebase-firestore-local-LocalStore  reason: not valid java name */
    public /* synthetic */ ImmutableSortedMap m410lambda$acknowledgeBatch$3$comgooglefirebasefirestorelocalLocalStore(MutationBatchResult mutationBatchResult) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> rejectBatch(int i) {
        return (ImmutableSortedMap) this.persistence.runTransaction("Reject batch", new LocalStore$$ExternalSyntheticLambda9(this, i));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$rejectBatch$4$com-google-firebase-firestore-local-LocalStore  reason: not valid java name */
    public /* synthetic */ ImmutableSortedMap m421lambda$rejectBatch$4$comgooglefirebasefirestorelocalLocalStore(int i) {
    ...
    public void setLastStreamToken(ByteString byteString) {
        this.persistence.runTransaction("Set stream token", (Runnable) new LocalStore$$ExternalSyntheticLambda19(this, byteString));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$setLastStreamToken$5$com-google-firebase-firestore-local-LocalStore  reason: not valid java name */
    public /* synthetic */ void m425lambda$setLastStreamToken$5$comgooglefirebasefirestorelocalLocalStore(ByteString byteString) {
    ...
    public /* synthetic */ ImmutableSortedMap m413lambda$applyRemoteEvent$6$comgooglefirebasefirestorelocalLocalStore(RemoteEvent remoteEvent, SnapshotVersion snapshotVersion) {
    ...
    public void notifyLocalViewChanges(List<LocalViewChanges> list) {
        this.persistence.runTransaction("notifyLocalViewChanges", (Runnable) new LocalStore$$ExternalSyntheticLambda10(this, list));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$notifyLocalViewChanges$7$com-google-firebase-firestore-local-LocalStore  reason: not valid java name */
    public /* synthetic */ void m420lambda$notifyLocalViewChanges$7$comgooglefirebasefirestorelocalLocalStore(List list) {
        Iterator it = list.iterator();
        while (it.hasNext()) {
    ...
    public TargetData allocateTarget(Target target) {
        ...
        if (targetData != null) {
            ...
            this.persistence.runTransaction("Allocate target", (Runnable) new LocalStore$$ExternalSyntheticLambda7(this, allocateQueryHolder, target));
    ...
    public /* synthetic */ void m411lambda$allocateTarget$8$comgooglefirebasefirestorelocalLocalStore(AllocateQueryHolder allocateQueryHolder, Target target) {
    ...
    public /* synthetic */ Boolean m419lambda$hasNewerBundle$9$comgooglefirebasefirestorelocalLocalStore(BundleMetadata bundleMetadata) {
    ...
    public /* synthetic */ void m423lambda$saveBundle$10$comgooglefirebasefirestorelocalLocalStore(BundleMetadata bundleMetadata) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> applyBundledDocuments(ImmutableSortedMap<DocumentKey, MutableDocument> immutableSortedMap, String str) {
        return (ImmutableSortedMap) this.persistence.runTransaction("Apply bundle documents", new LocalStore$$ExternalSyntheticLambda15(this, immutableSortedMap, allocateTarget(newUmbrellaTarget(str))));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$applyBundledDocuments$11$com-google-firebase-firestore-local-LocalStore  reason: not valid java name */
    public /* synthetic */ ImmutableSortedMap m412lambda$applyBundledDocuments$11$comgooglefirebasefirestorelocalLocalStore(ImmutableSortedMap immutableSortedMap, TargetData targetData) {
        ImmutableSortedSet<DocumentKey> emptyKeySet = DocumentKey.emptyKeySet();
        HashMap hashMap = new HashMap();
    ...
    public /* synthetic */ void m424lambda$saveNamedQuery$12$comgooglefirebasefirestorelocalLocalStore(NamedQuery namedQuery, TargetData targetData, int i, ImmutableSortedSet immutableSortedSet) {
    ...
    public NamedQuery getNamedQuery(String str) {
        return (NamedQuery) this.persistence.runTransaction("Get named query", new LocalStore$$ExternalSyntheticLambda1(this, str));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$getNamedQuery$13$com-google-firebase-firestore-local-LocalStore  reason: not valid java name */
    public /* synthetic */ NamedQuery m418lambda$getNamedQuery$13$comgooglefirebasefirestorelocalLocalStore(String str) {
    ...
    public /* synthetic */ Collection m417lambda$getFieldIndexes$14$comgooglefirebasefirestorelocalLocalStore() {
        return this.indexManager.getFieldIndexes();
    }

    public void configureFieldIndexes(List<FieldIndex> list) {
        this.persistence.runTransaction("Configure indexes", (Runnable) new LocalStore$$ExternalSyntheticLambda18(this, list));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$configureFieldIndexes$15$com-google-firebase-firestore-local-LocalStore  reason: not valid java name */
    public /* synthetic */ void m415lambda$configureFieldIndexes$15$comgooglefirebasefirestorelocalLocalStore(List list) {
        ...
        Util.diffCollections(fieldIndexes, (Collection<FieldIndex>) list, comparator, localStore$$ExternalSyntheticLambda0, (LocalStore$$ExternalSyntheticLambda0) new LocalStore$$ExternalSyntheticLambda11(indexManager3));
    }
    ...
    public /* synthetic */ void m416lambda$deleteAllFieldIndexes$16$comgooglefirebasefirestorelocalLocalStore() {
    ...
    public void releaseTarget(int i) {
        this.persistence.runTransaction("Release target", (Runnable) new LocalStore$$ExternalSyntheticLambda3(this, i));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$releaseTarget$17$com-google-firebase-firestore-local-LocalStore  reason: not valid java name */
    public /* synthetic */ void m422lambda$releaseTarget$17$comgooglefirebasefirestorelocalLocalStore(int i) {
    ...
    public LruGarbageCollector.Results collectGarbage(LruGarbageCollector lruGarbageCollector) {
        return (LruGarbageCollector.Results) this.persistence.runTransaction("Collect garbage", new LocalStore$$ExternalSyntheticLambda13(this, lruGarbageCollector));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$collectGarbage$18$com-google-firebase-firestore-local-LocalStore  reason: not valid java name */
    public /* synthetic */ LruGarbageCollector.Results m414lambda$collectGarbage$18$comgooglefirebasefirestorelocalLocalStore(LruGarbageCollector lruGarbageCollector) {
