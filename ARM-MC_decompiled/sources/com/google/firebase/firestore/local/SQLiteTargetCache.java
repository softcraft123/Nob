...
final class SQLiteTargetCache implements TargetCache {
    ...
    public /* synthetic */ void m469lambda$start$0$comgooglefirebasefirestorelocalSQLiteTargetCache(Cursor cursor) {
    ...
    public /* synthetic */ void m466lambda$forEachTarget$1$comgooglefirebasefirestorelocalSQLiteTargetCache(Consumer consumer, Cursor cursor) {
    ...
    public int removeQueries(long j, SparseArray<?> sparseArray) {
        int[] iArr = new int[1];
        this.db.query("SELECT target_id FROM targets WHERE last_listen_sequence_number <= ?").binding(Long.valueOf(j)).forEach(new SQLiteTargetCache$$ExternalSyntheticLambda0(this, sparseArray, iArr));
        writeMetadata();
        return iArr[0];
    }
    ...
    public /* synthetic */ void m468lambda$removeQueries$2$comgooglefirebasefirestorelocalSQLiteTargetCache(SparseArray sparseArray, int[] iArr, Cursor cursor) {
    ...
    public TargetData getTargetData(com.google.firebase.firestore.core.Target target) {
        ...
        this.db.query("SELECT target_proto FROM targets WHERE canonical_id = ?").binding(canonicalId).forEach(new SQLiteTargetCache$$ExternalSyntheticLambda4(this, target, targetDataHolder));
    ...
    public /* synthetic */ void m467lambda$getTargetData$3$comgooglefirebasefirestorelocalSQLiteTargetCache(com.google.firebase.firestore.core.Target target, TargetDataHolder targetDataHolder, Cursor cursor) {
    ...
    public ImmutableSortedSet<DocumentKey> getMatchingKeysForTargetId(int i) {
        ...
        this.db.query("SELECT path FROM target_documents WHERE target_id = ?").binding(Integer.valueOf(i)).forEach(new SQLiteTargetCache$$ExternalSyntheticLambda2(documentKeysHolder));
