...
public class FirebaseFirestore {
    ...
    static FirebaseFirestore newInstance(Context context2, FirebaseApp firebaseApp2, Deferred<InternalAuthProvider> deferred, Deferred<InteropAppCheckTokenProvider> deferred2, String str, InstanceRegistry instanceRegistry2, GrpcMetadataProvider grpcMetadataProvider) {
        ...
        if (projectId != null) {
            return new FirebaseFirestore(context2, DatabaseId.forDatabase(projectId, str), firebaseApp2.getName(), new FirebaseAuthCredentialsProvider(deferred), new FirebaseAppCheckTokenProvider(deferred2), new FirebaseFirestore$$ExternalSyntheticLambda7(), firebaseApp2, instanceRegistry2, grpcMetadataProvider);
        }
    ...
    FirebaseFirestore(android.content.Context r1, com.google.firebase.firestore.model.DatabaseId r2, java.lang.String r3, com.google.firebase.firestore.auth.CredentialsProvider<com.google.firebase.firestore.auth.User> r4, com.google.firebase.firestore.auth.CredentialsProvider<java.lang.String> r5, com.google.firebase.firestore.util.Function<com.google.firebase.firestore.FirebaseFirestoreSettings, com.google.firebase.firestore.core.ComponentProvider> r6, com.google.firebase.FirebaseApp r7, com.google.firebase.firestore.FirebaseFirestore.InstanceRegistry r8, com.google.firebase.firestore.remote.GrpcMetadataProvider r9) {
        /*
            ...
            com.google.firebase.firestore.FirebaseFirestore$$ExternalSyntheticLambda5 r2 = new com.google.firebase.firestore.FirebaseFirestore$$ExternalSyntheticLambda5
            r2.<init>(r0)
            r1.<init>(r2)
    ...
    public Task<Void> setIndexConfiguration(String str) {
        ...
        try {
            ...
            return (Task) this.clientProvider.call(new FirebaseFirestore$$ExternalSyntheticLambda17(arrayList));
    ...
    private <ResultT> Task<ResultT> runTransaction(TransactionOptions transactionOptions, Transaction.Function<ResultT> function, Executor executor) {
        this.clientProvider.ensureConfigured();
        return (Task) this.clientProvider.call(new FirebaseFirestore$$ExternalSyntheticLambda14(transactionOptions, new FirebaseFirestore$$ExternalSyntheticLambda13(this, executor, function)));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$runTransaction$2$com-google-firebase-firestore-FirebaseFirestore  reason: not valid java name */
    public /* synthetic */ Task m366lambda$runTransaction$2$comgooglefirebasefirestoreFirebaseFirestore(Executor executor, Transaction.Function function, com.google.firebase.firestore.core.Transaction transaction) {
        return Tasks.call(executor, new FirebaseFirestore$$ExternalSyntheticLambda4(this, function, transaction));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$runTransaction$1$com-google-firebase-firestore-FirebaseFirestore  reason: not valid java name */
    public /* synthetic */ Object m365lambda$runTransaction$1$comgooglefirebasefirestoreFirebaseFirestore(Transaction.Function function, com.google.firebase.firestore.core.Transaction transaction) throws Exception {
    ...
    public Task<Void> clearPersistence(Executor executor) {
        ...
        executor.execute(new FirebaseFirestore$$ExternalSyntheticLambda3(this, taskCompletionSource));
        return taskCompletionSource.getTask();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$clearPersistence$5$com-google-firebase-firestore-FirebaseFirestore  reason: not valid java name */
    public /* synthetic */ void m363lambda$clearPersistence$5$comgooglefirebasefirestoreFirebaseFirestore(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public LoadBundleTask loadBundle(InputStream inputStream) {
        ...
        this.clientProvider.procedure(new FirebaseFirestore$$ExternalSyntheticLambda1(inputStream, loadBundleTask));
    ...
    public Task<Query> getNamedQuery(String str) {
        return ((Task) this.clientProvider.call(new FirebaseFirestore$$ExternalSyntheticLambda9(str))).continueWith(new FirebaseFirestore$$ExternalSyntheticLambda10(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$getNamedQuery$8$com-google-firebase-firestore-FirebaseFirestore  reason: not valid java name */
    public /* synthetic */ Query m364lambda$getNamedQuery$8$comgooglefirebasefirestoreFirebaseFirestore(Task task) throws Exception {
    ...
    private ListenerRegistration addSnapshotsInSyncListener(Executor executor, Activity activity, Runnable runnable) {
        return (ListenerRegistration) this.clientProvider.call(new FirebaseFirestore$$ExternalSyntheticLambda16(new AsyncEventListener(executor, new FirebaseFirestore$$ExternalSyntheticLambda15(runnable)), activity));
    }
