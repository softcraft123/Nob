...
final class FirestoreKt$snapshots$1 extends SuspendLambda implements Function2<ProducerScope<? super DocumentSnapshot>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            ListenerRegistration addSnapshotListener = this.$this_snapshots.addSnapshotListener(Executors.BACKGROUND_EXECUTOR, this.$metadataChanges, (EventListener<DocumentSnapshot>) new FirestoreKt$snapshots$1$$ExternalSyntheticLambda0(producerScope));
            Intrinsics.checkNotNullExpressionValue(addSnapshotListener, "addSnapshotListener(...)");
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, new FirestoreKt$snapshots$1$$ExternalSyntheticLambda1(addSnapshotListener), this) == coroutine_suspended) {
