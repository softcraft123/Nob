...
public final class FirebaseAppCheckTokenProvider extends CredentialsProvider<String> {
    ...
    public /* synthetic */ void m378lambda$new$1$comgooglefirebasefirestoreauthFirebaseAppCheckTokenProvider(Provider provider) {
        synchronized (this) {
    ...
    public synchronized void m377lambda$new$0$comgooglefirebasefirestoreauthFirebaseAppCheckTokenProvider(AppCheckTokenResult appCheckTokenResult) {
