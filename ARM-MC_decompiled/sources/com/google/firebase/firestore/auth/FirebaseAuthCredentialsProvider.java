...
public final class FirebaseAuthCredentialsProvider extends CredentialsProvider<User> {
    ...
    public /* synthetic */ void m380lambda$new$0$comgooglefirebasefirestoreauthFirebaseAuthCredentialsProvider(InternalTokenResult internalTokenResult) {
        onIdTokenChanged();
    }
    ...
    public /* synthetic */ void m381lambda$new$1$comgooglefirebasefirestoreauthFirebaseAuthCredentialsProvider(Provider provider) {
        synchronized (this) {
    ...
    public /* synthetic */ Task m379lambda$getToken$2$comgooglefirebasefirestoreauthFirebaseAuthCredentialsProvider(int i, Task task) throws Exception {
        synchronized (this) {
