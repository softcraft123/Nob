...
public class ActivityScope {
    ...
    private static void onActivityStopCallOnce(Activity activity, Runnable runnable) {
        ...
        activity.runOnUiThread(new ActivityScope$$ExternalSyntheticLambda2(activity, runnable));
    }
    ...
    private static void onFragmentActivityStopCallOnce(FragmentActivity fragmentActivity, Runnable runnable) {
        fragmentActivity.runOnUiThread(new ActivityScope$$ExternalSyntheticLambda1(fragmentActivity, runnable));
    }
