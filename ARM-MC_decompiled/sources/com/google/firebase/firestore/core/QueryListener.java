...
public class QueryListener {
    ...
    private boolean shouldRaiseInitialEvent(ViewSnapshot viewSnapshot, OnlineState onlineState2) {
        ...
        boolean equals = onlineState2.equals(OnlineState.OFFLINE);
        if (!this.options.waitForSyncWhenOnline || equals) {
            return !viewSnapshot.getDocuments().isEmpty() || viewSnapshot.hasCachedResults() || onlineState2.equals(OnlineState.OFFLINE);
        }
