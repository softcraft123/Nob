...
public final class FirestoreClient {
    ...
    public FirestoreClient(Context context, DatabaseInfo databaseInfo2, CredentialsProvider<User> credentialsProvider, CredentialsProvider<String> credentialsProvider2, AsyncQueue asyncQueue2, GrpcMetadataProvider grpcMetadataProvider, ComponentProvider componentProvider) {
        ...
        asyncQueue2.enqueueAndForget(new FirestoreClient$$ExternalSyntheticLambda10(this, taskCompletionSource, context, componentProvider, grpcMetadataProvider));
        credentialsProvider.setChangeListener(new FirestoreClient$$ExternalSyntheticLambda12(this, atomicBoolean, taskCompletionSource, asyncQueue2));
        credentialsProvider2.setChangeListener(new FirestoreClient$$ExternalSyntheticLambda13());
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$new$0$com-google-firebase-firestore-core-FirestoreClient  reason: not valid java name */
    public /* synthetic */ void m393lambda$new$0$comgooglefirebasefirestorecoreFirestoreClient(TaskCompletionSource taskCompletionSource, Context context, ComponentProvider componentProvider, GrpcMetadataProvider grpcMetadataProvider) {
        try {
    ...
    public /* synthetic */ void m395lambda$new$2$comgooglefirebasefirestorecoreFirestoreClient(AtomicBoolean atomicBoolean, TaskCompletionSource taskCompletionSource, AsyncQueue asyncQueue2, User user) {
    ...
    public /* synthetic */ void m394lambda$new$1$comgooglefirebasefirestorecoreFirestoreClient(User user) {
    ...
    public /* synthetic */ void m386lambda$disableNetwork$4$comgooglefirebasefirestorecoreFirestoreClient() {
    ...
    public /* synthetic */ void m387lambda$enableNetwork$5$comgooglefirebasefirestorecoreFirestoreClient() {
    ...
    public /* synthetic */ void m400lambda$terminate$6$comgooglefirebasefirestorecoreFirestoreClient() {
    ...
    public /* synthetic */ void m391lambda$listen$7$comgooglefirebasefirestorecoreFirestoreClient(QueryListener queryListener) {
    ...
    public /* synthetic */ void m399lambda$stopListening$8$comgooglefirebasefirestorecoreFirestoreClient(QueryListener queryListener) {
        this.eventManager.removeQueryListener(queryListener);
    }

    public void stopListening(QueryListener queryListener) {
        this.asyncQueue.enqueueAndForget(new FirestoreClient$$ExternalSyntheticLambda19(this, queryListener));
    }
    ...
    public /* synthetic */ Document m388lambda$getDocumentFromLocalCache$9$comgooglefirebasefirestorecoreFirestoreClient(DocumentKey documentKey) throws Exception {
    ...
    public /* synthetic */ ViewSnapshot m389lambda$getDocumentsFromLocalCache$11$comgooglefirebasefirestorecoreFirestoreClient(Query query) throws Exception {
    ...
    public Task<Void> write(List<Mutation> list) {
        verifyNotTerminated();
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.asyncQueue.enqueueAndForget(new FirestoreClient$$ExternalSyntheticLambda11(this, list, taskCompletionSource));
        return taskCompletionSource.getTask();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$write$12$com-google-firebase-firestore-core-FirestoreClient  reason: not valid java name */
    public /* synthetic */ void m403lambda$write$12$comgooglefirebasefirestorecoreFirestoreClient(List list, TaskCompletionSource taskCompletionSource) {
    ...
    public <TResult> Task<TResult> transaction(TransactionOptions transactionOptions, Function<Transaction, Task<TResult>> function) {
        verifyNotTerminated();
        return AsyncQueue.callTask(this.asyncQueue.getExecutor(), new FirestoreClient$$ExternalSyntheticLambda23(this, transactionOptions, function));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$transaction$13$com-google-firebase-firestore-core-FirestoreClient  reason: not valid java name */
    public /* synthetic */ Task m401lambda$transaction$13$comgooglefirebasefirestorecoreFirestoreClient(TransactionOptions transactionOptions, Function function) throws Exception {
    ...
    public Task<Map<String, Value>> runAggregateQuery(Query query, List<AggregateField> list) {
        verifyNotTerminated();
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.asyncQueue.enqueueAndForget(new FirestoreClient$$ExternalSyntheticLambda16(this, query, list, taskCompletionSource));
        return taskCompletionSource.getTask();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$runAggregateQuery$16$com-google-firebase-firestore-core-FirestoreClient  reason: not valid java name */
    public /* synthetic */ void m397lambda$runAggregateQuery$16$comgooglefirebasefirestorecoreFirestoreClient(Query query, List list, TaskCompletionSource taskCompletionSource) {
        this.syncEngine.runAggregateQuery(query, list).addOnSuccessListener(new FirestoreClient$$ExternalSyntheticLambda20(taskCompletionSource)).addOnFailureListener(new FirestoreClient$$ExternalSyntheticLambda21(taskCompletionSource));
    }

    public Task<Void> waitForPendingWrites() {
        verifyNotTerminated();
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.asyncQueue.enqueueAndForget(new FirestoreClient$$ExternalSyntheticLambda5(this, taskCompletionSource));
        return taskCompletionSource.getTask();
    }
    ...
    public /* synthetic */ void m402lambda$waitForPendingWrites$17$comgooglefirebasefirestorecoreFirestoreClient(TaskCompletionSource taskCompletionSource) {
    ...
    public void addSnapshotsInSyncListener(EventListener<Void> eventListener) {
        verifyNotTerminated();
        this.asyncQueue.enqueueAndForget(new FirestoreClient$$ExternalSyntheticLambda4(this, eventListener));
    }
    ...
    public /* synthetic */ void m383lambda$addSnapshotsInSyncListener$18$comgooglefirebasefirestorecoreFirestoreClient(EventListener eventListener) {
    ...
    public void loadBundle(InputStream inputStream, LoadBundleTask loadBundleTask) {
        verifyNotTerminated();
        this.asyncQueue.enqueueAndForget(new FirestoreClient$$ExternalSyntheticLambda1(this, new BundleReader(this.bundleSerializer, inputStream), loadBundleTask));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$loadBundle$19$com-google-firebase-firestore-core-FirestoreClient  reason: not valid java name */
    public /* synthetic */ void m392lambda$loadBundle$19$comgooglefirebasefirestorecoreFirestoreClient(BundleReader bundleReader, LoadBundleTask loadBundleTask) {
    ...
    public Task<Query> getNamedQuery(String str) {
        verifyNotTerminated();
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.asyncQueue.enqueueAndForget(new FirestoreClient$$ExternalSyntheticLambda18(this, str, taskCompletionSource));
        return taskCompletionSource.getTask();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$getNamedQuery$20$com-google-firebase-firestore-core-FirestoreClient  reason: not valid java name */
    public /* synthetic */ void m390lambda$getNamedQuery$20$comgooglefirebasefirestorecoreFirestoreClient(String str, TaskCompletionSource taskCompletionSource) {
    ...
    public Task<Void> configureFieldIndexes(List<FieldIndex> list) {
        verifyNotTerminated();
        return this.asyncQueue.enqueue((Runnable) new FirestoreClient$$ExternalSyntheticLambda7(this, list));
    }
    ...
    public /* synthetic */ void m384lambda$configureFieldIndexes$21$comgooglefirebasefirestorecoreFirestoreClient(List list) {
        this.localStore.configureFieldIndexes(list);
    }

    public void setIndexAutoCreationEnabled(boolean z) {
        verifyNotTerminated();
        this.asyncQueue.enqueueAndForget(new FirestoreClient$$ExternalSyntheticLambda22(this, z));
    }
    ...
    public /* synthetic */ void m398lambda$setIndexAutoCreationEnabled$22$comgooglefirebasefirestorecoreFirestoreClient(boolean z) {
    ...
    public /* synthetic */ void m385lambda$deleteAllFieldIndexes$23$comgooglefirebasefirestorecoreFirestoreClient() {
    ...
    public /* synthetic */ void m396lambda$removeSnapshotsInSyncListener$24$comgooglefirebasefirestorecoreFirestoreClient(EventListener eventListener) {
    ...
    public void removeSnapshotsInSyncListener(EventListener<Void> eventListener) {
        this.asyncQueue.enqueueAndForget(new FirestoreClient$$ExternalSyntheticLambda17(this, eventListener));
    }
