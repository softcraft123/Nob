...
public class FieldFilter extends Filter {
    ...
    public boolean matches(Document document) {
        ...
        return this.operator == Operator.NOT_EQUAL ? field2 != null && !field2.hasNullValue() && matchesComparison(Values.compare(field2, this.value)) : field2 != null && Values.typeOrder(field2) == Values.typeOrder(this.value) && matchesComparison(Values.compare(field2, this.value));
    }
