...
public class AsyncEventListener<T> implements EventListener<T> {
    ...
    public /* synthetic */ void m382lambda$onEvent$0$comgooglefirebasefirestorecoreAsyncEventListener(Object obj, FirebaseFirestoreException firebaseFirestoreException) {
        if (!this.muted) {
