...
public class Transaction {
    ...
    public Task<List<MutableDocument>> lookup(List<DocumentKey> list) {
        ...
        return this.datastore.lookup(list).continueWithTask(Executors.DIRECT_EXECUTOR, new Transaction$$ExternalSyntheticLambda0(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$lookup$0$com-google-firebase-firestore-core-Transaction  reason: not valid java name */
    public /* synthetic */ Task m404lambda$lookup$0$comgooglefirebasefirestorecoreTransaction(Task task) throws Exception {
        if (task.isSuccessful()) {
            for (MutableDocument recordVersion : (List) task.getResult()) {
