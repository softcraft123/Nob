...
public class TransactionRunner<TResult> {
    ...
    public /* synthetic */ void m407lambda$runWithBackoff$2$comgooglefirebasefirestorecoreTransactionRunner() {
        Transaction createTransaction = this.remoteStore.createTransaction();
        this.updateFunction.apply(createTransaction).addOnCompleteListener(this.asyncQueue.getExecutor(), new TransactionRunner$$ExternalSyntheticLambda1(this, createTransaction));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$runWithBackoff$1$com-google-firebase-firestore-core-TransactionRunner  reason: not valid java name */
    public /* synthetic */ void m406lambda$runWithBackoff$1$comgooglefirebasefirestorecoreTransactionRunner(Transaction transaction, Task task) {
        if (!task.isSuccessful()) {
            handleTransactionError(task);
        } else {
            transaction.commit().addOnCompleteListener(this.asyncQueue.getExecutor(), new TransactionRunner$$ExternalSyntheticLambda0(this, task));
        }
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$runWithBackoff$0$com-google-firebase-firestore-core-TransactionRunner  reason: not valid java name */
    public /* synthetic */ void m405lambda$runWithBackoff$0$comgooglefirebasefirestorecoreTransactionRunner(Task task, Task task2) {
