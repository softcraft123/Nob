...
public class Query {
    ...
    private Value parseDocumentIdValue(Object obj) {
        if (obj instanceof String) {
            ...
            } else if (this.query.isCollectionGroupQuery() || !str.contains(DomExceptionUtils.SEPARATOR)) {
        ...
        if (objArr.length <= explicitOrderBy.size()) {
            ...
            for (int i = 0; i < objArr.length; i++) {
                ...
                if (!explicitOrderBy.get(i).getField().equals(FieldPath.KEY_PATH)) {
                    ...
                    String str3 = str2;
                    if (this.query.isCollectionGroupQuery() || !str3.contains(DomExceptionUtils.SEPARATOR)) {
    ...
    public /* synthetic */ Task m373lambda$get$0$comgooglefirebasefirestoreQuery(FirestoreClient firestoreClient) {
    ...
    public /* synthetic */ QuerySnapshot m374lambda$get$1$comgooglefirebasefirestoreQuery(Task task) throws Exception {
    ...
    private Task<QuerySnapshot> getViaSnapshotListener(Source source) {
        ...
        taskCompletionSource2.setResult(addSnapshotListenerInternal(Executors.DIRECT_EXECUTOR, listenOptions, (Activity) null, new Query$$ExternalSyntheticLambda2(taskCompletionSource, taskCompletionSource2, source)));
    ...
    private ListenerRegistration addSnapshotListenerInternal(Executor executor, EventManager.ListenOptions listenOptions, Activity activity, EventListener<QuerySnapshot> eventListener) {
        validateHasExplicitOrderByForLimitToLast();
        return (ListenerRegistration) this.firestore.callClient(new Query$$ExternalSyntheticLambda1(this, listenOptions, new AsyncEventListener(executor, new Query$$ExternalSyntheticLambda0(this, eventListener)), activity));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$addSnapshotListenerInternal$3$com-google-firebase-firestore-Query  reason: not valid java name */
    public /* synthetic */ void m371lambda$addSnapshotListenerInternal$3$comgooglefirebasefirestoreQuery(EventListener eventListener, ViewSnapshot viewSnapshot, FirebaseFirestoreException firebaseFirestoreException) {
        if (firebaseFirestoreException != null) {
    ...
    public /* synthetic */ ListenerRegistration m372lambda$addSnapshotListenerInternal$5$comgooglefirebasefirestoreQuery(EventManager.ListenOptions listenOptions, AsyncEventListener asyncEventListener, Activity activity, FirestoreClient firestoreClient) {
