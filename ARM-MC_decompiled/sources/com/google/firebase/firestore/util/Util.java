...
public class Util {
    ...
    public static int compareUtf8Strings(String str, String str2) {
        ...
        while (i < min) {
            ...
            if (charAt == charAt2) {
                i++;
            } else if (Character.isSurrogate(charAt) == Character.isSurrogate(charAt2)) {
    ...
    public static void crashMainThread(RuntimeException runtimeException) {
        new Handler(Looper.getMainLooper()).post(new Util$$ExternalSyntheticLambda0(runtimeException));
    }
    ...
    public static <T extends Comparable<T>> void diffCollections(SortedSet<T> sortedSet, SortedSet<T> sortedSet2, Consumer<T> consumer, Consumer<T> consumer2) {
        ...
        if (sortedSet.comparator() != null) {
            ...
            /*  JADX ERROR: Method code generation error
                jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0015: CONSTRUCTOR  (r2v2 ? I:com.google.firebase.firestore.util.Util$$ExternalSyntheticLambda2) =  call: com.google.firebase.firestore.util.Util$$ExternalSyntheticLambda2.<init>():void type: CONSTRUCTOR in method: com.google.firebase.firestore.util.Util.diffCollections(java.util.SortedSet, java.util.SortedSet, com.google.firebase.firestore.util.Consumer, com.google.firebase.firestore.util.Consumer):void, dex: classes3.dex
        ...
        public static <K, V> Iterable<V> values(Iterable<Map.Entry<K, V>> iterable) {
            return new Util$$ExternalSyntheticLambda5(iterable);
        }
        ...
        public static <K, V> Map<K, V> firstNEntries(Map<K, V> map, int i, Comparator<V> comparator) {
            ...
            Collections.sort(arrayList, new Util$$ExternalSyntheticLambda3(comparator));
