...
public class ExponentialBackoff {
    ...
    public void backoffAndRun(Runnable runnable) {
        ...
        this.timerTask = this.queue.enqueueAfterDelay(this.timerId, max2, new ExponentialBackoff$$ExternalSyntheticLambda0(this, runnable));
    ...
    public /* synthetic */ void m497lambda$backoffAndRun$0$comgooglefirebasefirestoreutilExponentialBackoff(Runnable runnable) {
        this.lastAttemptTime = new Date().getTime();
        runnable.run();
    }
