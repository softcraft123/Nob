...
public class AsyncQueue {
    ...
    public class DelayedTask {
        ...
        public void start(long j) {
            this.scheduledFuture = AsyncQueue.this.executor.schedule(new AsyncQueue$DelayedTask$$ExternalSyntheticLambda0(this), j, TimeUnit.MILLISECONDS);
        }
    ...
    public static <TResult> Task<TResult> callTask(Executor executor2, Callable<Task<TResult>> callable) {
        ...
        executor2.execute(new AsyncQueue$$ExternalSyntheticLambda6(callable, executor2, taskCompletionSource));
    ...
    static /* synthetic */ void lambda$callTask$1(Callable callable, Executor executor2, TaskCompletionSource taskCompletionSource) {
        try {
            ((Task) callable.call()).continueWith(executor2, new AsyncQueue$$ExternalSyntheticLambda2(taskCompletionSource));
        } catch (Exception e) {
    ...
    private class SynchronizedShutdownAwareExecutor implements Executor {
        ...
        SynchronizedShutdownAwareExecutor() {
            ...
            newThread.setUncaughtExceptionHandler(new AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda1(this));
            AnonymousClass1 r1 = new ScheduledThreadPoolExecutor(1, delayedStartFactory, AsyncQueue.this) {
        ...
        public /* synthetic */ void m495lambda$new$0$comgooglefirebasefirestoreutilAsyncQueue$SynchronizedShutdownAwareExecutor(Thread thread2, Throwable th) {
            AsyncQueue.this.panic(th);
        }
        ...
        public void executeEvenAfterShutdown(Runnable runnable) {
            try {
                ...
                Class<AsyncQueue> cls = AsyncQueue.class;
        ...
        public <T> Task<T> executeAndReportResult(Callable<T> callable) {
            TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
            try {
                execute(new AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda2(taskCompletionSource, callable));
            } catch (RejectedExecutionException unused) {
                Class<AsyncQueue> cls = AsyncQueue.class;
                Logger.warn("AsyncQueue", "Refused to enqueue task after panic", new Object[0]);
            }
        ...
        public synchronized Task<Void> executeAndInitiateShutdown(Runnable runnable) {
            ...
            Task<Void> executeAndReportResult = executeAndReportResult(new AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda0(runnable));
    ...
    public Task<Void> enqueue(Runnable runnable) {
        return enqueue(new AsyncQueue$$ExternalSyntheticLambda4(runnable));
    }
    ...
    public void panic(Throwable th) {
        ...
        new Handler(Looper.getMainLooper()).post(new AsyncQueue$$ExternalSyntheticLambda3(th));
    }
    ...
    public void runSync(Runnable runnable) throws InterruptedException {
        ...
        enqueueAndForget(new AsyncQueue$$ExternalSyntheticLambda5(runnable, thArr, semaphore));
        semaphore.acquire(1);
        if (thArr[0] != null) {
    ...
    public void runDelayedTasksUntil(TimerId timerId) throws InterruptedException {
        runSync(new AsyncQueue$$ExternalSyntheticLambda1(this, timerId));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$runDelayedTasksUntil$6$com-google-firebase-firestore-util-AsyncQueue  reason: not valid java name */
    public /* synthetic */ void m494lambda$runDelayedTasksUntil$6$comgooglefirebasefirestoreutilAsyncQueue(TimerId timerId) {
