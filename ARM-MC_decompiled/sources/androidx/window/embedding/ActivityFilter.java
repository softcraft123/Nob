...
public final class ActivityFilter {
    ...
    public ActivityFilter(ComponentName componentName2, String str) {
        ...
        if (charSequence.length() > 0) {
            ...
            } else if (StringsKt.contains$default(charSequence2, (CharSequence) "*", false, 2, (Object) null) && StringsKt.indexOf$default(charSequence2, "*", 0, false, 6, (Object) null) != className.length() - 1) {
    ...
    public final boolean matchesActivity(Activity activity) {
        ...
        return Intrinsics.areEqual((Object) str, (Object) intent == null ? null : intent.getAction());
    }
