...
final class WindowInfoTrackerImpl$windowLayoutInfo$1 extends SuspendLambda implements Function2<FlowCollector<? super WindowLayoutInfo>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0093, code lost:
        if (r5.emit((androidx.window.layout.WindowLayoutInfo) r1.next(), r9) == r0) goto L_0x0095;
     */
    /* JADX WARNING: Removed duplicated region for block: B:19:0x0073 A[Catch:{ all -> 0x00a2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:22:0x007e A[Catch:{ all -> 0x00a2 }] */
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r10) {
        /*
            ...
            kotlin.ResultKt.throwOnFailure(r10)     // Catch:{ all -> 0x00a2 }
        L_0x001d:
            r10 = r5
            goto L_0x0061
        L_0x001f:
        ...
        L_0x0037:
            ...
            kotlinx.coroutines.channels.ChannelIterator r1 = r1.iterator()     // Catch:{ all -> 0x00a2 }
        L_0x0061:
            r5 = r9
            kotlin.coroutines.Continuation r5 = (kotlin.coroutines.Continuation) r5     // Catch:{ all -> 0x00a2 }
            r9.L$0 = r10     // Catch:{ all -> 0x00a2 }
            r9.L$1 = r4     // Catch:{ all -> 0x00a2 }
            r9.L$2 = r1     // Catch:{ all -> 0x00a2 }
            r9.label = r3     // Catch:{ all -> 0x00a2 }
            java.lang.Object r5 = r1.hasNext(r5)     // Catch:{ all -> 0x00a2 }
        ...
        L_0x0073:
            ...
            r10 = r8
        L_0x0076:
            java.lang.Boolean r10 = (java.lang.Boolean) r10     // Catch:{ all -> 0x00a2 }
            boolean r10 = r10.booleanValue()     // Catch:{ all -> 0x00a2 }
            if (r10 == 0) goto L_0x0096
            java.lang.Object r10 = r1.next()     // Catch:{ all -> 0x00a2 }
            androidx.window.layout.WindowLayoutInfo r10 = (androidx.window.layout.WindowLayoutInfo) r10     // Catch:{ all -> 0x00a2 }
            r6 = r9
            kotlin.coroutines.Continuation r6 = (kotlin.coroutines.Continuation) r6     // Catch:{ all -> 0x00a2 }
            r9.L$0 = r5     // Catch:{ all -> 0x00a2 }
            r9.L$1 = r4     // Catch:{ all -> 0x00a2 }
            r9.L$2 = r1     // Catch:{ all -> 0x00a2 }
            r9.label = r2     // Catch:{ all -> 0x00a2 }
            java.lang.Object r10 = r5.emit(r10, r6)     // Catch:{ all -> 0x00a2 }
    ...
    public static final void m136invokeSuspend$lambda0(Channel channel, WindowLayoutInfo windowLayoutInfo) {
        Intrinsics.checkNotNullExpressionValue(windowLayoutInfo, "info");
        channel.m2075trySendJP2dKIU(windowLayoutInfo);
    }
}
