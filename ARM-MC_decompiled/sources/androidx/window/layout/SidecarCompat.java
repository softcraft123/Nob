...
public final class SidecarCompat implements ExtensionInterfaceCompat {
    ...
    /* JADX WARNING: Can't wrap try/catch for region: R(10:58|59|60|61|69|70|71|72|73|(4:75|(2:78|79)|77|96)(2:80|81)) */
    /* JADX WARNING: Incorrect type for immutable var: ssa=int, code=?, for r0v3, types: [int] */
    /* JADX WARNING: Missing exception handler attribute for start block: B:72:0x0111 */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:75:0x0142 A[Catch:{ NoSuchFieldError -> 0x00bf, all -> 0x019c }] */
    ...
    public boolean validateExtensionInterface() {
        /*
            r8 = this;
            r0 = 0
            androidx.window.sidecar.SidecarInterface r1 = r8.sidecar     // Catch:{ all -> 0x019c }
            r2 = 1
            r3 = 0
        ...
        L_0x0007:
            ...
            goto L_0x001c
        L_0x0009:
            java.lang.Class r1 = r1.getClass()     // Catch:{ all -> 0x019c }
            if (r1 != 0) goto L_0x0010
            goto L_0x0007
        L_0x0010:
            java.lang.String r4 = "setSidecarCallback"
            java.lang.Class[] r5 = new java.lang.Class[r2]     // Catch:{ all -> 0x019c }
            ...
            r5[r0] = r6     // Catch:{ all -> 0x019c }
            java.lang.reflect.Method r1 = r1.getMethod(r4, r5)     // Catch:{ all -> 0x019c }
        L_0x001c:
            if (r1 != 0) goto L_0x0020
            r1 = r3
            goto L_0x0024
        L_0x0020:
            java.lang.Class r1 = r1.getReturnType()     // Catch:{ all -> 0x019c }
        L_0x0024:
            java.lang.Class r4 = java.lang.Void.TYPE     // Catch:{ all -> 0x019c }
            boolean r4 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r4)     // Catch:{ all -> 0x019c }
            if (r4 == 0) goto L_0x0190
            androidx.window.sidecar.SidecarInterface r1 = r8.sidecar     // Catch:{ all -> 0x019c }
            if (r1 != 0) goto L_0x0031
            goto L_0x0034
        L_0x0031:
            r1.getDeviceState()     // Catch:{ all -> 0x019c }
        L_0x0034:
            androidx.window.sidecar.SidecarInterface r1 = r8.sidecar     // Catch:{ all -> 0x019c }
            if (r1 != 0) goto L_0x0039
            goto L_0x003c
        L_0x0039:
            r1.onDeviceStateListenersChanged(r2)     // Catch:{ all -> 0x019c }
        L_0x003c:
            androidx.window.sidecar.SidecarInterface r1 = r8.sidecar     // Catch:{ all -> 0x019c }
        ...
        L_0x00a7:
            ...
            goto L_0x00ae
        L_0x00aa:
            java.lang.Class r3 = r1.getReturnType()     // Catch:{ all -> 0x019c }
        L_0x00ae:
            java.lang.Class r1 = java.lang.Void.TYPE     // Catch:{ all -> 0x019c }
            boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r3, (java.lang.Object) r1)     // Catch:{ all -> 0x019c }
            if (r1 == 0) goto L_0x016c
            androidx.window.sidecar.SidecarDeviceState r1 = new androidx.window.sidecar.SidecarDeviceState     // Catch:{ all -> 0x019c }
            r1.<init>()     // Catch:{ all -> 0x019c }
            r3 = 3
            r1.posture = r3     // Catch:{ NoSuchFieldError -> 0x00bf }
            goto L_0x00f2
        L_0x00bf:
            ...
            java.lang.Class[] r6 = new java.lang.Class[r2]     // Catch:{ all -> 0x019c }
            java.lang.Class r7 = java.lang.Integer.TYPE     // Catch:{ all -> 0x019c }
            r6[r0] = r7     // Catch:{ all -> 0x019c }
            java.lang.reflect.Method r4 = r4.getMethod(r5, r6)     // Catch:{ all -> 0x019c }
            java.lang.Integer r5 = java.lang.Integer.valueOf(r3)     // Catch:{ all -> 0x019c }
            java.lang.Object[] r5 = new java.lang.Object[]{r5}     // Catch:{ all -> 0x019c }
            r4.invoke(r1, r5)     // Catch:{ all -> 0x019c }
            java.lang.Class<androidx.window.sidecar.SidecarDeviceState> r4 = androidx.window.sidecar.SidecarDeviceState.class
            ...
            java.lang.Object r1 = r4.invoke(r1, r5)     // Catch:{ all -> 0x019c }
            if (r1 == 0) goto L_0x0164
            java.lang.Integer r1 = (java.lang.Integer) r1     // Catch:{ all -> 0x019c }
            int r1 = r1.intValue()     // Catch:{ all -> 0x019c }
            if (r1 != r3) goto L_0x015c
        L_0x00f2:
            androidx.window.sidecar.SidecarDisplayFeature r1 = new androidx.window.sidecar.SidecarDisplayFeature     // Catch:{ all -> 0x019c }
            r1.<init>()     // Catch:{ all -> 0x019c }
            android.graphics.Rect r3 = r1.getRect()     // Catch:{ all -> 0x019c }
            java.lang.String r4 = "displayFeature.rect"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r3, r4)     // Catch:{ all -> 0x019c }
            r1.setRect(r3)     // Catch:{ all -> 0x019c }
            r1.getType()     // Catch:{ all -> 0x019c }
            r1.setType(r2)     // Catch:{ all -> 0x019c }
            ...
            java.util.List r0 = r3.displayFeatures     // Catch:{ NoSuchFieldError -> 0x0111 }
            goto L_0x014a
        L_0x0111:
            ...
            r6[r0] = r7     // Catch:{ all -> 0x019c }
            java.lang.reflect.Method r1 = r1.getMethod(r5, r6)     // Catch:{ all -> 0x019c }
            java.lang.Object[] r5 = new java.lang.Object[]{r4}     // Catch:{ all -> 0x019c }
            r1.invoke(r3, r5)     // Catch:{ all -> 0x019c }
            java.lang.Class<androidx.window.sidecar.SidecarWindowLayoutInfo> r1 = androidx.window.sidecar.SidecarWindowLayoutInfo.class
            java.lang.String r5 = "getDisplayFeatures"
            java.lang.Class[] r6 = new java.lang.Class[r0]     // Catch:{ all -> 0x019c }
            java.lang.reflect.Method r1 = r1.getMethod(r5, r6)     // Catch:{ all -> 0x019c }
            java.lang.Object[] r5 = new java.lang.Object[r0]     // Catch:{ all -> 0x019c }
            java.lang.Object r1 = r1.invoke(r3, r5)     // Catch:{ all -> 0x019c }
            if (r1 == 0) goto L_0x0154
            java.util.List r1 = (java.util.List) r1     // Catch:{ all -> 0x019c }
            boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r4, (java.lang.Object) r1)     // Catch:{ all -> 0x019c }
            if (r1 == 0) goto L_0x014c
        L_0x014a:
            r0 = r2
            goto L_0x019c
        L_0x014c:
            java.lang.Exception r1 = new java.lang.Exception     // Catch:{ all -> 0x019c }
            java.lang.String r2 = "Invalid display feature getter/setter"
            r1.<init>(r2)     // Catch:{ all -> 0x019c }
            throw r1     // Catch:{ all -> 0x019c }
        L_0x0154:
            java.lang.NullPointerException r1 = new java.lang.NullPointerException     // Catch:{ all -> 0x019c }
        ...
        L_0x0164:
            ...
            throw r1     // Catch:{ all -> 0x019c }
        L_0x016c:
            java.lang.NoSuchMethodException r1 = new java.lang.NoSuchMethodException     // Catch:{ all -> 0x019c }
            ...
            throw r1     // Catch:{ all -> 0x019c }
        L_0x0178:
            java.lang.NoSuchMethodException r2 = new java.lang.NoSuchMethodException     // Catch:{ all -> 0x019c }
            java.lang.String r3 = "Illegal return type for 'onWindowLayoutChangeListenerAdded': "
            java.lang.String r1 = kotlin.jvm.internal.Intrinsics.stringPlus(r3, r1)     // Catch:{ all -> 0x019c }
            r2.<init>(r1)     // Catch:{ all -> 0x019c }
