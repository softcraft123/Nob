...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f17 = Float.isNaN(motionKeyPosition2.mPercentX) ? f10 : motionKeyPosition2.mPercentX;
        float f18 = 0.0f;
        float f19 = Float.isNaN(motionKeyPosition2.mAltPercentY) ? 0.0f : motionKeyPosition2.mAltPercentY;
        if (!Float.isNaN(motionKeyPosition2.mPercentY)) {
            f10 = motionKeyPosition2.mPercentY;
        }
        if (!Float.isNaN(motionKeyPosition2.mAltPercentX)) {
            f18 = motionKeyPosition2.mAltPercentX;
        }
        this.mMode = 0;
    ...
    public void initScreen(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (!Float.isNaN(motionKeyPosition2.mPercentX)) {
            this.x = (float) ((int) (motionKeyPosition2.mPercentX * ((float) ((int) (((float) i) - this.width)))));
        }
        if (!Float.isNaN(motionKeyPosition2.mPercentY)) {
            this.y = (float) ((int) (motionKeyPosition2.mPercentY * ((float) ((int) (((float) i2) - this.height)))));
        }
    ...
    public void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f19 = Float.isNaN(motionKeyPosition2.mPercentY) ? 0.0f : motionKeyPosition2.mPercentY;
        this.mMode = 1;
    ...
    public void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        ...
        if (motion != null) {
            ...
            double d2 = (double) f2;
            double d3 = (double) f3;
            f2 = (float) ((((double) f14) + (Math.sin(d3) * d2)) - ((double) (f4 / 2.0f)));
            double d4 = d3;
            f3 = (float) ((((double) f15) - (Math.cos(d3) * d2)) - ((double) (f5 / 2.0f)));
            double d5 = (double) f6;
            double d6 = (double) f8;
            f13 = (float) ((((double) f17) - (d5 * Math.cos(d4))) + (Math.sin(d4) * d6));
            f12 = (float) (((double) f16) + (Math.sin(d4) * d5) + (Math.cos(d4) * d6));
        } else {
            f = 2.0f;
        }
        fArr[0] = f2 + (f4 / f) + 0.0f;
    ...
    public void setView(float f, MotionWidget motionWidget, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        if (motion != null) {
            ...
            double d2 = (double) f3;
            double d3 = (double) f4;
            f3 = (float) ((((double) f15) + (Math.sin(d3) * d2)) - ((double) (f5 / 2.0f)));
            f4 = (float) ((((double) f16) - (Math.cos(d3) * d2)) - ((double) (f6 / 2.0f)));
            double d4 = (double) f17;
            double d5 = (double) f8;
            double d6 = d3;
            double d7 = (double) f9;
            float sin = (float) (d4 + (Math.sin(d3) * d5) + (Math.cos(d3) * d2 * d7));
            float cos = (float) ((((double) f18) - (d5 * Math.cos(d6))) + (Math.sin(d6) * d2 * d7));
            double[] dArr6 = dArr2;
            if (dArr6.length >= 2) {
                dArr6[0] = (double) sin;
                dArr6[1] = (double) cos;
            ...
            if (!Float.isNaN(f14)) {
                motionWidget2.setRotationZ((float) (((double) f14) + Math.toDegrees(Math.atan2((double) cos, (double) sin))));
            }
        } else {
            float f19 = f14;
            if (!Float.isNaN(f19)) {
                motionWidget2.setRotationZ((float) (((double) 0.0f) + ((double) f19) + Math.toDegrees(Math.atan2((double) (f9 + (f11 / 2.0f)), (double) (f8 + (f10 / 2.0f))))));
            }
        }
        float f20 = f3 + 0.5f;
        float f21 = f4 + 0.5f;
        motionWidget2.layout((int) f20, (int) f21, (int) (f20 + f5), (int) (f21 + f6));
    }
