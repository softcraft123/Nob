    ...
    public void setup(float f) {
        ...
        if (size != 0) {
            ...
            while (it.hasNext()) {
                ...
                WavePoint wavePoint3 = wavePoint2;
                WavePoint wavePoint4 = wavePoint3;
                this.mCycleOscillator.setPoint(i, wavePoint.mPosition, wavePoint2.mPeriod, wavePoint3.mOffset, wavePoint4.mPhase, wavePoint4.mValue);
                i++;
            }
