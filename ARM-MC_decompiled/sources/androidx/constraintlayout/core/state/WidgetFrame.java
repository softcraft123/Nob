...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        int i22 = widgetFrame6.right - i20;
        float f5 = f4;
        int i23 = widgetFrame6.bottom - i21;
        int i24 = widgetFrame5.right - i18;
        float f6 = widgetFrame5.alpha;
        float f7 = widgetFrame6.alpha;
        int i25 = widgetFrame5.visibility;
        int i26 = widgetFrame5.bottom - i19;
        if (i25 == 8) {
            i19 = (int) (((float) i19) - (((float) i23) / 2.0f));
            i4 = i23;
            i3 = (int) (((float) i18) - (((float) i22) / 2.0f));
            if (Float.isNaN(f6)) {
                i5 = i22;
                f6 = 0.0f;
            } else {
        ...
        if (widgetFrame6.visibility == 8) {
            ...
            i21 = (int) (((float) i21) - (((float) i23) / 2.0f));
            if (Float.isNaN(f7)) {
                i6 = i23;
                i22 = i5;
                f7 = 0.0f;
        ...
        float f8 = widgetFrame5.visibility == 4 ? 0.0f : f6;
        int i28 = i20;
        float f9 = widgetFrame6.visibility == 4 ? 0.0f : f7;
        if (widgetFrame4.widget == null || !transition2.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                i11 = (int) (findPreviousPosition.x * ((float) i15));
                i9 = (int) (findPreviousPosition.y * ((float) i16));
            ...
            if (findNextPosition != null) {
                i14 = (int) (findNextPosition.x * ((float) i15));
                i13 = findNextPosition.frame;
                i7 = (int) (findNextPosition.y * ((float) i16));
            } else {
                i13 = 100;
                i14 = i28;
                i7 = i29;
            }
            f2 = (f5 - ((float) i12)) / ((float) (i13 - i12));
            i8 = i14;
            i10 = i11;
        }
        widgetFrame4.widget = widgetFrame5.widget;
        int i30 = (int) (((float) i10) + (((float) (i8 - i10)) * f2));
        widgetFrame4.left = i30;
        int i31 = (int) (((float) i9) + (f2 * ((float) (i7 - i9))));
        widgetFrame4.top = i31;
        float f10 = 1.0f - f3;
        widgetFrame4.right = i30 + ((int) ((((float) i5) * f10) + (((float) i22) * f3)));
        widgetFrame4.bottom = i31 + ((int) ((f10 * ((float) i23)) + (((float) i6) * f3)));
        widgetFrame4.pivotX = interpolate(widgetFrame5.pivotX, widgetFrame6.pivotX, 0.5f, f3);
        widgetFrame4.pivotY = interpolate(widgetFrame5.pivotY, widgetFrame6.pivotY, 0.5f, f3);
        widgetFrame4.rotationX = interpolate(widgetFrame5.rotationX, widgetFrame6.rotationX, 0.0f, f3);
        widgetFrame4.rotationY = interpolate(widgetFrame5.rotationY, widgetFrame6.rotationY, 0.0f, f3);
        widgetFrame4.rotationZ = interpolate(widgetFrame5.rotationZ, widgetFrame6.rotationZ, 0.0f, f3);
        widgetFrame4.scaleX = interpolate(widgetFrame5.scaleX, widgetFrame6.scaleX, 1.0f, f3);
        widgetFrame4.scaleY = interpolate(widgetFrame5.scaleY, widgetFrame6.scaleY, 1.0f, f3);
        widgetFrame4.translationX = interpolate(widgetFrame5.translationX, widgetFrame6.translationX, 0.0f, f3);
        widgetFrame4.translationY = interpolate(widgetFrame5.translationY, widgetFrame6.translationY, 0.0f, f3);
        widgetFrame4.translationZ = interpolate(widgetFrame5.translationZ, widgetFrame6.translationZ, 0.0f, f3);
        widgetFrame4.alpha = interpolate(f8, f9, 1.0f, f3);
        ...
        for (String next : keySet) {
            if (widgetFrame5.mCustom.containsKey(next)) {
                ...
                if (customVariable.numberOfInterpolatedValues() == 1) {
                    customVariable3.setValue((Object) Float.valueOf(interpolate(customVariable.getValueToInterpolate(), customVariable2.getValueToInterpolate(), 0.0f, f3)));
                } else {
                    ...
                    for (int i32 = 0; i32 < numberOfInterpolatedValues; i32++) {
                        fArr[i32] = interpolate(fArr[i32], fArr2[i32], 0.0f, f3);
