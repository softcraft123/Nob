...
public class Transition implements TypedValues {
    ...
    public void addKeyPosition(String str, int i, int i2, float f, float f2) {
        ...
        String str2 = str;
        int i3 = i;
        KeyPosition keyPosition = new KeyPosition(str2, i3, i2, f, f2);
        HashMap hashMap = this.keyPositions.get(Integer.valueOf(i3));
        if (hashMap == null) {
            hashMap = new HashMap();
            this.keyPositions.put(Integer.valueOf(i3), hashMap);
        }
