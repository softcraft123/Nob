...
public class StateSet {
    ...
    private void load(android.content.Context r9, org.xmlpull.v1.XmlPullParser r10) {
        ...
        L_0x0025:
            r0.recycle()
            int r0 = r10.getEventType()     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            r1 = 0
        L_0x002d:
            r3 = 1
            ...
            goto L_0x009a
        L_0x003c:
            java.lang.String r0 = r10.getName()     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            boolean r0 = r4.equals(r0)     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            if (r0 == 0) goto L_0x009a
            goto L_0x00a8
        L_0x0048:
            java.lang.String r0 = r10.getName()     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            int r7 = r0.hashCode()     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            switch(r7) {
        ...
        L_0x0054:
            ...
            boolean r0 = r0.equals(r3)     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            if (r0 == 0) goto L_0x0079
            r3 = r5
            goto L_0x007a
        L_0x005e:
            boolean r0 = r0.equals(r4)     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            if (r0 == 0) goto L_0x0079
            goto L_0x007a
        L_0x0065:
        ...
        L_0x007a:
            ...
            goto L_0x009a
        L_0x007f:
            androidx.constraintlayout.widget.StateSet$Variant r0 = new androidx.constraintlayout.widget.StateSet$Variant     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            r0.<init>(r9, r10)     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            if (r1 == 0) goto L_0x009a
            r1.add(r0)     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            goto L_0x009a
        L_0x008a:
            androidx.constraintlayout.widget.StateSet$State r1 = new androidx.constraintlayout.widget.StateSet$State     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            r1.<init>(r9, r10)     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            android.util.SparseArray<androidx.constraintlayout.widget.StateSet$State> r0 = r8.mStateList     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            int r3 = r1.mId     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            r0.put(r3, r1)     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            goto L_0x009a
        L_0x0097:
            r10.getName()     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
        L_0x009a:
            int r0 = r10.next()     // Catch:{ XmlPullParserException -> 0x00a4, IOException -> 0x009f }
            goto L_0x002d
        L_0x009f:
            r9 = move-exception
            r9.printStackTrace()
