...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    public MotionPaths(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i4 == 1) {
            ...
            initScreen(i, i3, keyPosition2, motionPaths4, motionPaths3);
        }
    }
    ...
    public void setView(float f, View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3, boolean z) {
        ...
        if (motionController != null) {
            ...
            if (!Float.isNaN(f14)) {
                view2.setRotation((float) (((double) f14) + Math.toDegrees(Math.atan2((double) cos, (double) sin))));
            }
        } else {
            float f19 = f14;
            if (!Float.isNaN(f19)) {
                view2.setRotation((float) (((double) 0.0f) + ((double) f19) + Math.toDegrees(Math.atan2((double) (f9 + (f11 / 2.0f)), (double) (f8 + (f10 / 2.0f))))));
            }
        }
        if (view2 instanceof FloatLayout) {
            ((FloatLayout) view2).layout(f3, f4, f5 + f3, f6 + f4);
            return;
        }
        float f20 = f3 + 0.5f;
        int i5 = (int) f20;
        ...
        int i9 = i7 - i5;
        int i10 = i8 - i6;
        if (!(i9 == view2.getMeasuredWidth() && i10 == view2.getMeasuredHeight() && !z)) {
