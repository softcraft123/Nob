...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:37:0x0141 A[SYNTHETIC] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void build() {
            /*
                r17 = this;
    ...
    private class DevModeDraw {
                ...
                if (i5 != 4 || this.mPathMode[i6 - 1] != 0) {
                    ...
                    if (i5 == 4) {
                        ...
                        if (i9 == 1) {
                            ...
                            drawPathScreenTicks(canvas2, f - 0.0f, f2 - 0.0f, i4, i3);
                        }
        ...
        private void drawPathRelativeTicks(Canvas canvas, float f, float f2) {
            ...
            canvas2.drawLine(f, f2, f10, f11, this.mPaintGraph);
        }
        ...
        private void drawPathCartesianTicks(Canvas canvas, float f, float f2) {
            ...
            canvas2.drawLine(f, f2, Math.min(f3, f5), f2, this.mPaintGraph);
            ...
            canvas2.drawLine(f, f2, f, Math.max(f4, f6), this.mPaintGraph);
        }
        ...
        private void drawPathScreenTicks(Canvas canvas, float f, float f2, int i, int i2) {
            ...
            Canvas canvas2 = canvas;
            canvas2.drawLine(f, f2, Math.min(0.0f, 1.0f), f2, this.mPaintGraph);
            String str2 = "" + (((float) ((int) (((double) (((f2 - ((float) (i2 / 2))) * 100.0f) / ((float) (MotionLayout.this.getHeight() - i2)))) + 0.5d))) / 100.0f);
            getTextBounds(str2, this.mTextPaint);
            canvas.drawText(str2, 5.0f + f, 0.0f - ((f2 / 2.0f) - ((float) (this.mBounds.height() / 2))), this.mTextPaint);
            canvas2.drawLine(f, f2, f, Math.max(0.0f, 1.0f), this.mPaintGraph);
        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:132:0x0204 A[ADDED_TO_REGION] */
