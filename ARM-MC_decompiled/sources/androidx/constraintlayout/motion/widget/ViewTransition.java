...
public class ViewTransition {
    ...
    ViewTransition(android.content.Context r10, org.xmlpull.v1.XmlPullParser r11) {
        /*
            ...
            r9.mContext = r10
            int r2 = r11.getEventType()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
        L_0x002a:
            r3 = 1
            ...
            goto L_0x00e2
        L_0x0037:
            java.lang.String r2 = r11.getName()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            boolean r2 = r4.equals(r2)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            if (r2 == 0) goto L_0x00e2
            goto L_0x00f1
        L_0x0043:
            java.lang.String r2 = r11.getName()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            int r7 = r2.hashCode()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            r8 = 4
            switch(r7) {
                case -1962203927: goto L_0x0076;
                case -1239391468: goto L_0x006c;
                case 61998586: goto L_0x0064;
                case 366511058: goto L_0x005a;
                case 1791837707: goto L_0x0050;
                default: goto L_0x004f;
            }     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
        L_0x004f:
            goto L_0x0080
        L_0x0050:
            java.lang.String r4 = "CustomAttribute"
            boolean r4 = r2.equals(r4)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
        ...
        L_0x0081:
            ...
            java.lang.String r3 = TAG     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.String r5 = androidx.constraintlayout.motion.widget.Debug.getLoc()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.String r5 = " unknown tag "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.StringBuilder r2 = r4.append(r2)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.String r2 = r2.toString()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            android.util.Log.e(r3, r2)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.String r2 = TAG     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            r3.<init>()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.String r4 = ".xml:"
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            int r4 = r11.getLineNumber()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.lang.String r3 = r3.toString()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            android.util.Log.e(r2, r3)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            goto L_0x00e2
        L_0x00c8:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = r9.mConstraintDelta     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r2 = r2.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r10, r11, r2)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            goto L_0x00e2
        L_0x00d0:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = androidx.constraintlayout.widget.ConstraintSet.buildDelta(r10, r11)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            r9.mConstraintDelta = r2     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            goto L_0x00e2
        L_0x00d7:
            androidx.constraintlayout.motion.widget.KeyFrames r2 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            r2.<init>(r10, r11)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            r9.mKeyFrames = r2     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            goto L_0x00e2
        L_0x00df:
            r9.parseViewTransitionTags(r10, r11)     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
        L_0x00e2:
            int r2 = r11.next()     // Catch:{ XmlPullParserException -> 0x00ed, IOException -> 0x00e8 }
            goto L_0x002a
        L_0x00e8:
            r10 = move-exception
            r10.printStackTrace()
    ...
    public /* synthetic */ void m38lambda$applyTransition$0$androidxconstraintlayoutmotionwidgetViewTransition(View[] viewArr) {
        if (this.mSetsTag != -1) {
