...
public final class GetPasswordOption extends CredentialOption {
    ...
    public GetPasswordOption(Set<String> set) {
        this(set, false, (Set) null, 6, (DefaultConstructorMarker) null);
    ...
    public static final class Companion {
        ...
        public final GetPasswordOption createFrom$credentials_release(Bundle bundle, Set<ComponentName> set, Bundle bundle2) {
            ...
            return new GetPasswordOption(set2, bundle.getBoolean("androidx.credentials.BUNDLE_KEY_IS_AUTO_SELECT_ALLOWED", false), set, bundle, bundle2, bundle.getInt(CredentialOption.BUNDLE_KEY_TYPE_PRIORITY_VALUE, 1000), (DefaultConstructorMarker) null);
        }
