    ...
    public static final class Companion {
        ...
        public final List<PrivilegedApp> extractPrivilegedApps$credentials_release(JSONObject jSONObject) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (Intrinsics.areEqual((Object) jSONObject2.getString(PrivilegedApp.TYPE_KEY), (Object) PrivilegedApp.ANDROID_TYPE_KEY)) {
        ...
        public final PrivilegedApp createFromJSONObject(JSONObject jSONObject, boolean z) {
            ...
            int length = jSONArray.length();
            for (int i = 0; i < length; i++) {
                if (!z || !Intrinsics.areEqual((Object) "userdebug", (Object) jSONArray.getJSONObject(i).optString(PrivilegedApp.BUILD_KEY)) || Intrinsics.areEqual((Object) "userdebug", (Object) Build.TYPE)) {
