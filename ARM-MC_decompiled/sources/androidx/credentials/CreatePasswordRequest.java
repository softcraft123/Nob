...
public final class CreatePasswordRequest extends CreateCredentialRequest {
    ...
    public static final class Companion {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:7:?, code lost:
            r0 = new androidx.credentials.CreateCredentialRequest.DisplayInfo(r2, (java.lang.CharSequence) null);
         */
        /* JADX WARNING: Missing exception handler attribute for start block: B:6:0x0024 */
        @kotlin.jvm.JvmStatic
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public final androidx.credentials.CreatePasswordRequest createFrom$credentials_release(android.os.Bundle r12, java.lang.String r13, android.os.Bundle r14) {
            /*
                r11 = this;
                ...
                java.lang.String r2 = r12.getString(r0)     // Catch:{ Exception -> 0x0045 }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r2)     // Catch:{ Exception -> 0x0045 }
                java.lang.String r0 = "androidx.credentials.BUNDLE_KEY_PASSWORD"
                java.lang.String r3 = r12.getString(r0)     // Catch:{ Exception -> 0x0045 }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r3)     // Catch:{ Exception -> 0x0045 }
                androidx.credentials.CreateCredentialRequest$DisplayInfo$Companion r0 = androidx.credentials.CreateCredentialRequest.DisplayInfo.Companion     // Catch:{ IllegalArgumentException -> 0x0024 }
                androidx.credentials.CreateCredentialRequest$DisplayInfo r0 = r0.createFrom(r12)     // Catch:{ IllegalArgumentException -> 0x0024 }
            L_0x0022:
                r5 = r0
                goto L_0x002e
            L_0x0024:
                androidx.credentials.CreateCredentialRequest$DisplayInfo r0 = new androidx.credentials.CreateCredentialRequest$DisplayInfo     // Catch:{ Exception -> 0x0045 }
                r1 = r2
                java.lang.CharSequence r1 = (java.lang.CharSequence) r1     // Catch:{ Exception -> 0x0045 }
                r4 = 0
                r0.<init>(r1, r4)     // Catch:{ Exception -> 0x0045 }
                goto L_0x0022
            L_0x002e:
                java.lang.String r0 = "androidx.credentials.BUNDLE_KEY_PREFER_IMMEDIATELY_AVAILABLE_CREDENTIALS"
                r1 = 0
                boolean r7 = r12.getBoolean(r0, r1)     // Catch:{ Exception -> 0x0045 }
                java.lang.String r0 = "androidx.credentials.BUNDLE_KEY_IS_AUTO_SELECT_ALLOWED"
                boolean r4 = r12.getBoolean(r0, r1)     // Catch:{ Exception -> 0x0045 }
                androidx.credentials.CreatePasswordRequest r1 = new androidx.credentials.CreatePasswordRequest     // Catch:{ Exception -> 0x0045 }
                r10 = 0
                r8 = r12
                r6 = r13
                r9 = r14
                r1.<init>(r2, r3, r4, r5, r6, r7, r8, r9, r10)     // Catch:{ Exception -> 0x0045 }
                return r1
            L_0x0045:
                androidx.credentials.internal.FrameworkClassParsingException r12 = new androidx.credentials.internal.FrameworkClassParsingException
                r12.<init>()
                throw r12
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.credentials.CreatePasswordRequest.Companion.createFrom$credentials_release(android.os.Bundle, java.lang.String, android.os.Bundle):androidx.credentials.CreatePasswordRequest");
        }
    }
}
