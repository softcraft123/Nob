...
public class CreatePublicKeyCredentialException extends CreateCredentialException {
    ...
    public static final class Companion {
        ...
        public final CreateCredentialException createFrom(String str, String str2) {
            Intrinsics.checkNotNullParameter(str, "type");
            try {
                if (StringsKt.contains$default((CharSequence) str, (CharSequence) CreatePublicKeyCredentialDomException.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION, false, 2, (Object) null)) {
