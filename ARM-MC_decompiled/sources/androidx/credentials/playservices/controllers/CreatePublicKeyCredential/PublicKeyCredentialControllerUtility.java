...
public final class PublicKeyCredentialControllerUtility {
    ...
    public static final class Companion {
        ...
        public final PublicKeyCredentialCreationOptions convert(CreatePublicKeyCredentialRequest createPublicKeyCredentialRequest, Context context) {
            Intrinsics.checkNotNullParameter(createPublicKeyCredentialRequest, "request");
            Intrinsics.checkNotNullParameter(context, "context");
            if (isDeviceGMSVersionOlderThan(context, PublicKeyCredentialControllerUtility.AUTH_MIN_VERSION_JSON_CREATE)) {
                return new PublicKeyCredentialCreationOptions(createPublicKeyCredentialRequest.getRequestJson());
            }
        ...
        private final boolean isDeviceGMSVersionOlderThan(Context context, long j) {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                ...
                j2 = (long) packageManager.getPackageInfo("com.google.android.gms", 0).versionCode;
            }
            if (j2 > j) {
                return true;
            }
        ...
        public final GetCredentialException beginSignInPublicKeyCredentialResponseContainsError$credentials_play_services_auth_release(ErrorCode errorCode, String str) {
            ...
            if (errorCode == ErrorCode.NOT_ALLOWED_ERR && str != null && StringsKt.contains$default((CharSequence) str, (CharSequence) "Unable to get sync account", false, 2, (Object) null)) {
        ...
        public final void parseOptionalWithRequiredDefaultsAttestationAndExcludeCredentials$credentials_play_services_auth_release(JSONObject jSONObject, PublicKeyCredentialCreationOptions.Builder builder) {
            ...
            if (jSONObject2.has(getJSON_KEY_EXCLUDE_CREDENTIALS$credentials_play_services_auth_release())) {
                ...
                while (i < length) {
                    ...
                    if (string2.length() == 0) {
                        ...
                        arrayList.add(new PublicKeyCredentialDescriptor(string2, b64Decode, (List<Transport>) list));
                        i++;
                    } else {
            ...
            String optString = jSONObject2.optString(jSON_KEY_ATTESTATION$credentials_play_services_auth_release, str);
