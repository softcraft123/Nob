...
public final class CredentialProviderGetSignInIntentController$resultReceiver$1 extends ResultReceiver {
    ...
    public void onReceiveResult(int i, Bundle bundle) {
        ...
        if (!this.this$0.maybeReportErrorFromResultReceiver(bundle2, new CredentialProviderGetSignInIntentController$resultReceiver$1$onReceiveResult$1(CredentialProviderBaseController.Companion), this.this$0.getExecutor(), this.this$0.getCallback(), this.this$0.cancellationSignal)) {
            this.this$0.handleResponse$credentials_play_services_auth_release(bundle2.getInt(CredentialProviderBaseController.ACTIVITY_REQUEST_CODE_TAG), i, (Intent) bundle2.getParcelable(CredentialProviderBaseController.RESULT_DATA_TAG));
        }
    }
}
