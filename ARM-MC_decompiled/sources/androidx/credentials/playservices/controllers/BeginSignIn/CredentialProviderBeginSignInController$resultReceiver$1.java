...
public final class CredentialProviderBeginSignInController$resultReceiver$1 extends ResultReceiver {
    ...
    public void onReceiveResult(int i, Bundle bundle) {
        ...
        if (!this.this$0.maybeReportErrorFromResultReceiver(bundle2, new CredentialProviderBeginSignInController$resultReceiver$1$onReceiveResult$1(CredentialProviderBaseController.Companion), this.this$0.getExecutor(), this.this$0.getCallback(), this.this$0.cancellationSignal)) {
