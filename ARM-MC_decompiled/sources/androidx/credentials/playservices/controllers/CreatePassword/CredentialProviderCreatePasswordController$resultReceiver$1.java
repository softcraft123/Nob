...
public final class CredentialProviderCreatePasswordController$resultReceiver$1 extends ResultReceiver {
    ...
    public void onReceiveResult(int i, Bundle bundle) {
        ...
        if (!credentialProviderCreatePasswordController.maybeReportErrorFromResultReceiver(bundle2, credentialProviderCreatePasswordController$resultReceiver$1$onReceiveResult$1, executor, credentialManagerCallback, this.this$0.cancellationSignal)) {
            this.this$0.handleResponse$credentials_play_services_auth_release(bundle2.getInt(CredentialProviderBaseController.ACTIVITY_REQUEST_CODE_TAG), i);
        }
    }
}
