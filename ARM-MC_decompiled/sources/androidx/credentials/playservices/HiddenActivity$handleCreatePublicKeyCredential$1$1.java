...
final class HiddenActivity$handleCreatePublicKeyCredential$1$1 extends Lambda implements Function1<PendingIntent, Unit> {
    ...
    public final void invoke(PendingIntent pendingIntent) {
        ...
        try {
            ...
            hiddenActivity.setupFailure(access$getResultReceiver$p, CredentialProviderBaseController.CREATE_UNKNOWN, "During public key credential, found IntentSender failure on public key creation: " + sendIntentException.getMessage());
        }
    }
}
