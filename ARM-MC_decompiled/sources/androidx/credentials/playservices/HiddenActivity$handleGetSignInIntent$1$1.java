...
final class HiddenActivity$handleGetSignInIntent$1$1 extends Lambda implements Function1<PendingIntent, Unit> {
    ...
    public final void invoke(PendingIntent pendingIntent) {
        try {
            ...
            hiddenActivity.setupFailure(access$getResultReceiver$p, CredentialProviderBaseController.GET_UNKNOWN, "During get sign-in intent, one tap ui intent sender failure: " + sendIntentException.getMessage());
        }
    }
}
