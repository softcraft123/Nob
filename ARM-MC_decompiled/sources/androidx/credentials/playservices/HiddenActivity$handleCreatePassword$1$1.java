...
final class HiddenActivity$handleCreatePassword$1$1 extends Lambda implements Function1<SavePasswordResult, Unit> {
    ...
    public final void invoke(SavePasswordResult savePasswordResult) {
        try {
            ...
            hiddenActivity.setupFailure(access$getResultReceiver$p, CredentialProviderBaseController.CREATE_UNKNOWN, "During save password, found UI intent sender failure: " + sendIntentException.getMessage());
        }
    }
}
