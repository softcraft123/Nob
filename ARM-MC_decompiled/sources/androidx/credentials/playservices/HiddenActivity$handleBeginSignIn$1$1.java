...
final class HiddenActivity$handleBeginSignIn$1$1 extends Lambda implements Function1<BeginSignInResult, Unit> {
    final /* synthetic */ int $requestCode;
    final /* synthetic */ HiddenActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HiddenActivity$handleBeginSignIn$1$1(HiddenActivity hiddenActivity, int i) {
        super(1);
    ...
    public final void invoke(BeginSignInResult beginSignInResult) {
        try {
            ...
            hiddenActivity.setupFailure(access$getResultReceiver$p, CredentialProviderBaseController.GET_UNKNOWN, "During begin sign in, one tap ui intent sender failure: " + sendIntentException.getMessage());
        }
    }
}
