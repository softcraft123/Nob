    ...
    public <I, O> void onLaunch(int i, ActivityResultContract<I, O> activityResultContract, I i2, ActivityOptionsCompat activityOptionsCompat) {
        ...
        if (Intrinsics.areEqual((Object) ActivityResultContracts.RequestMultiplePermissions.ACTION_REQUEST_PERMISSIONS, (Object) createIntent.getAction())) {
            ...
            try {
                ...
                i3 = i;
                try {
                    ActivityCompat.startIntentSenderForResult(activity, intentSenderRequest.getIntentSender(), i3, intentSenderRequest.getFillInIntent(), intentSenderRequest.getFlagsMask(), intentSenderRequest.getFlagsValues(), 0, bundle2);
                } catch (IntentSender.SendIntentException e) {
                    e = e;
                    new Handler(Looper.getMainLooper()).post(new ComponentActivity$activityResultRegistry$1$$ExternalSyntheticLambda1(this, i3, e));
                }
