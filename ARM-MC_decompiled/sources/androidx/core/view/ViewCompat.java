...
public class ViewCompat {
    ...
    public static WindowInsetsCompat dispatchApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
        ...
        if (windowInsets2 != null) {
            if (Build.VERSION.SDK_INT >= 30) {
                windowInsets = Api30Impl.dispatchApplyWindowInsets(view, windowInsets2);
            } else {
                windowInsets = Api20Impl.dispatchApplyWindowInsets(view, windowInsets2);
            }
            if (!windowInsets.equals(windowInsets2)) {
    ...
    public static void dispatchNestedScroll(View view, int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        int i8 = i3;
        int i9 = i2;
        dispatchNestedScroll(view, i, i9, i8, i7, iArr3, i6);
    }
    ...
    public static boolean dispatchNestedScroll(View view, int i, int i2, int i3, int i4, int[] iArr, int i5) {
        ...
        int i7 = i3;
        int i8 = i2;
        return dispatchNestedScroll(view, i, i8, i7, i6, iArr2);
    }
    ...
    private static class Api21Impl {
        ...
        static void setOnApplyWindowInsetsListener(final View view, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
            AnonymousClass1 r0 = onApplyWindowInsetsListener != null ? new View.OnApplyWindowInsetsListener() {
            ...
            if (Build.VERSION.SDK_INT < 30) {
                view.setTag(R.id.tag_on_apply_window_listener, r0);
            }
