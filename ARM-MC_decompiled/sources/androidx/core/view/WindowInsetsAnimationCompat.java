    ...
    private static class Impl21 extends Impl {
        ...
        private static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                ...
                final WindowInsetsAnimationCompat windowInsetsAnimationCompat = new WindowInsetsAnimationCompat(i3, Impl21.createInsetInterpolator(i, i2), (WindowInsetsCompat.Type.ime() & i3) != 0 ? 160 : 250);
                ...
                duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    public void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        Impl21.dispatchOnProgress(view2, Impl21.interpolateInsets(windowInsetsCompat, windowInsetsCompat2, windowInsetsAnimationCompat2.getInterpolatedFraction(), i3), Collections.singletonList(windowInsetsAnimationCompat2));
                    }
                });
                duration.addListener(new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animator) {
                        windowInsetsAnimationCompat2.setFraction(1.0f);
                        Impl21.dispatchOnEnd(view2, windowInsetsAnimationCompat2);
                    }
                });
                ...
                OneShotPreDrawListener.add(view4, new Runnable() {
                    public void run() {
                        Impl21.dispatchOnStart(view3, windowInsetsAnimationCompat, computeAnimationBounds);
                        duration.start();
                    }
                });
                this.mLastInsets = windowInsetsCompat;
