...
public final class DisplayCutoutCompat {
    ...
    public DisplayCutoutCompat(Insets insets, Rect rect, Rect rect2, Rect rect3, Rect rect4, Insets insets2) {
        this(constructDisplayCutout(insets, rect, rect2, rect3, rect4, insets2, (Path) null));
    }
    ...
    private static DisplayCutout constructDisplayCutout(Insets insets, Rect rect, Rect rect2, Rect rect3, Rect rect4, Insets insets2, Path path) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            Rect rect6 = rect3;
            Rect rect7 = rect2;
            return Api30Impl.createDisplayCutout(insets.toPlatformInsets(), rect, rect7, rect6, rect5, insets3.toPlatformInsets());
            ...
            Rect rect8 = new Rect(insets.left, insets.top, insets.right, insets.bottom);
            ...
            return Api28Impl.createDisplayCutout(rect8, arrayList);
        }
    }
