...
public class FontResourcesParserCompat {
    ...
    public static final class ProviderResourceEntry implements FamilyResourceEntry {
        ...
        public ProviderResourceEntry(FontRequest fontRequest, int i, int i2) {
            this(Collections.singletonList(fontRequest), i, i2, (String) null);
        }
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        while (xmlPullParser.next() != 3) {
            if (xmlPullParser.getEventType() == 2) {
                if (xmlPullParser.getName().equals("fallback")) {
                    arrayList2.add(readFallback(xmlPullParser, resources, string, string2, readCerts));
                } else {
                    skip(xmlPullParser);
                }
            }
        ...
        if (string3 != null) {
            arrayList2.add(new FontRequest(string, string2, string3, readCerts, (String) null, (String) null));
            if (string4 != null) {
                arrayList2.add(new FontRequest(string, string2, string4, readCerts, (String) null, (String) null));
            }
            return new ProviderResourceEntry(arrayList2, integer, integer2, string5);
        }
