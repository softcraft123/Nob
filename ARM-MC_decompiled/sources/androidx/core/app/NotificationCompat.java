...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:50:0x01b3  */
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r12, int r13, boolean r14) {
            /*
                ...
                android.graphics.Bitmap r2 = r11.createColoredBitmap((androidx.core.graphics.drawable.IconCompat) r2, (int) r7)
                ...
                int r2 = r2.icon
                androidx.core.app.NotificationCompat$Builder r3 = r11.mBuilder
                int r3 = r3.getColor()
                android.graphics.Bitmap r12 = r11.createIconWithBackground(r2, r12, r13, r3)
                int r13 = androidx.core.R.id.right_icon
                r1.setImageViewBitmap(r13, r12)
                int r12 = androidx.core.R.id.right_icon
                r1.setViewVisibility(r12, r7)
                goto L_0x009f
            L_0x0068:
                if (r12 == 0) goto L_0x009f
                androidx.core.app.NotificationCompat$Builder r12 = r11.mBuilder
            ...
            L_0x0116:
                ...
                r1.setTextViewTextSize(r0, r7, r14)
            L_0x0147:
            ...
            L_0x0156:
                ...
                r1.setLong(r14, r0, r2)
                int r14 = androidx.core.R.id.chronometer
                java.lang.String r0 = "setStarted"
                r1.setBoolean(r14, r0, r13)
                androidx.core.app.NotificationCompat$Builder r14 = r11.mBuilder
                ...
                androidx.core.app.NotificationCompat.Style.Api24Impl.setChronometerCountDown(r1, r14, r0)
                goto L_0x01af
            L_0x019b:
    ...
    public static class ProgressStyle extends Style {
        ...
        public ProgressStyle setProgressSegments(List<Segment> list) {
            ...
            for (Segment addProgressSegment : list) {
                addProgressSegment(addProgressSegment);
            }
            return this;
        }
        ...
        public ProgressStyle setProgressPoints(List<Point> list) {
            ...
            for (Point addProgressPoint : list) {
                addProgressPoint(addProgressPoint);
            }
            return this;
        }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 36) {
                ...
                if (iconCompat3 != null) {
                    icon = iconCompat3.toIcon(context);
                }
                Api36Impl.setProgressTrackerIcon(progressStyle, icon);
        ...
        public void restoreFromCompatExtras(Bundle bundle) {
            super.restoreFromCompatExtras(bundle);
            this.mProgressSegments = getProgressSegmentsFromBundleList(BundleCompat.getParcelableArrayList(bundle, NotificationCompat.EXTRA_PROGRESS_SEGMENTS, Bundle.class));
            ...
            this.mProgressPoints = getProgressPointsFromBundleList(BundleCompat.getParcelableArrayList(bundle, NotificationCompat.EXTRA_PROGRESS_POINTS, Bundle.class));
            this.mTrackerIcon = asIconCompat((Parcelable) BundleCompat.getParcelable(bundle, NotificationCompat.EXTRA_PROGRESS_TRACKER_ICON, Icon.class));
            this.mStartIcon = asIconCompat((Parcelable) BundleCompat.getParcelable(bundle, NotificationCompat.EXTRA_PROGRESS_START_ICON, Icon.class));
            this.mEndIcon = asIconCompat((Parcelable) BundleCompat.getParcelable(bundle, NotificationCompat.EXTRA_PROGRESS_END_ICON, Icon.class));
        }
        ...
        private static final class Api36Impl {
            ...
            static void setProgressPoints(Notification.ProgressStyle progressStyle, List<Point> list) {
                for (Point next : list) {
                    progressStyle.addProgressPoint(new Notification.ProgressStyle.Point(next.getPosition()).setColor(next.getColor()).setId(next.getId()));
                }
            }

            static void setProgressSegments(Notification.ProgressStyle progressStyle, List<Segment> list) {
                for (Segment next : list) {
                    progressStyle.addProgressSegment(new Notification.ProgressStyle.Segment(next.getLength()).setColor(next.getColor()).setId(next.getId()));
                }
            }
        }
    }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) {
            ...
            try {
                ...
                View apply = remoteViews.apply(createPackageContext, (ViewGroup) null);
                ArrayList arrayList = new ArrayList();
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        boolean z2 = Api20Impl.getExtras(action2).getBoolean("android.support.allowGeneratedReplies") || Api24Impl.getAllowGeneratedReplies(action2);
        boolean z3 = Api20Impl.getExtras(action2).getBoolean("android.support.action.showsUserInterface", true);
        if (Build.VERSION.SDK_INT >= 28) {
            i = Api28Impl.getSemanticAction(action2);
        } else {
            i = Api20Impl.getExtras(action2).getInt("android.support.action.semanticAction", 0);
        }
        int i3 = i;
        boolean isContextual = Build.VERSION.SDK_INT >= 29 ? Api29Impl.isContextual(action2) : false;
        if (Build.VERSION.SDK_INT >= 31) {
            z = Api31Impl.isAuthenticationRequired(action2);
        }
        boolean z4 = z;
        if (Api23Impl.getIcon(action2) == null && action2.icon != 0) {
            return new Action(action2.icon, action2.title, action2.actionIntent, Api20Impl.getExtras(action2), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, z4);
        }
        if (Api23Impl.getIcon(action2) != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action2));
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, Api20Impl.getExtras(action2), remoteInputArr, (RemoteInput[]) null, z2, i3, z3, isContextual, z4);
    }
