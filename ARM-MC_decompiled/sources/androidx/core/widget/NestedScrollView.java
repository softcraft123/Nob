...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            initializeTouchDrag((int) motionEvent2.getY(), motionEvent2.getPointerId(0));
    ...
    private int scrollBy(int i, int i2, int i3, boolean z) {
        return scrollBy(i, -1, (MotionEvent) null, i2, i3, z);
    }
    ...
    public int scrollBy(int i, int i2, MotionEvent motionEvent, int i3, int i4, boolean z) {
        ...
        int i10 = i9;
        boolean z2 = false;
        if (dispatchNestedPreScroll(0, i, this.mScrollConsumed, this.mScrollOffset, i9)) {
            i5 = this.mScrollOffset[1];
            i6 = i - this.mScrollConsumed[1];
        } else {
            i6 = i;
            i5 = 0;
        }
        ...
        int i12 = scrollY;
        int i13 = scrollRange;
        boolean z4 = overScrollByCompat(0, i6, 0, scrollY, 0, scrollRange, 0, 0, true) && !hasNestedScrollingParent(i10);
        int scrollY2 = getScrollY() - i12;
        if (!(motionEvent == null || scrollY2 == 0)) {
            getScrollFeedbackProvider().onScrollProgress(motionEvent.getDeviceId(), motionEvent.getSource(), i7, scrollY2);
        }
        int[] iArr = this.mScrollConsumed;
        iArr[1] = 0;
        int i14 = i10;
        dispatchNestedScroll(0, scrollY2, 0, i11 - scrollY2, this.mScrollOffset, i14, iArr);
        int i15 = i14;
        int i16 = i5 + this.mScrollOffset[1];
        int i17 = i11 - this.mScrollConsumed[1];
        int i18 = i12 + i17;
        if (i18 < 0) {
            if (z3) {
                EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, ((float) (-i17)) / ((float) getHeight()), ((float) i8) / ((float) getWidth()));
                if (motionEvent != null) {
                    getScrollFeedbackProvider().onScrollLimit(motionEvent.getDeviceId(), motionEvent.getSource(), i7, true);
                }
            ...
            EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, ((float) i17) / ((float) getHeight()), 1.0f - (((float) i8) / ((float) getWidth())));
            if (motionEvent != null) {
                getScrollFeedbackProvider().onScrollLimit(motionEvent.getDeviceId(), motionEvent.getSource(), i7, false);
            }
        ...
        if (z2 && i15 == 0 && (velocityTracker = this.mVelocityTracker) != null) {
            velocityTracker.clear();
        }
        if (i15 == 1) {
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (f != 0.0f) {
                MotionEvent motionEvent2 = motionEvent;
                scrollBy(-((int) (f * getVerticalScrollFactorCompat())), i2, motionEvent2, i, 1, MotionEventCompat.isFromSource(motionEvent, 8194));
                if (i2 == 0) {
                    return true;
                }
                this.mDifferentialMotionFlingController.onMotionEvent(motionEvent2, i2);
                return true;
            }
        }
        return false;
