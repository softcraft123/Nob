...
public class FlexBuffersBuilder {
    ...
    public int endVector(String str, int i, boolean z, boolean z2) {
        int i2 = i;
        Value createVector = createVector(putKey(str), i2, this.stack.size() - i, z, z2, (Value) null);
    ...
    private Value createKeyVector(int i, int i2) {
        ...
        while (i3 < this.stack.size()) {
            int i4 = i3 + 1;
            max = Math.max(max, Value.elemWidth(4, 0, (long) this.stack.get(i3).key, this.bb.writePosition(), i4));
            i3 = i4;
        }
        int align = align(max);
        writeInt(j, align);
