...
public final class SpringForce implements Force {
    ...
    public DynamicAnimation.MassState updateValues(double d, double d2, long j) {
        ...
        if (d7 > 1.0d) {
            ...
            d4 = Math.pow(2.718281828459045d, (-d7) * d19 * d5) * ((Math.cos(this.mDampedFreq * d5) * d6) + (Math.sin(this.mDampedFreq * d5) * d20));
            double d21 = this.mNaturalFreq;
            double d22 = this.mDampingRatio;
            double pow3 = Math.pow(2.718281828459045d, (-d22) * d21 * d5);
            double d23 = this.mDampedFreq;
            double d24 = d5;
            double sin = (-d23) * d6 * Math.sin(d23 * d24);
            double d25 = this.mDampedFreq;
            d3 = ((-d21) * d4 * d22) + (pow3 * (sin + (d20 * d25 * Math.cos(d25 * d24))));
        }
