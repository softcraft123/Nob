...
class ProfileTranscoder {
    ...
    private static DexProfileData[] readUncompressedBody(InputStream inputStream, String str, int i) throws IOException {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            dexProfileDataArr[i3] = new DexProfileData(str, Encoding.readString(inputStream2, readUInt16), readUInt322, 0, readUInt162, (int) readUInt32, (int) readUInt323, new int[readUInt162], new TreeMap());
        }
