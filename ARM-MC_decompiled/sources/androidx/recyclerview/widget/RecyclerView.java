...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (getOverScrollMode() != 2) {
            if (motionEvent2 != null && !MotionEventCompat.isFromSource(motionEvent2, 8194)) {
                pullGlows(motionEvent2.getX(), (float) i13, motionEvent2.getY(), (float) i15);
            }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r17) {
        ...
        L_0x014b:
            ...
            r7 = r15
        L_0x014e:
            boolean r1 = r0.scrollByInternal(r1, r7, r6)
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                recyclerView3.dispatchNestedScroll(i2, i, i7, i8, (int[]) null, 1, recyclerView3.mReusableIntPair);
    ...
    public final class Recycler {
        ...
        public androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            ...
            L_0x00e7:
                ...
                androidx.recyclerview.widget.RecyclerView$RecycledViewPool r1 = r0.getRecycledViewPool()
                androidx.recyclerview.widget.RecyclerView$ViewHolder r1 = r1.getRecycledView(r11)
                if (r1 == 0) goto L_0x00fd
                r1.resetInternal()
                boolean r2 = androidx.recyclerview.widget.RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST
            ...
            L_0x011a:
                ...
                androidx.recyclerview.widget.RecyclerView r2 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.RecyclerView$ViewHolder r2 = r1.createViewHolder(r2, r11)
                ...
                r4.<init>(r1)
                r2.mNestedRecyclerView = r4
            L_0x0137:
                androidx.recyclerview.widget.RecyclerView r1 = androidx.recyclerview.widget.RecyclerView.this
                long r8 = r1.getNanoTime()
                androidx.recyclerview.widget.RecyclerView$RecycledViewPool r1 = r0.mRecyclerPool
                long r8 = r8 - r12
                r1.factorInCreateTime(r11, r8)
                goto L_0x017f
            L_0x0144:
            ...
            L_0x017f:
                ...
                androidx.recyclerview.widget.RecyclerView$ItemAnimator$ItemHolderInfo r2 = r4.recordPreLayoutInformation(r5, r1, r2, r9)
                androidx.recyclerview.widget.RecyclerView r4 = androidx.recyclerview.widget.RecyclerView.this
