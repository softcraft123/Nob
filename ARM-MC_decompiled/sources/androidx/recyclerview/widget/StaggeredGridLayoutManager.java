...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        if (staggeredGridLayoutManager.mShouldReverseLayout) {
            i2 = staggeredGridLayoutManager.mPrimaryOrientation.getEndAfterPadding();
        } else {
            i2 = staggeredGridLayoutManager.mPrimaryOrientation.getStartAfterPadding();
        }
        int i11 = i2;
        boolean z2 = false;
        while (layoutState.hasMore(state) && (staggeredGridLayoutManager.mLayoutState.mInfinite || !staggeredGridLayoutManager.mRemainingSpans.isEmpty())) {
            ...
            boolean z3 = span2 == -1 ? true : r8;
            if (z3) {
                span = layoutParams.mFullSpan ? staggeredGridLayoutManager.mSpans[r8] : staggeredGridLayoutManager.getNextSpan(layoutState2);
            ...
            if (layoutState2.mLayoutDirection == 1) {
                if (layoutParams.mFullSpan) {
                    i5 = staggeredGridLayoutManager.getMaxEnd(i11);
                } else {
                    i5 = span3.getEndLine(i11);
                }
                i4 = staggeredGridLayoutManager.mPrimaryOrientation.getDecoratedMeasurement(next) + i5;
                if (z3 && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem createFullSpanItemFromEnd = staggeredGridLayoutManager.createFullSpanItemFromEnd(i5);
                ...
                if (layoutParams.mFullSpan) {
                    i9 = staggeredGridLayoutManager.getMinStart(i11);
                } else {
                    i9 = span3.getStartLine(i11);
                }
                i4 = i9;
                i5 = i4 - staggeredGridLayoutManager.mPrimaryOrientation.getDecoratedMeasurement(next);
                if (z3 && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem createFullSpanItemFromStart = staggeredGridLayoutManager.createFullSpanItemFromStart(i4);
            ...
            if (layoutParams.mFullSpan && layoutState2.mItemDirection == -1) {
                if (z3) {
                    ...
                    if (layoutState2.mLayoutDirection == 1) {
                        z = staggeredGridLayoutManager.areAllEndsEqual();
                    } else {
                        z = staggeredGridLayoutManager.areAllStartsEqual();
                    }
                    if (!z) {
            ...
            if (!staggeredGridLayoutManager.isLayoutRTL() || staggeredGridLayoutManager.mOrientation != 1) {
                if (layoutParams.mFullSpan) {
                    i8 = staggeredGridLayoutManager.mSecondaryOrientation.getStartAfterPadding();
                } else {
                    i8 = (span3.mIndex * staggeredGridLayoutManager.mSizePerSpan) + staggeredGridLayoutManager.mSecondaryOrientation.getStartAfterPadding();
                }
                i6 = i8;
                i7 = staggeredGridLayoutManager.mSecondaryOrientation.getDecoratedMeasurement(next) + i6;
            } else {
                if (layoutParams.mFullSpan) {
                    i7 = staggeredGridLayoutManager.mSecondaryOrientation.getEndAfterPadding();
                } else {
                    i7 = staggeredGridLayoutManager.mSecondaryOrientation.getEndAfterPadding() - (((staggeredGridLayoutManager.mSpanCount - 1) - span3.mIndex) * staggeredGridLayoutManager.mSizePerSpan);
                }
                i6 = i7 - staggeredGridLayoutManager.mSecondaryOrientation.getDecoratedMeasurement(next);
            }
            int i12 = i7;
            int i13 = i6;
            if (staggeredGridLayoutManager.mOrientation == 1) {
                staggeredGridLayoutManager.layoutDecoratedWithMargins(next, i13, i5, i12, i4);
                staggeredGridLayoutManager = this;
            } else {
                staggeredGridLayoutManager.layoutDecoratedWithMargins(next, i5, i13, i4, i12);
            }
            if (layoutParams.mFullSpan) {
        ...
        if (staggeredGridLayoutManager.mLayoutState.mLayoutDirection == -1) {
            i3 = staggeredGridLayoutManager.mPrimaryOrientation.getStartAfterPadding() - staggeredGridLayoutManager.getMinStart(staggeredGridLayoutManager.mPrimaryOrientation.getStartAfterPadding());
        } else {
            i3 = staggeredGridLayoutManager.getMaxEnd(staggeredGridLayoutManager.mPrimaryOrientation.getEndAfterPadding()) - staggeredGridLayoutManager.mPrimaryOrientation.getEndAfterPadding();
        }
        if (i3 > 0) {
