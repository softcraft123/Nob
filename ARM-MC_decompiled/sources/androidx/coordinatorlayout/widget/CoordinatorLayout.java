...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (Build.VERSION.SDK_INT < 29) {
            ...
            coordinatorLayout = this;
            context2 = context;
            coordinatorLayout.saveAttributeDataForStyleable(context2, R.styleable.CoordinatorLayout, attributeSet, typedArray2, 0, R.style.Widget_Support_CoordinatorLayout);
        } else {
            context2 = context;
            coordinatorLayout = this;
            coordinatorLayout.saveAttributeDataForStyleable(context2, R.styleable.CoordinatorLayout, attributeSet, typedArray2, i, 0);
        }
        int resourceId = typedArray2.getResourceId(R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        coordinatorLayout.mStatusBarBackground = typedArray2.getDrawable(R.styleable.CoordinatorLayout_statusBarBackground);
        typedArray2.recycle();
        setupForInsets();
    ...
    public boolean onStartNestedScroll(View view, View view2, int i, int i2) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (behavior != null) {
                    int i5 = i2;
                    boolean onStartNestedScroll = behavior.onStartNestedScroll(this, childAt, view, view2, i, i5);
    ...
    public void onNestedScrollAccepted(View view, View view2, int i, int i2) {
        ...
        while (i5 < childCount) {
            ...
            if (layoutParams.isNestedScrollAccepted(i2) && (behavior = layoutParams.getBehavior()) != null) {
                ...
                i4 = i;
                i3 = i2;
                behavior.onNestedScrollAccepted(this, childAt, view4, view3, i4, i3);
            } else {
                view4 = view;
                view3 = view2;
                i4 = i;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i11) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.onNestedScroll(this, childAt, view, i, i2, i3, i4, i11, iArr2);
                    ...
                    if (i4 > 0) {
                        i7 = Math.max(i9, iArr4[1]);
                    } else {
                        i7 = Math.min(i9, iArr4[1]);
                    }
                    i9 = i7;
                    z = true;
                }
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i9) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iArr2[0] = 0;
                    iArr2[1] = 0;
                    behavior.onNestedPreScroll(this, childAt, view, i, i2, iArr2, i9);
                    int[] iArr3 = this.mBehaviorConsumed;
                    if (i > 0) {
        ...
        while (i < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(0) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    f3 = f2;
                    z2 = z;
                    z3 |= behavior.onNestedFling(this, childAt, view2, f4, f3, z2);
                    i++;
                    view = view2;
                    f = f4;
                    f2 = f3;
        ...
        while (i < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(0) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    f4 = f;
                    f3 = f2;
                    z |= behavior.onNestedPreFling(this, childAt, view2, f4, f3);
                    i++;
                    view = view2;
                    f = f4;
                    f2 = f3;
