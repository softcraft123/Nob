...
final class CodedOutputStreamWriter implements Writer {
    ...
    private void writeFixed32ListInternal(int i, IntArrayList intArrayList, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < intArrayList.size(); i4++) {
                i3 += CodedOutputStream.computeFixed32SizeNoTag(intArrayList.getInt(i4));
            }
            this.output.writeUInt32NoTag(i3);
            while (i2 < intArrayList.size()) {
    ...
    private void writeFixed64ListInternal(int i, LongArrayList longArrayList, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < longArrayList.size(); i4++) {
                i3 += CodedOutputStream.computeFixed64SizeNoTag(longArrayList.getLong(i4));
            }
            this.output.writeUInt32NoTag(i3);
            while (i2 < longArrayList.size()) {
    ...
    private void writeFloatListInternal(int i, FloatArrayList floatArrayList, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < floatArrayList.size(); i4++) {
                i3 += CodedOutputStream.computeFloatSizeNoTag(floatArrayList.getFloat(i4));
            }
            this.output.writeUInt32NoTag(i3);
    ...
    private void writeDoubleListInternal(int i, DoubleArrayList doubleArrayList, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < doubleArrayList.size(); i4++) {
                i3 += CodedOutputStream.computeDoubleSizeNoTag(doubleArrayList.getDouble(i4));
            }
            this.output.writeUInt32NoTag(i3);
    ...
    private void writeBoolListInternal(int i, BooleanArrayList booleanArrayList, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < booleanArrayList.size(); i4++) {
                i3 += CodedOutputStream.computeBoolSizeNoTag(booleanArrayList.getBoolean(i4));
            }
            this.output.writeUInt32NoTag(i3);
    ...
    private void writeSFixed32ListInternal(int i, IntArrayList intArrayList, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < intArrayList.size(); i4++) {
                i3 += CodedOutputStream.computeSFixed32SizeNoTag(intArrayList.getInt(i4));
            }
            this.output.writeUInt32NoTag(i3);
            while (i2 < intArrayList.size()) {
    ...
    private void writeSFixed64ListInternal(int i, LongArrayList longArrayList, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < longArrayList.size(); i4++) {
                i3 += CodedOutputStream.computeSFixed64SizeNoTag(longArrayList.getLong(i4));
            }
            this.output.writeUInt32NoTag(i3);
            while (i2 < longArrayList.size()) {
