...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static FieldInfo forField(Field field2, int i, FieldType fieldType, boolean z) {
        ...
        if (fieldType2 != FieldType.MESSAGE_LIST && fieldType2 != FieldType.GROUP_LIST) {
            return new FieldInfo(field2, i, fieldType2, (Class<?>) null, (Field) null, 0, false, z, (OneofInfo) null, (Class<?>) null, (Object) null, (Internal.EnumVerifier) null, (Field) null);
        }
    ...
    public static FieldInfo forPackedField(Field field2, int i, FieldType fieldType, Field field3) {
        ...
        Internal.checkNotNull(fieldType2, "fieldType");
        if (fieldType2 != FieldType.MESSAGE_LIST && fieldType2 != FieldType.GROUP_LIST) {
            return new FieldInfo(field2, i, fieldType2, (Class<?>) null, (Field) null, 0, false, false, (OneofInfo) null, (Class<?>) null, (Object) null, (Internal.EnumVerifier) null, field3);
        }
        throw new IllegalStateException("Shouldn't be called for repeated message fields.");
    }
    ...
    public static FieldInfo forExplicitPresenceField(Field field2, int i, FieldType fieldType, Field field3, int i2, boolean z, Internal.EnumVerifier enumVerifier2) {
        Field field4 = field3;
        checkFieldNumber(i);
        Internal.checkNotNull(field2, "field");
        FieldType fieldType2 = fieldType;
        ...
        if (field4 == null || isExactlyOneBitSet(i2)) {
            return new FieldInfo(field2, i, fieldType2, (Class<?>) null, field4, i2, false, z, (OneofInfo) null, (Class<?>) null, (Object) null, enumVerifier2, (Field) null);
        }
    ...
    public static FieldInfo forOneofMemberField(int i, FieldType fieldType, OneofInfo oneofInfo, Class<?> cls, boolean z, Internal.EnumVerifier enumVerifier2) {
        ...
        Internal.checkNotNull(oneofInfo2, "oneof");
        Class<?> cls2 = cls;
        Internal.checkNotNull(cls2, "oneofStoredType");
        if (fieldType.isScalar()) {
            return new FieldInfo((Field) null, i, fieldType, (Class<?>) null, (Field) null, 0, false, z, oneofInfo2, cls2, (Object) null, enumVerifier2, (Field) null);
        }
    ...
    public static FieldInfo forLegacyRequiredField(Field field2, int i, FieldType fieldType, Field field3, int i2, boolean z, Internal.EnumVerifier enumVerifier2) {
        Field field4 = field3;
        checkFieldNumber(i);
        Internal.checkNotNull(field2, "field");
        FieldType fieldType2 = fieldType;
        ...
        Internal.checkNotNull(field4, "presenceField");
        if (field4 == null || isExactlyOneBitSet(i2)) {
            return new FieldInfo(field2, i, fieldType2, (Class<?>) null, field4, i2, true, z, (OneofInfo) null, (Class<?>) null, (Object) null, enumVerifier2, (Field) null);
        }
        throw new IllegalArgumentException("presenceMask must have exactly one bit set: " + i2);
    }
    ...
    public static final class Builder {
        ...
        public FieldInfo build() {
            ...
            if (field2 == null) {
                ...
                return FieldInfo.forLegacyRequiredField(this.field, this.fieldNumber, this.type, field2, this.presenceMask, this.enforceUtf8, this.enumVerifier);
            } else {
                return FieldInfo.forExplicitPresenceField(this.field, this.fieldNumber, this.type, field2, this.presenceMask, this.enforceUtf8, this.enumVerifier);
            }
        }
    }
}
