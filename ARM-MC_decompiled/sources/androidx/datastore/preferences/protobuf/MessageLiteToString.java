    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            if (substring.endsWith(LIST_SUFFIX) && !substring.endsWith(BUILDER_LIST_SUFFIX) && !substring.equals(LIST_SUFFIX) && (method2 = (Method) entry.getValue()) != null && method2.getReturnType().equals(List.class)) {
                printField(sb2, i3, substring.substring(0, substring.length() - LIST_SUFFIX.length()), GeneratedMessageLite.invokeOrDie(method2, messageLite2, new Object[0]));
                ...
                printField(sb2, i3, substring.substring(0, substring.length() - MAP_SUFFIX.length()), GeneratedMessageLite.invokeOrDie(method, messageLite2, new Object[0]));
        ...
        if (messageLite2 instanceof GeneratedMessageLite.ExtendableMessage) {
            ...
            while (it.hasNext()) {
                ...
                printField(sb2, i3, "[" + ((GeneratedMessageLite.ExtensionDescriptor) next.getKey()).getNumber() + "]", next.getValue());
            }
        }
        GeneratedMessageLite generatedMessageLite = (GeneratedMessageLite) messageLite2;
        if (generatedMessageLite.unknownFields != null) {
            generatedMessageLite.unknownFields.printWithIndent(sb2, i3);
        }
    }
    ...
    static void printField(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                ...
                printField(sb, i2, Values.VECTOR_MAP_VECTORS_KEY, entry.getValue());
                sb.append("\n");
                indent(i, sb);
                sb.append("}");
            } else {
