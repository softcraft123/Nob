...
public final class PreferenceDataStoreFactory {
    ...
    public final DataStore<Preferences> create(ReplaceFileCorruptionHandler<Preferences> replaceFileCorruptionHandler, List<? extends DataMigration<Preferences>> list, CoroutineScope coroutineScope, Function0<? extends File> function0) {
        ...
        Intrinsics.checkNotNullParameter(function0, "produceFile");
        return new PreferenceDataStore(create((Storage<Preferences>) new FileStorage(PreferencesFileSerializer.INSTANCE, (Function1) null, new PreferenceDataStoreFactory$create$delegate$1(function0), 2, (DefaultConstructorMarker) null), replaceFileCorruptionHandler, list, coroutineScope));
    }
    ...
    public final DataStore<Preferences> createWithPath(ReplaceFileCorruptionHandler<Preferences> replaceFileCorruptionHandler, List<? extends DataMigration<Preferences>> list, CoroutineScope coroutineScope, Function0<Path> function0) {
        Intrinsics.checkNotNullParameter(list, "migrations");
        Intrinsics.checkNotNullParameter(coroutineScope, "scope");
        Intrinsics.checkNotNullParameter(function0, "produceFile");
