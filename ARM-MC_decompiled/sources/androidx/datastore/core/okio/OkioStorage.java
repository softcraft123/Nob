...
public final class OkioStorage<T> implements Storage<T> {
    ...
    public OkioStorage(FileSystem fileSystem2, OkioSerializer<T> okioSerializer, Function2<? super Path, ? super FileSystem, ? extends InterProcessCoordinator> function2, Function0<Path> function0) {
