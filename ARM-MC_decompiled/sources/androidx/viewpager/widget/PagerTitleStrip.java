...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void updateTextPositions(int i, float f, boolean z) {
        ...
        if (i17 == 16) {
            ...
            int min = Math.min(paddingLeft, (i10 - this.mScaledTextSpacing) - i15);
            TextView textView2 = this.mPrevText;
            textView2.layout(min, i4, min + i15, textView2.getMeasuredHeight() + i4);
            int max3 = Math.max((width - paddingRight) - i16, i11 + this.mScaledTextSpacing);
        ...
        int min2 = Math.min(paddingLeft, (i10 - this.mScaledTextSpacing) - i15);
        TextView textView22 = this.mPrevText;
        textView22.layout(min2, i4, min2 + i15, textView22.getMeasuredHeight() + i4);
        int max32 = Math.max((width - paddingRight) - i16, i11 + this.mScaledTextSpacing);
