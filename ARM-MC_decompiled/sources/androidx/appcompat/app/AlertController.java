    ...
    public static class AlertParams {
        ...
        public void apply(AlertController alertController) {
            ...
            if (charSequence3 == null && this.mPositiveButtonIcon == null) {
                ...
                alertController3.setButton(-1, charSequence3, this.mPositiveButtonListener, (Message) null, this.mPositiveButtonIcon);
                alertController2 = alertController3;
            }
            CharSequence charSequence4 = this.mNegativeButtonText;
            if (!(charSequence4 == null && this.mNegativeButtonIcon == null)) {
                alertController2.setButton(-2, charSequence4, this.mNegativeButtonListener, (Message) null, this.mNegativeButtonIcon);
            }
            CharSequence charSequence5 = this.mNeutralButtonText;
            if (!(charSequence5 == null && this.mNeutralButtonIcon == null)) {
                alertController2.setButton(-3, charSequence5, this.mNeutralButtonListener, (Message) null, this.mNeutralButtonIcon);
            }
        ...
        private void createListView(AlertController alertController) {
            ...
            final RecycleListView recycleListView = (RecycleListView) this.mInflater.inflate(alertController2.mListLayout, (ViewGroup) null);
            if (!this.mIsMultiChoice) {
                ...
                listAdapter = new ArrayAdapter<CharSequence>(this.mContext, alertController2.mMultiChoiceItemLayout, 16908308, this.mItems) {
            ...
            if (this.mOnClickListener != null) {
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                        AlertParams.this.mOnClickListener.onClick(alertController2.mDialog, i);
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                        ...
                        AlertParams.this.mOnCheckboxClickListener.onClick(alertController2.mDialog, i, recycleListView.isItemChecked(i));
                    }
                });
            }
