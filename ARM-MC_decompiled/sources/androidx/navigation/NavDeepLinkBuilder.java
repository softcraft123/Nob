    ...
    private final void verifyAllDestinations() {
        for (DeepLinkDestination destinationId : this.destinations) {
            ...
            if (findDestination(destinationId2) == null) {
                throw new IllegalArgumentException("Navigation destination " + NavDestination.Companion.getDisplayName(this.context, destinationId2) + " cannot be found in the navigation graph " + this.graph);
            }
        }
    }
    ...
    private static final class PermissiveNavigatorProvider extends NavigatorProvider {
        ...
        public <T extends Navigator<? extends NavDestination>> T getNavigator(String str) {
            ...
            try {
                ...
                Intrinsics.checkNotNull(t, "null cannot be cast to non-null type T of androidx.navigation.NavDeepLinkBuilder.PermissiveNavigatorProvider.getNavigator");
                return t;
            }
        }
    }
