...
public final class NavigationUI {
    ...
    public static final boolean onNavDestinationSelected(MenuItem menuItem, NavController navController) {
        ...
        try {
            ...
            Log.i(TAG, "Ignoring onNavDestinationSelected for MenuItem " + NavDestination.Companion.getDisplayName(navController.getContext(), menuItem.getItemId()) + " as it cannot be found from the current destination " + navController.getCurrentDestination(), e);
            return false;
        }
    }
    ...
    public static final void setupWithNavController(CollapsingToolbarLayout collapsingToolbarLayout, Toolbar toolbar, NavController navController, AppBarConfiguration appBarConfiguration) {
        ...
        toolbar.setNavigationOnClickListener(new NavigationUI$$ExternalSyntheticLambda3(navController, appBarConfiguration));
    }
    ...
    public static final void setupWithNavController(NavigationView navigationView, NavController navController, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(navController, "navController");
        if (!z) {
            navigationView.setNavigationItemSelectedListener(new NavigationUI$$ExternalSyntheticLambda2(navController, z, navigationView));
    ...
    public static final void setupWithNavController(NavigationBarView navigationBarView, NavController navController, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(navController, "navController");
        if (!z) {
            navigationBarView.setOnItemSelectedListener(new NavigationUI$$ExternalSyntheticLambda0(navController, z));
