...
final class Navigator$navigate$1 extends Lambda implements Function1<NavBackStackEntry, NavBackStackEntry> {
    ...
    public final NavBackStackEntry invoke(NavBackStackEntry navBackStackEntry) {
        ...
        if (destination == null || (navigate = this.this$0.navigate(destination, navBackStackEntry.getArguments(), this.$navOptions, this.$navigatorExtras)) == null) {
            return null;
        }
        if (Intrinsics.areEqual((Object) navigate, (Object) destination)) {
            return navBackStackEntry;
        }
        return this.this$0.getState().createBackStackEntry(navigate, navigate.addInDefaultArgs(navBackStackEntry.getArguments()));
    }
}
