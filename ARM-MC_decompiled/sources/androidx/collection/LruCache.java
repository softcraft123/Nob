...
public class LruCache<K, V> {
    ...
    public int sizeOf(K k, V v) {
        Intrinsics.checkNotNullParameter(k, "key");
        Intrinsics.checkNotNullParameter(v, Values.VECTOR_MAP_VECTORS_KEY);
        return 1;
    }
    ...
    public final V get(K r6) {
        /*
            ...
            monitor-enter(r0)
            androidx.collection.internal.LruHashMap<K, V> r1 = r5.map     // Catch:{ all -> 0x005a }
            java.lang.Object r1 = r1.get(r6)     // Catch:{ all -> 0x005a }
            if (r1 == 0) goto L_0x0018
            int r6 = r5.hitCount     // Catch:{ all -> 0x005a }
            int r6 = r6 + 1
            r5.hitCount = r6     // Catch:{ all -> 0x005a }
            monitor-exit(r0)
            return r1
        L_0x0018:
            int r1 = r5.missCount     // Catch:{ all -> 0x005a }
            int r1 = r1 + 1
            r5.missCount = r1     // Catch:{ all -> 0x005a }
            monitor-exit(r0)
        ...
        L_0x0027:
            ...
            monitor-enter(r1)
            int r2 = r5.createCount     // Catch:{ all -> 0x0057 }
            int r2 = r2 + 1
            r5.createCount = r2     // Catch:{ all -> 0x0057 }
            androidx.collection.internal.LruHashMap<K, V> r2 = r5.map     // Catch:{ all -> 0x0057 }
            java.lang.Object r2 = r2.put(r6, r0)     // Catch:{ all -> 0x0057 }
            if (r2 == 0) goto L_0x003e
            androidx.collection.internal.LruHashMap<K, V> r3 = r5.map     // Catch:{ all -> 0x0057 }
            r3.put(r6, r2)     // Catch:{ all -> 0x0057 }
            goto L_0x0049
        L_0x003e:
            int r3 = r5.size     // Catch:{ all -> 0x0057 }
            int r4 = r5.safeSizeOf(r6, r0)     // Catch:{ all -> 0x0057 }
            int r3 = r3 + r4
            r5.size = r3     // Catch:{ all -> 0x0057 }
    ...
    public void trimToSize(int r6) {
        ...
        L_0x0000:
            androidx.collection.internal.Lock r0 = r5.lock
            monitor-enter(r0)
            int r1 = r5.size     // Catch:{ all -> 0x0062 }
            if (r1 < 0) goto L_0x0056
            androidx.collection.internal.LruHashMap<K, V> r1 = r5.map     // Catch:{ all -> 0x0062 }
        ...
        L_0x0020:
            androidx.collection.internal.LruHashMap<K, V> r1 = r5.map     // Catch:{ all -> 0x0062 }
            java.util.Set r1 = r1.getEntries()     // Catch:{ all -> 0x0062 }
            java.lang.Iterable r1 = (java.lang.Iterable) r1     // Catch:{ all -> 0x0062 }
            java.lang.Object r1 = kotlin.collections.CollectionsKt.firstOrNull(r1)     // Catch:{ all -> 0x0062 }
            java.util.Map$Entry r1 = (java.util.Map.Entry) r1     // Catch:{ all -> 0x0062 }
            if (r1 != 0) goto L_0x0032
            monitor-exit(r0)
            return
        L_0x0032:
            java.lang.Object r2 = r1.getKey()     // Catch:{ all -> 0x0062 }
            java.lang.Object r1 = r1.getValue()     // Catch:{ all -> 0x0062 }
            androidx.collection.internal.LruHashMap<K, V> r3 = r5.map     // Catch:{ all -> 0x0062 }
            r3.remove(r2)     // Catch:{ all -> 0x0062 }
            int r3 = r5.size     // Catch:{ all -> 0x0062 }
            int r4 = r5.safeSizeOf(r2, r1)     // Catch:{ all -> 0x0062 }
            int r3 = r3 - r4
