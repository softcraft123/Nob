...
public class SimpleArrayMap<K, V> {
    ...
    private final int indexOf(K k, int i) {
        ...
        if (binarySearch < 0 || Intrinsics.areEqual((Object) k, this.array[binarySearch << 1])) {
            return binarySearch;
        }
        int i3 = binarySearch + 1;
        while (i3 < i2 && this.hashes[i3] == i) {
            if (Intrinsics.areEqual((Object) k, this.array[i3 << 1])) {
                return i3;
            }
            i3++;
        }
        ...
        while (i4 >= 0 && this.hashes[i4] == i) {
            if (Intrinsics.areEqual((Object) k, this.array[i4 << 1])) {
                return i4;
            }
            i4--;
        }
    ...
    private final <T extends V> T getOrDefaultInternal(Object obj, T t) {
        ...
        return indexOfKey >= 0 ? this.array[(indexOfKey << 1) + 1] : t;
    }
    ...
    public V put(K k, V v) {
        ...
        if (i3 < i) {
            ...
            Object[] objArr = this.array;
            ArraysKt.copyInto((T[]) objArr, (T[]) objArr, i5 << 1, i3 << 1, this.size << 1);
        }
        int i6 = this.size;
        if (i == i6) {
    ...
    public void putAll(SimpleArrayMap<? extends K, ? extends V> simpleArrayMap) {
        ...
        if (this.size != 0) {
            ...
            ArraysKt.copyInto((T[]) simpleArrayMap.array, (T[]) this.array, 0, 0, i << 1);
            this.size = i;
        }
    }
    ...
    public V removeAt(int i) {
        ...
        if (iArr.length <= 8 || i2 >= iArr.length / 3) {
            if (i < i4) {
                ...
                Object[] objArr = this.array;
                ArraysKt.copyInto((T[]) objArr, (T[]) objArr, i3, i6 << 1, i2 << 1);
            }
            Object[] objArr2 = this.array;
            int i7 = i4 << 1;
            objArr2[i7] = null;
            ...
            if (i2 == this.size) {
                if (i > 0) {
                    ...
                    ArraysKt.copyInto((T[]) vArr, (T[]) this.array, 0, 0, i3);
                }
                if (i < i4) {
                    int i8 = i + 1;
                    ArraysKt.copyInto(iArr, this.hashes, i, i8, i2);
                    ArraysKt.copyInto((T[]) vArr, (T[]) this.array, i3, i8 << 1, i2 << 1);
                }
            } else {
                throw new ConcurrentModificationException();
            }
    ...
    public V getOrDefault(Object obj, V v) {
        int indexOfKey = indexOfKey(obj);
        return indexOfKey >= 0 ? this.array[(indexOfKey << 1) + 1] : v;
    }
}
