...
public final class MutableLongLongMap extends LongLongMap {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            int i4 = (i << 3) + i3;
                            if (function2.invoke(Long.valueOf(this.keys[i4]), Long.valueOf(this.values[i4])).booleanValue()) {
                                removeValueAt(i4);
                            }
                        }
                        j >>= 8;
    ...
    private final void resizeStorage(int i) {
        ...
        while (i3 < i2) {
            if (((jArr2[i3 >> 3] >> ((i3 & 7) << 3)) & 255) < 128) {
                ...
                jArr6[findFirstAvailableSlot] = jArr4[i3];
            } else {
                jArr = jArr2;
            }
            i3++;
    ...
    public final void putAll(LongLongMap longLongMap) {
        ...
        Intrinsics.checkNotNullParameter(longLongMap2, TypedValues.TransitionType.S_FROM);
