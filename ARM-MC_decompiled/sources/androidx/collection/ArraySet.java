...
public final class ArraySet<E> implements Collection<E>, Set<E>, KMutableCollection, KMutableSet {
    ...
    public final E removeAt(int i) {
        ...
        if (getHashes$collection().length <= 8 || get_size$collection() >= getHashes$collection().length / 3) {
            ...
            if (i6 < i4) {
                int i7 = i6 + 1;
                ArraysKt.copyInto(getHashes$collection(), getHashes$collection(), i6, i7, i3);
                ArraysKt.copyInto((T[]) getArray$collection(), (T[]) getArray$collection(), i6, i7, i3);
            }
            ...
            if (i > 0) {
                int i8 = i;
                ArraysKt.copyInto$default(hashes$collection, getHashes$collection(), 0, 0, i8, 6, (Object) null);
                int i9 = i8;
                objArr = array$collection;
                ArraysKt.copyInto$default(objArr, getArray$collection(), 0, 0, i9, 6, (Object) null);
                i2 = i9;
            } else {
                i2 = i;
                objArr = array$collection;
            ...
            if (i2 < i4) {
                int i10 = i2 + 1;
                ArraysKt.copyInto(hashes$collection, getHashes$collection(), i2, i10, i3);
                ArraysKt.copyInto((T[]) objArr, (T[]) getArray$collection(), i2, i10, i3);
            }
        }
        if (i3 == get_size$collection()) {
