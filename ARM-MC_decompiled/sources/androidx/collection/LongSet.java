...
public abstract class LongSet {
    ...
    public static /* synthetic */ String joinToString$default(LongSet longSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i2, Object obj) {
        if (obj == null) {
            ...
            return longSet.joinToString(charSequence, charSequence2, charSequence3, i3, charSequence5);
        }
                    ...
                    if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                        ...
                        while (i9 < i8) {
                            if ((j & 255) < 128) {
                                ...
                                i3 = i7;
                                sb.append((CharSequence) function12.invoke(Long.valueOf(j2)));
                                i6++;
                            } else {
                                i3 = i7;
                            }
    ...
    public final String joinToString(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, Function1<? super Long, ? extends CharSequence> function1) {
        ...
        CharSequence charSequence7 = charSequence3;
        CharSequence charSequence8 = charSequence4;
        Function1<? super Long, ? extends CharSequence> function12 = function1;
        Intrinsics.checkNotNullParameter(charSequence5, "separator");
        Intrinsics.checkNotNullParameter(charSequence6, "prefix");
        Intrinsics.checkNotNullParameter(charSequence7, "postfix");
        Intrinsics.checkNotNullParameter(charSequence8, "truncated");
    ...
    public final boolean all(Function1<? super Long, Boolean> function1) {
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                int i2 = 8 - ((~(i - length)) >>> 31);
                for (int i3 = 0; i3 < i2; i3++) {
                    if ((255 & j) < 128 && !function1.invoke(Long.valueOf(jArr[(i << 3) + i3])).booleanValue()) {
                        return false;
                    }
                    j >>= 8;
                }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                ...
                for (int i4 = 0; i4 < i3; i4++) {
                    if ((255 & j) < 128 && function12.invoke(Long.valueOf(jArr[(i << 3) + i4])).booleanValue()) {
                        i2++;
                    }
                    j >>= 8;
                }
