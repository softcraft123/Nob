...
public final class ArraySetKt {
    ...
    public static final <E> boolean addInternal(ArraySet<E> arraySet, E e) {
        ...
        int i3 = arraySet2.get_size$collection();
        boolean z = false;
        if (e2 == null) {
            i2 = indexOfNull(arraySet2);
            i = 0;
        } else {
        ...
        int i4 = ~i2;
        if (i3 >= arraySet2.getHashes$collection().length) {
            int i5 = 8;
            if (i3 >= 8) {
                i5 = (i3 >> 1) + i3;
            } else if (i3 < 4) {
            ...
            if (i3 == arraySet2.get_size$collection()) {
                if (arraySet2.getHashes$collection().length == 0) {
                    z = true;
                }
                if (!z) {
                    ArraysKt.copyInto$default(hashes$collection, arraySet2.getHashes$collection(), 0, 0, hashes$collection.length, 6, (Object) null);
                    ArraysKt.copyInto$default(array$collection, arraySet2.getArray$collection(), 0, 0, array$collection.length, 6, (Object) null);
                }
            } else {
                throw new ConcurrentModificationException();
            }
        ...
        if (i4 < i3) {
            int i6 = i4 + 1;
            ArraysKt.copyInto(arraySet2.getHashes$collection(), arraySet2.getHashes$collection(), i6, i4, i3);
            ArraysKt.copyInto((T[]) arraySet2.getArray$collection(), (T[]) arraySet2.getArray$collection(), i6, i4, i3);
        }
        if (i3 != arraySet2.get_size$collection() || i4 >= arraySet2.getHashes$collection().length) {
            throw new ConcurrentModificationException();
        }
        arraySet2.getHashes$collection()[i4] = i;
        arraySet2.getArray$collection()[i4] = e2;
    ...
    public static final <E> E removeAtInternal(ArraySet<E> arraySet, int i) {
        ...
        if (arraySet.getHashes$collection().length <= 8 || arraySet.get_size$collection() >= arraySet.getHashes$collection().length / 3) {
            ...
            if (i6 < i4) {
                int i7 = i6 + 1;
                ArraysKt.copyInto(arraySet.getHashes$collection(), arraySet.getHashes$collection(), i6, i7, i3);
                ArraysKt.copyInto((T[]) arraySet.getArray$collection(), (T[]) arraySet.getArray$collection(), i6, i7, i3);
            }
            ...
            if (i > 0) {
                int i8 = i;
                ArraysKt.copyInto$default(hashes$collection, arraySet.getHashes$collection(), 0, 0, i8, 6, (Object) null);
                int i9 = i8;
                objArr = array$collection;
                ArraysKt.copyInto$default(objArr, arraySet.getArray$collection(), 0, 0, i9, 6, (Object) null);
                i2 = i9;
            } else {
                i2 = i;
                objArr = array$collection;
            ...
            if (i2 < i4) {
                int i10 = i2 + 1;
                ArraysKt.copyInto(hashes$collection, arraySet.getHashes$collection(), i2, i10, i3);
                ArraysKt.copyInto((T[]) objArr, (T[]) arraySet.getArray$collection(), i2, i10, i3);
            }
        }
