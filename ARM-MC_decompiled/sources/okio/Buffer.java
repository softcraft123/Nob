...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final Buffer copyTo(OutputStream outputStream, long j, long j2) throws IOException {
        ...
        long j3 = j;
        long j4 = j2;
        SegmentedByteString.checkOffsetAndCount(this.size, j3, j4);
        if (j4 != 0) {
            Segment segment = this.head;
            while (true) {
                Intrinsics.checkNotNull(segment);
                if (j3 < ((long) (segment.limit - segment.pos))) {
                    break;
                }
            ...
            while (j5 > 0) {
                ...
                int min = (int) Math.min((long) (segment2.limit - i), j5);
    ...
    public final Buffer writeTo(OutputStream outputStream, long j) throws IOException {
        Intrinsics.checkNotNullParameter(outputStream, "out");
        long j2 = j;
        SegmentedByteString.checkOffsetAndCount(this.size, 0, j2);
        Segment segment = this.head;
        long j3 = j2;
        while (j3 > 0) {
            Intrinsics.checkNotNull(segment);
            int min = (int) Math.min(j3, (long) (segment.limit - segment.pos));
    ...
    public final byte m2120deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m2121deprecated_size() {
        return this.size;
    }
    ...
    public final Buffer copyTo(Buffer buffer, long j, long j2) {
        ...
        long j3 = j;
        long j4 = j2;
        SegmentedByteString.checkOffsetAndCount(size(), j3, j4);
        if (j4 != 0) {
            ...
            while (j5 > 0) {
                ...
                sharedCopy.limit = Math.min(sharedCopy.pos + ((int) j5), sharedCopy.limit);
                ...
                j5 -= (long) (sharedCopy.limit - sharedCopy.pos);
                segment2 = segment2.next;
                j3 = 0;
            }
        }
    ...
    public final long completeSegmentByteCount() {
        ...
        Intrinsics.checkNotNull(segment2);
        return (segment2.limit >= 8192 || !segment2.owner) ? size2 : size2 - ((long) (segment2.limit - segment2.pos));
    }
    ...
    public final byte getByte(long j) {
        long j2 = j;
        SegmentedByteString.checkOffsetAndCount(size(), j2, 1);
        Segment segment = this.head;
        if (segment == null) {
            ...
            Intrinsics.checkNotNull(segment);
            return segment.data[(int) ((((long) segment.pos) + j2) - size2)];
        } else {
            long j3 = 0;
            while (true) {
    ...
    public long indexOf(ByteString byteString, long j) throws IOException {
        ...
        if (byteString2.size() > 0) {
            ...
            if (j3 >= 0) {
                ...
                byte[] internalArray$okio2 = byteString2.internalArray$okio();
