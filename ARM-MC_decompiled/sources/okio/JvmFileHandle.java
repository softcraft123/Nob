...
public final class JvmFileHandle extends FileHandle {
    ...
    public synchronized void protectedResize(long r8) {
        /*
            r7 = this;
            monitor-enter(r7)
            long r2 = r7.size()     // Catch:{ all -> 0x001e }
            long r0 = r8 - r2
            r4 = 0
            int r4 = (r0 > r4 ? 1 : (r0 == r4 ? 0 : -1))
            if (r4 <= 0) goto L_0x0016
            int r6 = (int) r0     // Catch:{ all -> 0x001e }
            byte[] r4 = new byte[r6]     // Catch:{ all -> 0x001e }
            r5 = 0
            r1 = r7
            r1.protectedWrite(r2, r4, r5, r6)     // Catch:{ all -> 0x0023 }
            goto L_0x001c
        L_0x0016:
            r1 = r7
            java.io.RandomAccessFile r0 = r1.randomAccessFile     // Catch:{ all -> 0x0023 }
            r0.setLength(r8)     // Catch:{ all -> 0x0023 }
        L_0x001c:
            monitor-exit(r7)
            return
        L_0x001e:
