...
public final class SegmentedByteString {
    ...
    public static final String toHexString(byte b) {
        return StringsKt.concatToString(new char[]{ByteString.getHEX_DIGIT_CHARS()[(b >> 4) & 15], ByteString.getHEX_DIGIT_CHARS()[b & Ascii.SI]});
    }
    ...
    public static final String toHexString(long j) {
        ...
        char c = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 60) & 15)];
        char c2 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 56) & 15)];
        char c3 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 52) & 15)];
        char c4 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 48) & 15)];
        char c5 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 44) & 15)];
        char c6 = ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 40) & 15)];
        char c7 = c5;
        char c8 = c6;
        int i = 0;
        char[] cArr = {c, c2, c3, c4, c7, c8, ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 36) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 32) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 28) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 24) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 20) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 16) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 12) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 8) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) ((j >> 4) & 15)], ByteString.getHEX_DIGIT_CHARS()[(int) (j & 15)]};
        while (i < 16 && cArr[i] == '0') {
            i++;
        }
