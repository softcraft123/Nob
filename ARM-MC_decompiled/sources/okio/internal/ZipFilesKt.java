...
public final class ZipFilesKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0084, code lost:
        if (r6.readIntLe() != 1) goto L_0x00dc;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:61:0x0120, code lost:
        if (r7.getOffset() >= r10.getCentralDirectoryOffset()) goto L_0x0138;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:63:0x012c, code lost:
        if (r2.invoke(r7).booleanValue() == false) goto L_0x0134;
     */
    ...
    public static final okio.ZipFileSystem openZip(okio.Path r19, okio.FileSystem r20, kotlin.jvm.functions.Function1<? super okio.internal.ZipEntry, java.lang.Boolean> r21) throws java.io.IOException {
        /*
            ...
            r5 = r4
            okio.FileHandle r5 = (okio.FileHandle) r5     // Catch:{ all -> 0x018a }
            long r6 = r5.size()     // Catch:{ all -> 0x018a }
            r8 = 22
            long r8 = (long) r8     // Catch:{ all -> 0x018a }
            long r6 = r6 - r8
            r8 = 0
            ...
            long r10 = r6 - r10
            long r10 = java.lang.Math.max(r10, r8)     // Catch:{ all -> 0x018a }
        L_0x0037:
            okio.Source r3 = r5.source(r6)     // Catch:{ all -> 0x018a }
            okio.BufferedSource r3 = okio.Okio.buffer((okio.Source) r3)     // Catch:{ all -> 0x018a }
            int r12 = r3.readIntLe()     // Catch:{ all -> 0x016e }
            r13 = 101010256(0x6054b50, float:2.506985E-35)
            if (r12 != r13) goto L_0x015a
            okio.internal.EocdRecord r10 = readEocdRecord(r3)     // Catch:{ all -> 0x016e }
            int r11 = r10.getCommentByteCount()     // Catch:{ all -> 0x016e }
            long r11 = (long) r11     // Catch:{ all -> 0x016e }
            java.lang.String r11 = r3.readUtf8(r11)     // Catch:{ all -> 0x016e }
            r3.close()     // Catch:{ all -> 0x018a }
            r3 = 20
            long r12 = (long) r3     // Catch:{ all -> 0x018a }
            long r6 = r6 - r12
            ...
            okio.Source r3 = r5.source(r6)     // Catch:{ all -> 0x018a }
            okio.BufferedSource r3 = okio.Okio.buffer((okio.Source) r3)     // Catch:{ all -> 0x018a }
            java.io.Closeable r3 = (java.io.Closeable) r3     // Catch:{ all -> 0x018a }
            r6 = r3
            okio.BufferedSource r6 = (okio.BufferedSource) r6     // Catch:{ all -> 0x00ea }
            int r7 = r6.readIntLe()     // Catch:{ all -> 0x00ea }
            ...
            r15 = 1
            if (r6 != r15) goto L_0x00dc
            if (r7 != 0) goto L_0x00dc
            okio.Source r6 = r5.source(r13)     // Catch:{ all -> 0x00ea }
        ...
        L_0x00e4:
            ...
            kotlin.io.CloseableKt.closeFinally(r3, r12)     // Catch:{ all -> 0x018a }
            goto L_0x00f2
        L_0x00ea:
            r0 = move-exception
            r1 = r0
        ...
        L_0x00ed:
            r0 = move-exception
            kotlin.io.CloseableKt.closeFinally(r3, r1)     // Catch:{ all -> 0x018a }
            throw r0     // Catch:{ all -> 0x018a }
        L_0x00f2:
            java.util.ArrayList r3 = new java.util.ArrayList     // Catch:{ all -> 0x018a }
            r3.<init>()     // Catch:{ all -> 0x018a }
            java.util.List r3 = (java.util.List) r3     // Catch:{ all -> 0x018a }
            long r6 = r10.getCentralDirectoryOffset()     // Catch:{ all -> 0x018a }
            okio.Source r5 = r5.source(r6)     // Catch:{ all -> 0x018a }
            ...
            r6 = r5
            okio.BufferedSource r6 = (okio.BufferedSource) r6     // Catch:{ all -> 0x0152 }
            long r13 = r10.getEntryCount()     // Catch:{ all -> 0x0152 }
        L_0x010e:
            int r7 = (r8 > r13 ? 1 : (r8 == r13 ? 0 : -1))
            if (r7 >= 0) goto L_0x0140
            okio.internal.ZipEntry r7 = readEntry(r6)     // Catch:{ all -> 0x0152 }
            long r15 = r7.getOffset()     // Catch:{ all -> 0x0152 }
            long r17 = r10.getCentralDirectoryOffset()     // Catch:{ all -> 0x0152 }
            int r15 = (r15 > r17 ? 1 : (r15 == r17 ? 0 : -1))
            if (r15 >= 0) goto L_0x0138
            java.lang.Object r15 = r2.invoke(r7)     // Catch:{ all -> 0x0152 }
            java.lang.Boolean r15 = (java.lang.Boolean) r15     // Catch:{ all -> 0x0152 }
            boolean r15 = r15.booleanValue()     // Catch:{ all -> 0x0152 }
            if (r15 == 0) goto L_0x0134
            r15 = r3
            java.util.Collection r15 = (java.util.Collection) r15     // Catch:{ all -> 0x0152 }
            r15.add(r7)     // Catch:{ all -> 0x0152 }
        L_0x0134:
            r15 = 1
            long r8 = r8 + r15
            goto L_0x010e
        ...
        L_0x0140:
            kotlin.Unit r2 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0152 }
            kotlin.io.CloseableKt.closeFinally(r5, r12)     // Catch:{ all -> 0x018a }
            java.util.Map r2 = buildIndex(r3)     // Catch:{ all -> 0x018a }
            okio.ZipFileSystem r3 = new okio.ZipFileSystem     // Catch:{ all -> 0x018a }
            r3.<init>(r0, r1, r2, r11)     // Catch:{ all -> 0x018a }
        ...
        L_0x0155:
            r0 = move-exception
            kotlin.io.CloseableKt.closeFinally(r5, r1)     // Catch:{ all -> 0x018a }
            throw r0     // Catch:{ all -> 0x018a }
        L_0x015a:
            r3.close()     // Catch:{ all -> 0x018a }
            r12 = -1
        ...
        L_0x0173:
            ...
            long r2 = r5.size()     // Catch:{ all -> 0x018a }
        ...
        for (ZipEntry zipEntry : CollectionsKt.sortedWith(list, new ZipFilesKt$buildIndex$$inlined$sortedBy$1())) {
            if (mutableMapOf.put(zipEntry.getCanonicalPath(), zipEntry) == null) {
                while (true) {
                    ...
                    ZipEntry zipEntry3 = new ZipEntry(parent, true, (String) null, 0, 0, 0, 0, (Long) null, 0, TypedValues.PositionType.TYPE_CURVE_FIT, (DefaultConstructorMarker) null);
    ...
    public static final ZipEntry readEntry(BufferedSource bufferedSource) throws IOException {
        ...
        if (readIntLe == CENTRAL_FILE_HEADER_SIGNATURE) {
            ...
            if ((readShortLe & 1) == 0) {
                ...
                Long dosDateTimeToEpochMillis = dosDateTimeToEpochMillis(bufferedSource2.readShortLe() & UShort.MAX_VALUE, bufferedSource2.readShortLe() & UShort.MAX_VALUE);
                ...
                if (!StringsKt.contains$default((CharSequence) readUtf8, 0, false, 2, (Object) null)) {
                    ...
                    readExtra(bufferedSource2, readShortLe4, new ZipFilesKt$readEntry$1(booleanRef, j2, longRef5, bufferedSource2, longRef, longRef3));
                    if (j2 <= 0 || booleanRef.element) {
                        return new ZipEntry(Path.Companion.get$default(Path.Companion, DomExceptionUtils.SEPARATOR, false, 1, (Object) null).resolve(readUtf8), StringsKt.endsWith$default(readUtf8, DomExceptionUtils.SEPARATOR, false, 2, (Object) null), bufferedSource2.readUtf8((long) readShortLe5), readIntLe2, longRef.element, longRef5.element, readShortLe2, dosDateTimeToEpochMillis, longRef3.element);
                    }
    ...
    private static final void readExtra(BufferedSource bufferedSource, int i, Function2<? super Integer, ? super Long, Unit> function2) {
        ...
        while (j != 0) {
            if (j >= 4) {
                short readShortLe = bufferedSource.readShortLe() & UShort.MAX_VALUE;
                long readShortLe2 = ((long) bufferedSource.readShortLe()) & 65535;
                long j2 = j - ((long) 4);
                if (j2 >= readShortLe2) {
    ...
    private static final FileMetadata readOrSkipLocalHeader(BufferedSource bufferedSource, FileMetadata fileMetadata) {
        ...
        if (readIntLe == LOCAL_FILE_HEADER_SIGNATURE) {
            ...
            if ((readShortLe & 1) == 0) {
                ...
                short readShortLe2 = bufferedSource2.readShortLe() & UShort.MAX_VALUE;
                bufferedSource2.skip(((long) bufferedSource2.readShortLe()) & 65535);
                if (fileMetadata == null) {
                    bufferedSource2.skip((long) readShortLe2);
                    return null;
                }
                readExtra(bufferedSource2, readShortLe2, new ZipFilesKt$readOrSkipLocalHeader$1(bufferedSource2, objectRef, objectRef2, objectRef3));
