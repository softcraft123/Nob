...
public final class SegmentedByteString {
    ...
    public static final int segment(C0000SegmentedByteString segmentedByteString, int i) {
    ...
    public static final void forEachSegment(C0000SegmentedByteString segmentedByteString, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    private static final void forEachSegment(C0000SegmentedByteString segmentedByteString, int i, int i2, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
        int i3;
    ...
    public static final ByteString commonSubstring(C0000SegmentedByteString segmentedByteString, int i, int i2) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        ...
        if (i < 0) {
            ...
            if (i3 < 0) {
                ...
                return new C0000SegmentedByteString(bArr, iArr);
            }
        } else {
    ...
    public static final byte commonInternalGet(C0000SegmentedByteString segmentedByteString, int i) {
        int i2;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final int commonGetSize(C0000SegmentedByteString segmentedByteString) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        return segmentedByteString.getDirectory$okio()[((Object[]) segmentedByteString.getSegments$okio()).length - 1];
    }

    public static final byte[] commonToByteArray(C0000SegmentedByteString segmentedByteString) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final boolean commonRangeEquals(C0000SegmentedByteString segmentedByteString, int i, ByteString byteString, int i2, int i3) {
        int i4;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final boolean commonRangeEquals(C0000SegmentedByteString segmentedByteString, int i, byte[] bArr, int i2, int i3) {
        int i4;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final void commonCopyInto(C0000SegmentedByteString segmentedByteString, int i, byte[] bArr, int i2, int i3) {
        int i4;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        ...
        long j2 = j;
        okio.SegmentedByteString.checkOffsetAndCount((long) bArr.length, (long) i2, j2);
        int i5 = i3 + i;
        int segment = segment(segmentedByteString, i);
        while (i < i5) {
            if (segment == 0) {
    ...
    public static final boolean commonEquals(C0000SegmentedByteString segmentedByteString, Object obj) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final int commonHashCode(C0000SegmentedByteString segmentedByteString) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final void commonWrite(C0000SegmentedByteString segmentedByteString, Buffer buffer, int i, int i2) {
        int i3;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
