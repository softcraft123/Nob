...
public final class Path {
    ...
    /* access modifiers changed from: private */
    public static final ByteString SLASH = ByteString.Companion.encodeUtf8(DomExceptionUtils.SEPARATOR);
    ...
    public static final ByteString toSlash(String str) {
        if (Intrinsics.areEqual((Object) str, (Object) DomExceptionUtils.SEPARATOR)) {
            return SLASH;
        }
