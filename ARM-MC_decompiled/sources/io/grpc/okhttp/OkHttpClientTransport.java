...
class OkHttpClientTransport implements ConnectionClientTransport, ExceptionHandlingFrameWriter.TransportExceptionHandler, OutboundFlowController.Transport {
    ...
    public OkHttpClientStream newStream(MethodDescriptor<?, ?> methodDescriptor, Metadata metadata, CallOptions callOptions, ClientStreamTracer[] clientStreamTracerArr) {
        ...
        Preconditions.checkNotNull(methodDescriptor2, "method");
        ...
        synchronized (this.lock) {
            okHttpClientStream = new OkHttpClientStream(methodDescriptor2, metadata2, this.frameWriter, this, this.outboundFlow, this.lock, this.maxMessageSize, this.initialWindowSize, this.defaultAuthority, this.userAgent, newClientContext, this.transportTracer, callOptions, this.useGetForSafeMethods);
        }
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:27:0x00ea */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.net.Socket createHttpProxySocket(java.net.InetSocketAddress r7, java.net.InetSocketAddress r8, java.lang.String r9, java.lang.String r10) throws io.grpc.StatusException {
        /*
            r6 = this;
            java.lang.String r0 = "\r\n"
            r1 = 0
            java.net.InetAddress r2 = r8.getAddress()     // Catch:{ IOException -> 0x010d }
            if (r2 == 0) goto L_0x0018
            javax.net.SocketFactory r2 = r6.socketFactory     // Catch:{ IOException -> 0x010d }
            java.net.InetAddress r3 = r8.getAddress()     // Catch:{ IOException -> 0x010d }
            int r8 = r8.getPort()     // Catch:{ IOException -> 0x010d }
            java.net.Socket r8 = r2.createSocket(r3, r8)     // Catch:{ IOException -> 0x010d }
            goto L_0x0026
        L_0x0018:
            javax.net.SocketFactory r2 = r6.socketFactory     // Catch:{ IOException -> 0x010d }
            java.lang.String r3 = r8.getHostName()     // Catch:{ IOException -> 0x010d }
            int r8 = r8.getPort()     // Catch:{ IOException -> 0x010d }
            java.net.Socket r8 = r2.createSocket(r3, r8)     // Catch:{ IOException -> 0x010d }
        L_0x0026:
            r1 = r8
            r8 = 1
            r1.setTcpNoDelay(r8)     // Catch:{ IOException -> 0x010d }
            int r8 = r6.proxySocketTimeout     // Catch:{ IOException -> 0x010d }
            r1.setSoTimeout(r8)     // Catch:{ IOException -> 0x010d }
            okio.Source r8 = okio.Okio.source((java.net.Socket) r1)     // Catch:{ IOException -> 0x010d }
            okio.Sink r2 = okio.Okio.sink((java.net.Socket) r1)     // Catch:{ IOException -> 0x010d }
            okio.BufferedSink r2 = okio.Okio.buffer((okio.Sink) r2)     // Catch:{ IOException -> 0x010d }
            io.grpc.okhttp.internal.proxy.Request r7 = r6.createHttpProxyRequest(r7, r9, r10)     // Catch:{ IOException -> 0x010d }
            io.grpc.okhttp.internal.proxy.HttpUrl r9 = r7.httpUrl()     // Catch:{ IOException -> 0x010d }
            java.util.Locale r10 = java.util.Locale.US     // Catch:{ IOException -> 0x010d }
            java.lang.String r3 = "CONNECT %s:%d HTTP/1.1"
            java.lang.String r4 = r9.host()     // Catch:{ IOException -> 0x010d }
            int r9 = r9.port()     // Catch:{ IOException -> 0x010d }
            java.lang.Integer r9 = java.lang.Integer.valueOf(r9)     // Catch:{ IOException -> 0x010d }
            java.lang.Object[] r9 = new java.lang.Object[]{r4, r9}     // Catch:{ IOException -> 0x010d }
            java.lang.String r9 = java.lang.String.format(r10, r3, r9)     // Catch:{ IOException -> 0x010d }
            okio.BufferedSink r9 = r2.writeUtf8(r9)     // Catch:{ IOException -> 0x010d }
            r9.writeUtf8(r0)     // Catch:{ IOException -> 0x010d }
            io.grpc.okhttp.internal.Headers r9 = r7.headers()     // Catch:{ IOException -> 0x010d }
            int r9 = r9.size()     // Catch:{ IOException -> 0x010d }
            r10 = 0
            r3 = r10
        L_0x006d:
            if (r3 >= r9) goto L_0x0093
            io.grpc.okhttp.internal.Headers r4 = r7.headers()     // Catch:{ IOException -> 0x010d }
            java.lang.String r4 = r4.name(r3)     // Catch:{ IOException -> 0x010d }
            okio.BufferedSink r4 = r2.writeUtf8(r4)     // Catch:{ IOException -> 0x010d }
            java.lang.String r5 = ": "
            okio.BufferedSink r4 = r4.writeUtf8(r5)     // Catch:{ IOException -> 0x010d }
            io.grpc.okhttp.internal.Headers r5 = r7.headers()     // Catch:{ IOException -> 0x010d }
            java.lang.String r5 = r5.value(r3)     // Catch:{ IOException -> 0x010d }
            okio.BufferedSink r4 = r4.writeUtf8(r5)     // Catch:{ IOException -> 0x010d }
            r4.writeUtf8(r0)     // Catch:{ IOException -> 0x010d }
            int r3 = r3 + 1
            goto L_0x006d
        L_0x0093:
            r2.writeUtf8(r0)     // Catch:{ IOException -> 0x010d }
            r2.flush()     // Catch:{ IOException -> 0x010d }
            java.lang.String r7 = readUtf8LineStrictUnbuffered(r8)     // Catch:{ IOException -> 0x010d }
            io.grpc.okhttp.internal.StatusLine r7 = io.grpc.okhttp.internal.StatusLine.parse(r7)     // Catch:{ IOException -> 0x010d }
        L_0x00a1:
            java.lang.String r9 = readUtf8LineStrictUnbuffered(r8)     // Catch:{ IOException -> 0x010d }
            java.lang.String r0 = ""
            boolean r9 = r9.equals(r0)     // Catch:{ IOException -> 0x010d }
            if (r9 != 0) goto L_0x00ae
            goto L_0x00a1
        L_0x00ae:
            int r9 = r7.code     // Catch:{ IOException -> 0x010d }
            r0 = 200(0xc8, float:2.8E-43)
            if (r9 < r0) goto L_0x00be
            int r9 = r7.code     // Catch:{ IOException -> 0x010d }
            r0 = 300(0x12c, float:4.2E-43)
            if (r9 >= r0) goto L_0x00be
            r1.setSoTimeout(r10)     // Catch:{ IOException -> 0x010d }
            return r1
        L_0x00be:
            okio.Buffer r9 = new okio.Buffer     // Catch:{ IOException -> 0x010d }
            r9.<init>()     // Catch:{ IOException -> 0x010d }
            r1.shutdownOutput()     // Catch:{ IOException -> 0x00cc }
            r2 = 1024(0x400, double:5.06E-321)
            r8.read(r9, r2)     // Catch:{ IOException -> 0x00cc }
            goto L_0x00e7
        L_0x00cc:
            r8 = move-exception
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ IOException -> 0x010d }
            r10.<init>()     // Catch:{ IOException -> 0x010d }
            java.lang.String r0 = "Unable to read body: "
            java.lang.StringBuilder r10 = r10.append(r0)     // Catch:{ IOException -> 0x010d }
            java.lang.String r8 = r8.toString()     // Catch:{ IOException -> 0x010d }
            java.lang.StringBuilder r8 = r10.append(r8)     // Catch:{ IOException -> 0x010d }
            java.lang.String r8 = r8.toString()     // Catch:{ IOException -> 0x010d }
            r9.writeUtf8((java.lang.String) r8)     // Catch:{ IOException -> 0x010d }
        L_0x00e7:
            r1.close()     // Catch:{ IOException -> 0x00ea }
        L_0x00ea:
            java.util.Locale r8 = java.util.Locale.US     // Catch:{ IOException -> 0x010d }
            java.lang.String r10 = "Response returned from proxy was not successful (expected 2xx, got %d %s). Response body:\n%s"
            int r0 = r7.code     // Catch:{ IOException -> 0x010d }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ IOException -> 0x010d }
            java.lang.String r7 = r7.message     // Catch:{ IOException -> 0x010d }
            java.lang.String r9 = r9.readUtf8()     // Catch:{ IOException -> 0x010d }
            java.lang.Object[] r7 = new java.lang.Object[]{r0, r7, r9}     // Catch:{ IOException -> 0x010d }
            java.lang.String r7 = java.lang.String.format(r8, r10, r7)     // Catch:{ IOException -> 0x010d }
            io.grpc.Status r8 = io.grpc.Status.UNAVAILABLE     // Catch:{ IOException -> 0x010d }
            io.grpc.Status r7 = r8.withDescription(r7)     // Catch:{ IOException -> 0x010d }
            io.grpc.StatusException r7 = r7.asException()     // Catch:{ IOException -> 0x010d }
            throw r7     // Catch:{ IOException -> 0x010d }
        L_0x010d:
            r7 = move-exception
            if (r1 == 0) goto L_0x0113
            io.grpc.internal.GrpcUtil.closeQuietly((java.io.Closeable) r1)
        L_0x0113:
            io.grpc.Status r8 = io.grpc.Status.UNAVAILABLE
            java.lang.String r9 = "Failed trying to connect with proxy"
            io.grpc.Status r8 = r8.withDescription(r9)
            io.grpc.Status r7 = r8.withCause(r7)
            io.grpc.StatusException r7 = r7.asException()
            throw r7
        */
    ...
    class ClientFrameHandler implements FrameReader.Handler, Runnable {
        ...
        public void data(boolean z, int i, BufferedSource bufferedSource, int i2, int i3) throws IOException {
            ...
            int i4 = i;
            int i5 = i2;
            this.logger.logData(OkHttpFrameLogger.Direction.INBOUND, i4, bufferedSource.getBuffer(), i5, z2);
            OkHttpClientStream stream = OkHttpClientTransport.this.getStream(i4);
            if (stream != null) {
                long j = (long) i5;
                ...
                synchronized (OkHttpClientTransport.this.lock) {
                    try {
                        stream.transportState().transportDataReceived(buffer, z2, i3 - i5);
                    } catch (Throwable th) {
                        while (true) {
                            throw th;
                        }
            ...
            } else if (OkHttpClientTransport.this.mayHaveCreatedStream(i4)) {
                synchronized (OkHttpClientTransport.this.lock) {
                    try {
                        OkHttpClientTransport.this.frameWriter.rstStream(i4, ErrorCode.STREAM_CLOSED);
                    } catch (Throwable th2) {
                        while (true) {
                            throw th2;
                        }
                ...
                OkHttpClientTransport.this.onError(ErrorCode.PROTOCOL_ERROR, "Received data for unknown stream: " + i4);
                return;
            }
        ...
        public void headers(boolean z, boolean z2, int i, int i2, List<Header> list, HeadersMode headersMode) {
            ...
            if (OkHttpClientTransport.this.maxInboundMetadataSize == Integer.MAX_VALUE || (headerBlockSize = headerBlockSize(list)) <= OkHttpClientTransport.this.maxInboundMetadataSize) {
                ...
                status = Status.RESOURCE_EXHAUSTED.withDescription(String.format(Locale.US, "Response %s metadata larger than %d: %d", new Object[]{z2 ? "trailer" : "header", Integer.valueOf(OkHttpClientTransport.this.maxInboundMetadataSize), Integer.valueOf(headerBlockSize)}));
            }
            synchronized (OkHttpClientTransport.this.lock) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:24:0x0076, code lost:
            io.grpc.okhttp.OkHttpClientTransport.access$2300(r7.this$0, io.grpc.okhttp.internal.framed.ErrorCode.PROTOCOL_ERROR, "Received window_update for unknown stream: " + r1);
         */
        ...
        public void windowUpdate(int r8, long r9) {
            ...
            L_0x002c:
                ...
                io.grpc.okhttp.OkHttpClientTransport r0 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x008d }
                io.grpc.okhttp.OutboundFlowController r0 = r0.outboundFlow     // Catch:{ all -> 0x008d }
                r1 = 0
                int r9 = (int) r9     // Catch:{ all -> 0x008d }
                r0.windowUpdate(r1, r9)     // Catch:{ all -> 0x008d }
                monitor-exit(r8)     // Catch:{ all -> 0x008d }
                return
            L_0x0043:
                io.grpc.okhttp.OkHttpClientTransport r0 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x008d }
                java.util.Map r0 = r0.streams     // Catch:{ all -> 0x008d }
                java.lang.Integer r2 = java.lang.Integer.valueOf(r1)     // Catch:{ all -> 0x008d }
                java.lang.Object r0 = r0.get(r2)     // Catch:{ all -> 0x008d }
                io.grpc.okhttp.OkHttpClientStream r0 = (io.grpc.okhttp.OkHttpClientStream) r0     // Catch:{ all -> 0x008d }
                if (r0 == 0) goto L_0x0068
                io.grpc.okhttp.OkHttpClientTransport r2 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x008d }
                io.grpc.okhttp.OutboundFlowController r2 = r2.outboundFlow     // Catch:{ all -> 0x008d }
                io.grpc.okhttp.OkHttpClientStream$TransportState r0 = r0.transportState()     // Catch:{ all -> 0x008d }
                io.grpc.okhttp.OutboundFlowController$StreamState r0 = r0.getOutboundFlowState()     // Catch:{ all -> 0x008d }
                int r9 = (int) r9     // Catch:{ all -> 0x008d }
                r2.windowUpdate(r0, r9)     // Catch:{ all -> 0x008d }
                goto L_0x0072
            L_0x0068:
                io.grpc.okhttp.OkHttpClientTransport r9 = io.grpc.okhttp.OkHttpClientTransport.this     // Catch:{ all -> 0x008d }
                boolean r9 = r9.mayHaveCreatedStream(r1)     // Catch:{ all -> 0x008d }
