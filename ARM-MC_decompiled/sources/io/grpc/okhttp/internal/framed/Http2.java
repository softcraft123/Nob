...
public final class Http2 implements Variant {
    ...
    static final class FrameLogger {
        ...
        static String formatHeader(boolean z, int i, int i2, byte b, byte b2) {
            String[] strArr = TYPES;
            return String.format(Locale.US, "%s 0x%08x %5d %-13s %s", new Object[]{z ? "<<" : ">>", Integer.valueOf(i), Integer.valueOf(i2), b < strArr.length ? strArr[b] : String.format("0x%02x", new Object[]{Byte.valueOf(b)}), formatFlags(b, b2)});
        }
