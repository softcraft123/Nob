                ...
                if (i == -1) {
                    ...
                    while (true) {
                        ...
                        if (i6 >= headerArr.length) {
                            break;
                        } else if (headerArr[i6].name.equals(asciiLowercase)) {
                            if (this.dynamicTable[i6].value.equals(byteString)) {
                                i = Hpack.STATIC_HEADER_TABLE.length + (i6 - this.nextDynamicTableIndex);
                                break;
                            } else if (i2 == -1) {
                                i2 = (i6 - this.nextDynamicTableIndex) + Hpack.STATIC_HEADER_TABLE.length;
                            }
                        }
                    }
                }
