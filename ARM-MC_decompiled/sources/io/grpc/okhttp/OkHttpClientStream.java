...
class OkHttpClientStream extends AbstractClientStream {
    ...
    OkHttpClientStream(MethodDescriptor<?, ?> methodDescriptor, Metadata metadata, ExceptionHandlingFrameWriter exceptionHandlingFrameWriter, OkHttpClientTransport okHttpClientTransport, OutboundFlowController outboundFlowController, Object obj, int i, int i2, String str, String str2, StatsTraceContext statsTraceContext, TransportTracer transportTracer, CallOptions callOptions, boolean z) {
        ...
        StatsTraceContext statsTraceContext2;
        AbstractClientStream abstractClientStream;
        OkHttpWritableBufferAllocator okHttpWritableBufferAllocator = new OkHttpWritableBufferAllocator();
        if (!z || !methodDescriptor.isSafe()) {
            z2 = false;
            abstractClientStream = this;
            metadata2 = metadata;
            statsTraceContext2 = statsTraceContext;
            transportTracer2 = transportTracer;
        ...
        new AbstractClientStream(okHttpWritableBufferAllocator, statsTraceContext2, transportTracer2, metadata2, callOptions2, z2);
        this.sink = new Sink();
        this.useGet = false;
        StatsTraceContext statsTraceContext3 = statsTraceContext;
        this.statsTraceCtx = (StatsTraceContext) Preconditions.checkNotNull(statsTraceContext3, "statsTraceCtx");
        this.method = methodDescriptor;
        this.authority = str;
        this.userAgent = str2;
        this.attributes = okHttpClientTransport.getAttributes();
        Object obj2 = obj;
        StatsTraceContext statsTraceContext4 = statsTraceContext3;
        int i3 = i;
        this.state = new TransportState(i3, statsTraceContext4, obj2, exceptionHandlingFrameWriter, outboundFlowController, okHttpClientTransport, i2, methodDescriptor.getFullMethodName());
    }
