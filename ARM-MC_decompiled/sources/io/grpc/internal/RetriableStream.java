    ...
    private final class Sublistener implements ClientStreamListener {
        ...
        public void closed(io.grpc.Status r6, io.grpc.internal.ClientStreamListener.RpcProgress r7, io.grpc.Metadata r8) {
            /*
                ...
                monitor-enter(r0)
                io.grpc.internal.RetriableStream r1 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01cd }
                io.grpc.internal.RetriableStream$State r2 = r1.state     // Catch:{ all -> 0x01cd }
                io.grpc.internal.RetriableStream$Substream r3 = r5.substream     // Catch:{ all -> 0x01cd }
                io.grpc.internal.RetriableStream$State r2 = r2.substreamClosed(r3)     // Catch:{ all -> 0x01cd }
                io.grpc.internal.RetriableStream.State unused = r1.state = r2     // Catch:{ all -> 0x01cd }
                io.grpc.internal.RetriableStream r1 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01cd }
                io.grpc.internal.InsightBuilder r1 = r1.closedSubstreamsInsight     // Catch:{ all -> 0x01cd }
                io.grpc.Status$Code r2 = r6.getCode()     // Catch:{ all -> 0x01cd }
            ...
            L_0x0143:
                ...
                monitor-enter(r1)
                io.grpc.internal.RetriableStream r7 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0172 }
                io.grpc.internal.RetriableStream$FutureCanceller r8 = new io.grpc.internal.RetriableStream$FutureCanceller     // Catch:{ all -> 0x0172 }
                io.grpc.internal.RetriableStream r2 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0172 }
                java.lang.Object r2 = r2.lock     // Catch:{ all -> 0x0172 }
                r8.<init>(r2)     // Catch:{ all -> 0x0172 }
                io.grpc.internal.RetriableStream.FutureCanceller unused = r7.scheduledRetry = r8     // Catch:{ all -> 0x0172 }
            ...
            L_0x0182:
                ...
                monitor-enter(r7)
                io.grpc.internal.RetriableStream r8 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x01a2 }
                io.grpc.internal.RetriableStream$State r0 = r8.state     // Catch:{ all -> 0x01a2 }
                io.grpc.internal.RetriableStream$Substream r1 = r5.substream     // Catch:{ all -> 0x01a2 }
                io.grpc.internal.RetriableStream$State r0 = r0.replaceActiveHedge(r1, r6)     // Catch:{ all -> 0x01a2 }
                io.grpc.internal.RetriableStream.State unused = r8.state = r0     // Catch:{ all -> 0x01a2 }
        ...
        private HedgingPlan makeHedgingDecision(Status status, Metadata metadata) {
            ...
            boolean z = true;
            boolean z2 = (RetriableStream.this.throttle == null || (!contains && (pushbackMills == null || pushbackMills.intValue() >= 0))) ? false : !RetriableStream.this.throttle.onQualifiedFailureThenCheckIsAboveThreshold();
            if (contains && !z2 && !status.isOk() && pushbackMills != null && pushbackMills.intValue() > 0) {
                pushbackMills = 0;
            }
            if (!contains || z2) {
                z = false;
    ...
    class BufferSizeTracer extends ClientStreamTracer {
        ...
        public void outboundWireSize(long r6) {
            ...
            L_0x000c:
                ...
                java.lang.Object r0 = r0.lock
                monitor-enter(r0)
                io.grpc.internal.RetriableStream r1 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream$State r1 = r1.state     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream$Substream r1 = r1.winningSubstream     // Catch:{ all -> 0x0088 }
                if (r1 != 0) goto L_0x0086
                io.grpc.internal.RetriableStream$Substream r1 = r5.substream     // Catch:{ all -> 0x0088 }
                boolean r1 = r1.closed     // Catch:{ all -> 0x0088 }
                if (r1 == 0) goto L_0x0024
                goto L_0x0086
            L_0x0024:
                long r1 = r5.bufferNeeded     // Catch:{ all -> 0x0088 }
                long r1 = r1 + r6
                r5.bufferNeeded = r1     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream r6 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                long r6 = r6.perRpcBufferUsed     // Catch:{ all -> 0x0088 }
                int r6 = (r1 > r6 ? 1 : (r1 == r6 ? 0 : -1))
                if (r6 > 0) goto L_0x0035
                monitor-exit(r0)     // Catch:{ all -> 0x0088 }
                return
            L_0x0035:
                long r6 = r5.bufferNeeded     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream r1 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                long r1 = r1.perRpcBufferLimit     // Catch:{ all -> 0x0088 }
                int r6 = (r6 > r1 ? 1 : (r6 == r1 ? 0 : -1))
                r7 = 1
                if (r6 <= 0) goto L_0x0047
                io.grpc.internal.RetriableStream$Substream r6 = r5.substream     // Catch:{ all -> 0x0088 }
                r6.bufferLimitExceeded = r7     // Catch:{ all -> 0x0088 }
                goto L_0x006f
            L_0x0047:
                io.grpc.internal.RetriableStream r6 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream$ChannelBufferMeter r6 = r6.channelBufferUsed     // Catch:{ all -> 0x0088 }
                long r1 = r5.bufferNeeded     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream r3 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                long r3 = r3.perRpcBufferUsed     // Catch:{ all -> 0x0088 }
                long r1 = r1 - r3
                long r1 = r6.addAndGet(r1)     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream r6 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                long r3 = r5.bufferNeeded     // Catch:{ all -> 0x0088 }
                long unused = r6.perRpcBufferUsed = r3     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream r6 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                long r3 = r6.channelBufferLimit     // Catch:{ all -> 0x0088 }
            ...
            L_0x006f:
                io.grpc.internal.RetriableStream$Substream r6 = r5.substream     // Catch:{ all -> 0x0088 }
                boolean r6 = r6.bufferLimitExceeded     // Catch:{ all -> 0x0088 }
                if (r6 == 0) goto L_0x007e
                io.grpc.internal.RetriableStream r6 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0088 }
                io.grpc.internal.RetriableStream$Substream r7 = r5.substream     // Catch:{ all -> 0x0088 }
                java.lang.Runnable r6 = r6.commit(r7)     // Catch:{ all -> 0x0088 }
                goto L_0x007f
            L_0x007e:
                r6 = 0
            L_0x007f:
