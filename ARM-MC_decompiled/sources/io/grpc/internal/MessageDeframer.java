...
public class MessageDeframer implements Closeable, Deframer {
    ...
    public void deframe(io.grpc.internal.ReadableBuffer r3) {
        /*
            r2 = this;
            java.lang.String r0 = "data"
            com.google.common.base.Preconditions.checkNotNull(r3, r0)
            r0 = 1
            boolean r1 = r2.isClosedOrScheduledToClose()     // Catch:{ all -> 0x0024 }
            if (r1 != 0) goto L_0x0020
            io.grpc.internal.GzipInflatingBuffer r1 = r2.fullStreamDecompressor     // Catch:{ all -> 0x0024 }
            if (r1 == 0) goto L_0x0014
            r1.addGzippedBytes(r3)     // Catch:{ all -> 0x0024 }
            goto L_0x0019
        L_0x0014:
            io.grpc.internal.CompositeReadableBuffer r1 = r2.unprocessed     // Catch:{ all -> 0x0024 }
            r1.addBuffer(r3)     // Catch:{ all -> 0x0024 }
        L_0x0019:
            r2.deliver()     // Catch:{ all -> 0x001d }
            return
        L_0x001d:
            r1 = move-exception
            r0 = 0
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                io.grpc.internal.MessageDeframer$State r1 = io.grpc.internal.MessageDeframer.State.HEADER     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$io$grpc$internal$MessageDeframer$State     // Catch:{ NoSuchFieldError -> 0x001d }
                io.grpc.internal.MessageDeframer$State r1 = io.grpc.internal.MessageDeframer.State.BODY     // Catch:{ NoSuchFieldError -> 0x001d }
