...
class SerializeReentrantCallsDirectExecutor implements Executor {
    ...
    public void execute(java.lang.Runnable r7) {
        ...
        L_0x001c:
            r2 = move-exception
            java.util.logging.Logger r3 = log     // Catch:{ all -> 0x0037 }
            java.util.logging.Level r4 = java.util.logging.Level.SEVERE     // Catch:{ all -> 0x0037 }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x0037 }
            r5.<init>(r0)     // Catch:{ all -> 0x0037 }
            java.lang.StringBuilder r7 = r5.append(r7)     // Catch:{ all -> 0x0037 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0037 }
            r3.log(r4, r7, r2)     // Catch:{ all -> 0x0037 }
            java.util.ArrayDeque<java.lang.Runnable> r7 = r6.taskQueue
            if (r7 == 0) goto L_0x0019
            goto L_0x0016
        L_0x0036:
