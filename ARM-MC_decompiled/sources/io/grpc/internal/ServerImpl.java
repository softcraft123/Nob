...
public final class ServerImpl extends Server implements InternalInstrumented<InternalChannelz.ServerStats> {
    ...
    private final class ServerTransportListenerImpl implements ServerTransportListener {
        ...
        private void streamCreatedInternal(ServerStream serverStream, String str, Metadata metadata, Tag tag) {
            ...
            JumpToApplicationThreadServerStreamListener jumpToApplicationThreadServerStreamListener = new JumpToApplicationThreadServerStreamListener(executor2, ServerImpl.this.executor, serverStream, cancellableContext, tag);
            ...
            Link link = linkOut;
            Tag tag2 = tag;
            executor2.execute(new ContextRunnable(cancellableContext2, tag2, link, str, serverStream, jumpToApplicationThreadServerStreamListener, create, statsTraceContext, metadata, executor2) {
                ...
                private void runInternal() {
                    AnonymousClass1MethodLookup r6;
                    try {
                        ...
                        r6 = this;
                        try {
                            r6.val$future.set(r6.maySwitchExecutor(ServerTransportListenerImpl.this.wrapMethod(this.val$stream, lookupMethod, this.val$statsTraceCtx), this.val$stream, this.val$headers, this.val$context, this.val$tag));
                        } catch (Throwable th) {
                            th = th;
                            r6.val$jumpListener.setListener(ServerImpl.NOOP_LISTENER);
                            r6.val$stream.close(Status.fromThrowable(th), new Metadata());
                            r6.val$context.cancel((Throwable) null);
                            r6.val$future.cancel(false);
                            throw th;
                        }
                    } catch (Throwable th2) {
                        th = th2;
                ...
                private <ReqT, RespT> ServerCallParameters<ReqT, RespT> maySwitchExecutor(ServerMethodDefinition<ReqT, RespT> serverMethodDefinition, ServerStream serverStream, Metadata metadata, Context.CancellableContext cancellableContext, Tag tag) {
                    ...
                    ServerCallImpl serverCallImpl = new ServerCallImpl(serverStream, serverMethodDefinition.getMethodDescriptor(), metadata2, cancellableContext, ServerImpl.this.decompressorRegistry, ServerImpl.this.compressorRegistry, ServerImpl.this.serverCallTracer, tag);
            ...
            executor2.execute(new ContextRunnable(cancellableContext2, link, tag3, create, str, metadata, serverStream, jumpToApplicationThreadServerStreamListener2) {
                final /* synthetic */ Context.CancellableContext val$context;
                final /* synthetic */ SettableFuture val$future;
                final /* synthetic */ Metadata val$headers;
                final /* synthetic */ JumpToApplicationThreadServerStreamListener val$jumpListener;
        ...
        public <ReqT, RespT> ServerMethodDefinition<?, ?> wrapMethod(ServerStream serverStream, ServerMethodDefinition<ReqT, RespT> serverMethodDefinition, StatsTraceContext statsTraceContext) {
            ...
            return ServerImpl.this.binlog.wrapMethodDefinition(withServerCallHandler);
        }
